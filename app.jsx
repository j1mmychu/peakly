...
if (typeof navigator !== "undefined" && "serviceWorker" in navigator) {
  ...
  // A page that starts UNcontrolled (first-ever visit) also fires
  // controllerchange when the new SW calls clients.claim() — reloading there
  // punishes every brand-new visitor with a double cold load mid-session.
  // Only reload when an existing controller was REPLACED (i.e. a real deploy).
...
const VENUES = [
  {
    ...
    accent:"#6db3f2", tags:["Deep Powder","Blackcomb Glacier","Village Nightlife","World Cup Racing"], photo:"https://images.unsplash.com/photo-1677164859770-9b971dd523df?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8Nnx8V2hpc3RsZXIlMjBCbGFja2NvbWIlMjBza2klMjByZXNvcnR8ZW58MXwwfHx8MTc4NDk0NTg5MXww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"epic", lateSeason:true,
  },
  {
    ...
    accent:"#a5d6a7", tags:["UV 11","Crystal Water"], photo:"https://images.unsplash.com/photo-1738762932370-468a90e0ff68?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8Qm9yYSUyMEJvcmElMjBMYWdvb24lMjBiZWFjaHxlbnwxfDB8fHwxNzg0OTQ1ODkxfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75",
  },
  {
    ...
    accent:"#90caf9", tags:["Off-Piste","Mont Blanc Views"], photo:"https://images.unsplash.com/photo-1465220183275-1faa863377e3?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8Q2hhbW9uaXgtTW9udC1CbGFuYyUyMHNraSUyMHJlc29ydHxlbnwxfDB8fHwxNzg0OTQ1ODkyfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"ikon", lateSeason:true,
  },
  {id:"aspen",       category:"skiing",title:"Aspen Snowmass",          location:"Colorado, USA",            lat:39.1911,lon:-106.8175,ap:"ASE",icon:"⛷️",rating:4.97,reviews:3210,gradient:"linear-gradient(160deg,#0d1b35,#1a3a7a,#3a6ac4)",accent:"#7eb3e8",tags:["Expert Terrain","Luxury Village"], photo:"https://images.unsplash.com/photo-1614444894791-c0c4d4286c35?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8QXNwZW4lMjBTbm93bWFzcyUyMHNraSUyMHJlc29ydHxlbnwxfDB8fHwxNzg0OTQ1ODkyfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"ikon"},
  {id:"vail",        category:"skiing",title:"Vail Mountain",           location:"Colorado, USA",            lat:39.6433,lon:-106.3722,ap:"EGE",icon:"⛷️",rating:4.96,reviews:4120,gradient:"linear-gradient(160deg,#0d1b35,#1a3c7c,#2e68c2)",accent:"#82b4e8",tags:["Back Bowls","All Levels"], photo:"https://images.unsplash.com/photo-1771022110449-f1dea48f275b?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8VmFpbCUyME1vdW50YWluJTIwc2tpJTIwcmVzb3J0fGVufDF8MHx8fDE3ODQ5NDU4OTN8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"epic"},
  {id:"alta",        category:"skiing",title:"Alta",              location:"Utah, USA",                lat:40.5883,lon:-111.6358,ap:"SLC",icon:"⛷️",rating:4.96,reviews:2960,gradient:"linear-gradient(160deg,#0a1828,#1a3870,#2e66be)",accent:"#78ace4",tags:["Ski Only","Deep Powder"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Alta_Baldy_Chutes.JPG/1280px-Alta_Baldy_Chutes.JPG", skiPass:"ikon"},
  {id:"jacksonhole", category:"skiing",title:"Jackson Hole Mountain",   location:"Wyoming, USA",             lat:43.5875,lon:-110.8279,ap:"JAC",icon:"⛷️",rating:4.97,reviews:3440,gradient:"linear-gradient(160deg,#0d1c36,#1a3c7a,#3068c4)",accent:"#76aedf",tags:["Teton Views","Expert+"], photo:"https://images.unsplash.com/photo-1778704904143-23ee6279096a?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8SmFja3NvbiUyMEhvbGUlMjBNb3VudGFpbiUyMFVTQXxlbnwxfDB8fHwxNzg0OTQ1ODk0fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"ikon"},
  {id:"telluride",   category:"skiing",title:"Telluride Ski Resort",    location:"Colorado, USA",            lat:37.9364,lon:-107.8123,ap:"MTJ",icon:"⛷️",rating:4.96,reviews:2100,gradient:"linear-gradient(160deg,#0c1a34,#1a3878,#2e64c0)",accent:"#72a8dc",tags:["Box Canyon","Ski-In/Out Town"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Telluride_Ski_Resort%2C_Col._%288644075803%29.jpg/1280px-Telluride_Ski_Resort%2C_Col._%288644075803%29.jpg", skiPass:"epic"},
  {id:"breckenridge",category:"skiing",title:"Breckenridge",           location:"Colorado, USA",            lat:39.4817,lon:-106.0384,ap:"DEN",icon:"⛷️",rating:4.93,reviews:4820,gradient:"linear-gradient(160deg,#0e1c38,#1a3e7e,#2e6cbe)",accent:"#78aada",tags:["Historic Town","Epic Pass"], photo:"https://images.unsplash.com/photo-1705104709818-b604df632379?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8M3x8QnJlY2tlbnJpZGdlJTIwc2tpJTIwcmVzb3J0fGVufDF8MHx8fDE3ODY1ODM5NTB8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"epic"},
  {id:"mammoth",     category:"skiing",title:"Mammoth Mountain",        location:"California, USA",          lat:37.6308,lon:-119.0326,ap:"RNO",icon:"⛷️",rating:4.94,reviews:3780,gradient:"linear-gradient(160deg,#0c1e38,#1a4280,#3270c0)",accent:"#74a6da",tags:["Sierra Nevada","Late Season"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Mammoth_Mountain_aerial.jpg/1280px-Mammoth_Mountain_aerial.jpg", skiPass:"ikon", lateSeason:true},
  {id:"steamboat",   category:"skiing",title:"Steamboat Springs",       location:"Colorado, USA",            lat:40.4572,lon:-106.8045,ap:"HDN",icon:"⛷️",rating:4.91,reviews:2860,gradient:"linear-gradient(160deg,#0d1e38,#1a4280,#3270be)",accent:"#72a4d8",tags:["Champagne Powder","Cowboy Style"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/Steamboat_Springs_Ski_Resort_%288644074507%29.jpg/1280px-Steamboat_Springs_Ski_Resort_%288644074507%29.jpg", skiPass:"ikon"},
  {id:"sunvalley",   category:"skiing",title:"Sun Valley",              location:"Idaho, USA",               lat:43.6936,lon:-114.3536,ap:"SUN",icon:"⛷️",rating:4.94,reviews:2420,gradient:"linear-gradient(160deg,#0c1c38,#1a4080,#3472c0)",accent:"#74a8da",tags:["Bald Mountain","Original Resort"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Skier%27s_Perspective_at_Sun_Valley_Resort.jpg/1280px-Skier%27s_Perspective_at_Sun_Valley_Resort.jpg", skiPass:"ikon"},
  {id:"snowbasin",   category:"skiing",title:"Snowbasin",               location:"Utah, USA",                lat:41.2161,lon:-111.8548,ap:"SLC",icon:"⛷️",rating:4.91,reviews:1980,gradient:"linear-gradient(160deg,#0e1e38,#1a4280,#3272be)",accent:"#72a4d8",tags:["Olympic Venue","Uncrowded"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/View_of_Snowbasin_Resort_from_Allen_Peak.jpg/1280px-View_of_Snowbasin_Resort_from_Allen_Peak.jpg", skiPass:"ikon"},
  {id:"taos",        category:"skiing",title:"Taos Ski Valley",         location:"New Mexico, USA",          lat:36.5953,lon:-105.4475,ap:"SAF",icon:"⛷️",rating:4.92,reviews:1640,gradient:"linear-gradient(160deg,#0d1c38,#1a3a78,#2e68b8)",accent:"#72a4d8",tags:["High Altitude","Southwest Vibes"], photo:"https://images.unsplash.com/photo-1620831061446-ae117a743d5b?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8VGFvcyUyMFNraSUyMFZhbGxleSUyMFVTQXxlbnwxfDB8fHwxNzg2NTgzOTUzfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"ikon"},
  {id:"grandtarghee",category:"skiing",title:"Grand Targhee Resort",   location:"Wyoming, USA",             lat:43.7883,lon:-110.9426,ap:"JAC",icon:"⛷️",rating:4.90,reviews:1340,gradient:"linear-gradient(160deg,#0c1c36,#1a3876,#2e66b6)",accent:"#74a4d8",tags:["Teton Views","Powder Stash"], photo:"https://images.unsplash.com/photo-1694002907932-d51554f5531b?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8R3JhbmQlMjBUYXJnaGVlfGVufDF8MHx8fDE3ODY1ODM5NTZ8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"ikon"},
  {id:"abasin",      category:"skiing",title:"Arapahoe Basin",          location:"Colorado, USA",            lat:39.6426,lon:-105.8718,ap:"DEN",icon:"⛷️",rating:4.89,reviews:2180,gradient:"linear-gradient(160deg,#0a1a34,#1a3876,#2e66ba)",accent:"#72a6d8",tags:["Longest Season CO","The Legend"], photo:"https://images.unsplash.com/photo-1621371877304-820fa4a91078?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8QXJhcGFob2UlMjBCYXNpbiUyMHNraSUyMHJlc29ydHxlbnwxfDB8fHwxNzg2NTgzOTU2fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"ikon", lateSeason:true},
  {id:"sugarbush",   category:"skiing",title:"Sugarbush Resort",        location:"Vermont, USA",             lat:44.1356,lon:-72.9014,ap:"BTV",icon:"⛷️",rating:4.90,reviews:1940,gradient:"linear-gradient(160deg,#0d1c38,#1a3e7c,#2e6abc)",accent:"#76a8da",tags:["Mad River Valley","East Coast Best"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Sugarbush_Ski_Trail_Signage_2015.jpg/1280px-Sugarbush_Ski_Trail_Signage_2015.jpg", skiPass:"ikon"},
  {id:"stratton",    category:"skiing",title:"Stratton Mountain",       location:"Vermont, USA",             lat:43.1134,lon:-72.9076,ap:"ALB",icon:"⛷️",rating:4.89,reviews:2060,gradient:"linear-gradient(160deg,#0c1a36,#1a3a78,#2e66b8)",accent:"#72a6d8",tags:["Southern VT","Snowboard Birthplace"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Stratton_Mountain.jpg/1280px-Stratton_Mountain.jpg", skiPass:"ikon"},
  {id:"keystone",    category:"skiing",title:"Keystone Resort",         location:"Colorado, USA",            lat:39.6045,lon:-105.9516,ap:"DEN",icon:"⛷️",rating:4.92,reviews:3480,gradient:"linear-gradient(160deg,#0d1c38,#1a3e7e,#2e6cc0)",accent:"#76aada",tags:["Night Skiing","3 Peaks"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Snow_covered_mountains_in_Keystone_Ski_Resort_%28Unsplash%29.jpg/1280px-Snow_covered_mountains_in_Keystone_Ski_Resort_%28Unsplash%29.jpg", skiPass:"epic"},
  {id:"crestedbutte",category:"skiing",title:"Crested Butte Mountain",  location:"Colorado, USA",            lat:38.8992,lon:-106.9655,ap:"GUC",icon:"⛷️",rating:4.94,reviews:2060,gradient:"linear-gradient(160deg,#0c1a36,#1a3a7a,#2e68be)",accent:"#74a8dc",tags:["Extreme Terrain","Last Great Ski Town"], photo:"https://images.unsplash.com/photo-1772814587985-c663fdce9533?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8Q3Jlc3RlZCUyMEJ1dHRlJTIwVVNBfGVufDF8MHx8fDE3ODY1ODc0OTl8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"epic"},
  {id:"heavenly",    category:"skiing",title:"Heavenly Mountain",       location:"California, USA",          lat:38.9332,lon:-119.9400,ap:"RNO",icon:"⛷️",rating:4.93,reviews:3580,gradient:"linear-gradient(160deg,#0c1c38,#1a4080,#3270c2)",accent:"#74a8dc",tags:["Lake Tahoe Views","Gondola Ride"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Heavenly_Gondolas%2C_Lake_Tahoe%2C_CA_9-2010_%285815984302%29.jpg/1280px-Heavenly_Gondolas%2C_Lake_Tahoe%2C_CA_9-2010_%285815984302%29.jpg", skiPass:"epic"},
  {id:"okemo",       category:"skiing",title:"Okemo Mountain Resort",   location:"Vermont, USA",             lat:43.4017,lon:-72.7174,ap:"ALB",icon:"⛷️",rating:4.89,reviews:2180,gradient:"linear-gradient(160deg,#0c1a36,#1a3a78,#2e66b8)",accent:"#72a6d8",tags:["Immaculate Grooming","Family Resort"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Okemo-2005-0316a.jpg/1280px-Okemo-2005-0316a.jpg", skiPass:"epic"},
  {id:"whitefish",   category:"skiing",title:"Whitefish Mountain",      location:"Montana, USA",             lat:48.4825,lon:-114.3487,ap:"FCA",icon:"⛷️",rating:4.92,reviews:1840,gradient:"linear-gradient(160deg,#0c1a36,#1a3878,#2e66b8)",accent:"#72a6d8",tags:["Glacier NP Gateway","3,000 Acres"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Facing_North-East_from_Whitefish_Mountain_Ski_Hill_-_panoramio.jpg/1280px-Facing_North-East_from_Whitefish_Mountain_Ski_Hill_-_panoramio.jpg", skiPass:"independent"},
  {id:"mthood",      category:"skiing",title:"Mt Hood Meadows",         location:"Oregon, USA",              lat:45.3311,lon:-121.6648,ap:"PDX",icon:"⛷️",rating:4.90,reviews:2060,gradient:"linear-gradient(160deg,#0c1c38,#1a3c7a,#2e68bc)",accent:"#74a8da",tags:["Pacific NW","2,150 Acres"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Disabled_skier_at_Mt_Hood_Meadows-Mt_Hood_%2825827491143%29.jpg/1280px-Disabled_skier_at_Mt_Hood_Meadows-Mt_Hood_%2825827491143%29.jpg", skiPass:"independent"},
  {id:"alyeska",     category:"skiing",title:"Alyeska Resort",          location:"Alaska, USA",              lat:60.9697,lon:-149.0989,ap:"ANC",icon:"⛷️",rating:4.93,reviews:1320,gradient:"linear-gradient(160deg,#0a1a30,#1a3870,#2e66c0)",accent:"#74aadc",tags:["Alaska's Largest","Glacier Views"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Alyeska_Resort.JPG/1280px-Alyeska_Resort.JPG", skiPass:"independent"},
  {id:"niseko",      category:"skiing",title:"Niseko United",           location:"Hokkaido, Japan",          lat:42.8048,lon:140.6879,ap:"CTS",icon:"⛷️",rating:4.97,reviews:3180,gradient:"linear-gradient(160deg,#0d1c40,#1a3e88,#3a78d4)",accent:"#7ab4ec",tags:["Japow","200+ Snow Days"], photo:"https://images.unsplash.com/photo-1607746672355-e467302a3600?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8SG9ra2FpZG8lMjBKYXBhbiUyMHNraSUyMHJlc29ydHxlbnwxfDB8fHwxNzg0OTQ1ODk3fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"ikon"},
  {id:"rusutsu",     category:"skiing",title:"Rusutsu Resort",          location:"Hokkaido, Japan",          lat:42.7517,lon:140.8956,ap:"CTS",icon:"⛷️",rating:4.92,reviews:1580,gradient:"linear-gradient(160deg,#0c1c40,#1a3e88,#3876d0)",accent:"#76b0ea",tags:["Uncrowded Japow","Tree Runs"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Rusutsu_WestMt%28200703%29.jpg/1280px-Rusutsu_WestMt%28200703%29.jpg", skiPass:"ikon"},
  {id:"nozawa",      category:"skiing",title:"Nozawa Onsen",            location:"Nagano, Japan",            lat:36.9221,lon:138.4434,ap:"NRT",icon:"⛷️",rating:4.91,reviews:1260,gradient:"linear-gradient(160deg,#0e2040,#1a4088,#3878d2)",accent:"#78b2ea",tags:["Onsen Après","Authentic Village"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Nozawa_Onsen_01.jpg/1280px-Nozawa_Onsen_01.jpg", skiPass:"independent"},
  {id:"remarkables", category:"skiing",title:"The Remarkables",         location:"Queenstown, New Zealand",  lat:-45.0400,lon:168.7862,ap:"ZQN",icon:"⛷️",rating:4.92,reviews:1880,gradient:"linear-gradient(160deg,#0a1c2e,#1a4070,#2e74b8)",accent:"#68aadc",tags:["Queenstown Base","Scenic Views"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/New_zealand_remarkables.jpg/1280px-New_zealand_remarkables.jpg", skiPass:"ikon"},
  {id:"courchevel",  category:"skiing",title:"Courchevel",              location:"Les 3 Vallées, France",    lat:45.4146,lon:6.6337,ap:"CMF",icon:"⛷️",rating:4.96,reviews:3240,gradient:"linear-gradient(160deg,#0c1432,#1e2e72,#3048c2)",accent:"#6e8ae4",tags:["Luxury Chalet","Linked Ski Area"], photo:"https://images.unsplash.com/photo-1649421811395-5bfcf16cc37a?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8Q291cmNoZXZlbCUyMEZyYW5jZXxlbnwxfDB8fHwxNzg0OTQ1ODk5fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"independent"},
  {id:"tignes",      category:"skiing",title:"Tignes / Val d'Isère",   location:"Espace Killy, France",     lat:45.4708,lon:6.9057,ap:"CMF",icon:"⛷️",rating:4.94,reviews:2960,gradient:"linear-gradient(160deg,#0c1430,#1e2c72,#3046c0)",accent:"#6c88e2",tags:["Summer Glacier","Huge Domain"], photo:"https://images.unsplash.com/photo-1740327986659-2acba8a87eb6?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8VGlnbmVzJTIwJTJGJTIwVmFsJTIwZCUyN0lzJUMzJUE4cmUlMjBza2klMjByZXNvcnR8ZW58MXwwfHx8MTc4NDk0NTg5OXww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"independent", lateSeason:true},
  {id:"andermatt",   category:"skiing",title:"Andermatt",               location:"Uri, Switzerland",         lat:46.6363,lon:8.5942,ap:"ZRH",icon:"⛷️",rating:4.92,reviews:1820,gradient:"linear-gradient(160deg,#0d1832,#1a3a72,#2e62b8)",accent:"#70a8da",tags:["New World-Class","High Alpine"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/00_0350_Andermatt_-_Ski-Gebiet_Gurschen_%E2%80%93_Gemsstock.jpg/1280px-00_0350_Andermatt_-_Ski-Gebiet_Gurschen_%E2%80%93_Gemsstock.jpg", skiPass:"epic"},
  {id:"hintertux-glacier", category:"skiing",title:"Hintertux Glacier",location:"Zillertal, Tyrol, Austria",lat:47.0583,lon:11.6633,ap:"INN",icon:"⛷️",rating:4.88,reviews:1620,gradient:"linear-gradient(160deg,#0c1634,#1a3272,#2a5ab2)",accent:"#74a2d8",tags:["Year-Round Glacier","Only 365-Day Alps Ski","Summer Skiing","Zillertal"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Hintertux_Glacier.jpg/1280px-Hintertux_Glacier.jpg", skiPass:"independent", lateSeason:true},
  {id:"ischgl",      category:"skiing",title:"Ischgl",                  location:"Silvretta Arena, Austria", lat:47.0127,lon:10.2928,ap:"INN",icon:"⛷️",rating:4.94,reviews:3120,gradient:"linear-gradient(160deg,#0d1630,#1e3070,#2c5ab2)",accent:"#6c9ed2",tags:["Nightlife","Tax-Free Shopping"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Ischgl_01.jpg/1280px-Ischgl_01.jpg", skiPass:"ikon"},
  {id:"kitzbuehel",  category:"skiing",title:"Kitzbühel",               location:"Tyrol, Austria",           lat:47.4467,lon:12.3922,ap:"SZG",icon:"⛷️",rating:4.94,reviews:3840,gradient:"linear-gradient(160deg,#0e1630,#1e3272,#2e5eb4)",accent:"#6ea0d4",tags:["Hahnenkamm Races","Historic Town"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Kitzb%C3%BChel-Hahnenkamm_Spar.JPG/1280px-Kitzb%C3%BChel-Hahnenkamm_Spar.JPG", skiPass:"ikon"},
  {id:"cervinia",    category:"skiing",title:"Cervinia",                location:"Aosta Valley, Italy",      lat:45.9373,lon:7.6271,ap:"TRN",icon:"⛷️",rating:4.91,reviews:2120,gradient:"linear-gradient(160deg,#101832,#203872,#3462b2)",accent:"#6ea0d4",tags:["Matterhorn Italy","High Altitude"], photo:"https://images.unsplash.com/photo-1697754262007-0315b675a2fc?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8Q2VydmluaWElMjBJdGFseXxlbnwxfDB8fHwxNzg2NTg3NTAzfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"independent", lateSeason:true},
  {id:"beach_gcm",      category:"beach",title:"Seven Mile Beach",       location:"Grand Cayman, Cayman Islands",  lat:19.3180,lon:-81.3902,ap:"GCM",icon:"🏖️",rating:4.97,reviews:14200,gradient:"linear-gradient(160deg,#003344,#006688,#00aabb)",accent:"#00ddee",tags:["World's Best Beach","Crystal Caribbean"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Seven_Mile_Beach_Facing_North.jpg/1280px-Seven_Mile_Beach_Facing_North.jpg"},
  {id:"beach_grace",    category:"beach",title:"Grace Bay",              location:"Providenciales, Turks & Caicos",lat:21.7918,lon:-72.2598,ap:"PLS",icon:"🏖️",rating:4.98,reviews:11900,gradient:"linear-gradient(160deg,#002233,#004466,#0077aa)",accent:"#00bbee",tags:["#1 Ranked Beach","Swim-Through Reef"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Sunset_in_Grace_Bay%2C_Turks_and_Caicos_Islands.jpg/1280px-Sunset_in_Grace_Bay%2C_Turks_and_Caicos_Islands.jpg"},
  {id:"beach_shoal",    category:"beach",title:"Shoal Bay East",         location:"Anguilla",                      lat:18.2130,lon:-63.0420,ap:"AXA",icon:"🏖️",rating:4.96,reviews:4800,gradient:"linear-gradient(160deg,#003355,#0055aa,#0088dd)",accent:"#33bbff",tags:["Powdery White Sand","Quiet & Exclusive"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Anguilla_Shoal_Bay_is_the_BEST_beach_in_the_Caribbean._-_panoramio.jpg/1280px-Anguilla_Shoal_Bay_is_the_BEST_beach_in_the_Caribbean._-_panoramio.jpg"},
  {id:"beach_eagle",    category:"beach",title:"Eagle Beach",            location:"Aruba",                         lat:12.5600,lon:-70.0850,ap:"AUA",icon:"🏖️",rating:4.95,reviews:13400,gradient:"linear-gradient(160deg,#003355,#00558a,#0088bb)",accent:"#22aadd",tags:["Iconic Divi Tree","Year-Round Sun"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Eagle_Beach%2C_Aruba_1.jpg/1280px-Eagle_Beach%2C_Aruba_1.jpg"},
  {id:"beach_magens",   category:"beach",title:"Magens Bay",             location:"St. Thomas, USVI",              lat:18.3700,lon:-64.9330,ap:"STT",icon:"🏖️",rating:4.93,reviews:9200,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#33aaff",tags:["Protected Horseshoe","Palm-Lined Shore"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Magens_Bay%2C_St._Thomas%2C_USVI.jpg/1280px-Magens_Bay%2C_St._Thomas%2C_USVI.jpg"},
  {id:"beach_stlucia",  category:"beach",title:"Anse Chastanet",         location:"St. Lucia",                     lat:13.8630,lon:-61.0750,ap:"UVF",icon:"🏖️",rating:4.96,reviews:6200,gradient:"linear-gradient(160deg,#001a22,#003844,#006677)",accent:"#00aabb",tags:["Piton Views","Volcano Backdrop"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Anse_Chastanet%2C_Saint_Lucia_April_2007.jpg/1280px-Anse_Chastanet%2C_Saint_Lucia_April_2007.jpg"},
  {id:"beach_barbados", category:"beach",title:"Bottom Bay",             location:"Barbados",                      lat:13.0700,lon:-59.4450,ap:"BGI",icon:"🏖️",rating:4.94,reviews:7800,gradient:"linear-gradient(160deg,#003344,#006688,#0099aa)",accent:"#00ccdd",tags:["Atlantic Wonder","Coral Cliffs"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Bottom_Bay_%28375362563%29.jpg/1280px-Bottom_Bay_%28375362563%29.jpg"},
  {id:"beach_orient",   category:"beach",title:"Orient Bay",             location:"Saint-Martin, French Antilles",  lat:18.1000,lon:-63.0300,ap:"SXM",icon:"🏖️",rating:4.91,reviews:8600,gradient:"linear-gradient(160deg,#003355,#0055aa,#0088cc)",accent:"#33aadd",tags:["St-Barths Vibes","Water Sports Hub"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Orient_Bay%2C_SXM_island_in_the_Caribbean.JPG/1280px-Orient_Bay%2C_SXM_island_in_the_Caribbean.JPG"},
  {id:"beach_tobago",   category:"beach",title:"Pigeon Point",           location:"Tobago",                        lat:11.1650,lon:-60.8400,ap:"TAB",icon:"🏖️",rating:4.90,reviews:5400,gradient:"linear-gradient(160deg,#002233,#004466,#0077aa)",accent:"#00bbdd",tags:["Caribbean Soul","Offshore Coral"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Pigeon_Point_beach.jpg/1280px-Pigeon_Point_beach.jpg"},
  {id:"beach_negril",   category:"beach",title:"Seven Mile Beach Negril", location:"Jamaica",                      lat:18.3630,lon:-78.3440,ap:"MBJ",icon:"🏖️",rating:4.92,reviews:16800,gradient:"linear-gradient(160deg,#002200,#004400,#007700)",accent:"#44cc44",tags:["Legendary Sunsets","Cliff Diving"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Jamaica%2C_Negril_-_Flickr_-_VV_Nincic.jpg/1280px-Jamaica%2C_Negril_-_Flickr_-_VV_Nincic.jpg"},
  {id:"beach_holbox",   category:"beach",title:"Holbox Island",          location:"Quintana Roo, Mexico",          lat:21.5245,lon:-87.3690,ap:"CUN",icon:"🏖️",rating:4.96,reviews:9300,gradient:"linear-gradient(160deg,#002233,#005566,#0088aa)",accent:"#33bbcc",tags:["No Cars","Whale Shark Season"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/The_beach_of_Holbox_Island%2C_Mexico_%2851007646833%29.jpg/1280px-The_beach_of_Holbox_Island%2C_Mexico_%2851007646833%29.jpg"},
  {id:"beach_tulum",    category:"beach",title:"Tulum Beach",            location:"Tulum, Mexico",                 lat:20.1500,lon:-87.4630,ap:"CUN",icon:"🏖️",rating:4.93,reviews:21400,gradient:"linear-gradient(160deg,#003322,#006644,#009966)",accent:"#22ccaa",tags:["Mayan Ruins Backdrop","Crystal Cenotes"], photo:"https://images.unsplash.com/photo-1605217074767-688b113d3b43?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8VHVsdW0lMjBCZWFjaCUyMGJlYWNofGVufDF8MHx8fDE3ODQ5NDU5MDB8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_cozumel",  category:"beach",title:"Playa Palancar",         location:"Cozumel, Mexico",               lat:20.3500,lon:-87.0250,ap:"CZM",icon:"🏖️",rating:4.94,reviews:8900,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#33aaff",tags:["2nd Largest Reef","Crystal Visibility"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Palancar_beach_Cozumel_Mexico_%2821202413478%29.jpg/1280px-Palancar_beach_Cozumel_Mexico_%2821202413478%29.jpg"},
  {id:"beach_rivmaya",  category:"beach",title:"Riviera Maya",           location:"Quintana Roo, Mexico",          lat:20.6300,lon:-87.0790,ap:"CUN",icon:"🏖️",rating:4.88,reviews:38400,gradient:"linear-gradient(160deg,#002233,#004466,#0077aa)",accent:"#22aacc",tags:["Resorts + Cenotes","Mesoamerican Reef"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Riviera_Maya_Mexico_-_panoramio.jpg/1280px-Riviera_Maya_Mexico_-_panoramio.jpg"},
  {id:"beach_sayulita",category:"beach",title:"Sayulita",                location:"Nayarit, Mexico",               lat:20.8689,lon:-105.3977,ap:"PVR",icon:"🏖️",rating:4.91,reviews:11200,gradient:"linear-gradient(160deg,#332200,#665500,#998800)",accent:"#ddbb22",tags:["Bohemian Beach Town","Taco Heaven"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Beach_at_Sayulita_%2817268510126%29.jpg/1280px-Beach_at_Sayulita_%2817268510126%29.jpg"},
  {id:"beach_loscabos",category:"beach",title:"Playa del Amor",          location:"Los Cabos, Mexico",             lat:22.9325,lon:-109.9100,ap:"SJD",icon:"🏖️",rating:4.94,reviews:14600,gradient:"linear-gradient(160deg,#1a0d00,#4d2600,#804000)",accent:"#cc8833",tags:["El Arco Rock Arch","Sea of Cortez"], photo:"https://images.unsplash.com/photo-1566931603656-96071f3f69a6?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8UGxheWElMjBkZWwlMjBBbW9yJTIwYmVhY2h8ZW58MXwwfHx8MTc4NjU4NzUwNXww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_manuelant",category:"beach",title:"Manuel Antonio",         location:"Puntarenas, Costa Rica",        lat:9.3850,lon:-84.1420,ap:"SJO",icon:"🏖️",rating:4.93,reviews:12400,gradient:"linear-gradient(160deg,#001e00,#003d00,#006600)",accent:"#44cc44",tags:["Wildlife Everywhere","Rainforest Meets Sand"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Manuel_Antonio_beach%2C_Costa_Rica_-_55078432582.jpg/1280px-Manuel_Antonio_beach%2C_Costa_Rica_-_55078432582.jpg"},
  {id:"beach_bocas",    category:"beach",title:"Bocas del Toro",         location:"Panama",                        lat:9.3500,lon:-82.2420,ap:"BOC",icon:"🏖️",rating:4.90,reviews:7800,gradient:"linear-gradient(160deg,#002233,#004466,#007799)",accent:"#33bbcc",tags:["Caribbean Jungle","Bioluminescent Bay"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/Bocas_del_Toro.jpg/1280px-Bocas_del_Toro.jpg"},
  {id:"beach_noronha",  category:"beach",title:"Fernando de Noronha",    location:"Pernambuco, Brazil",            lat:-3.8550,lon:-32.4270,ap:"FEN",icon:"🏖️",rating:4.99,reviews:5600,gradient:"linear-gradient(160deg,#001428,#002855,#004491)",accent:"#3366dd",tags:["Most Pristine Atlantic","Limited Visitors"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Morro_do_Pico_and_Concei%C3%A7%C3%A3o_Beach_in_Fernando_de_Noronha.jpg/1280px-Morro_do_Pico_and_Concei%C3%A7%C3%A3o_Beach_in_Fernando_de_Noronha.jpg"},
  {id:"beach_floripa",  category:"beach",title:"Praia Mole",             location:"Florianópolis, Brazil",         lat:-27.6050,lon:-48.4420,ap:"FLN",icon:"🏖️",rating:4.88,reviews:9200,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#3388ee",tags:["Brazil's Most Beautiful","Beach + Lagoon"], photo:"https://images.unsplash.com/photo-1559779415-bdb4e2cb3e11?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8UHJhaWElMjBNb2xlJTIwYmVhY2h8ZW58MXwwfHx8MTc4NjU4NzUwNnww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_ob",       category:"beach",title:"Outer Banks OBX",        location:"North Carolina, USA",           lat:35.5582,lon:-75.4665,ap:"ORF",icon:"🏖️",rating:4.89,reviews:18600,gradient:"linear-gradient(160deg,#001a28,#003350,#005580)",accent:"#3388bb",tags:["Wild Horses","Barrier Island Drive"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Beach_outer_banks_north_carolina.jpg/1280px-Beach_outer_banks_north_carolina.jpg"},
  {id:"beach_siestakey",category:"beach",title:"Siesta Key Beach",       location:"Sarasota, Florida",             lat:27.2671,lon:-82.5471,ap:"SRQ",icon:"🏖️",rating:4.94,reviews:16800,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#33aaff",tags:["World's Finest Sand","Gulf Sunset Views"], photo:"https://images.unsplash.com/photo-1710088769598-7edfde6d7882?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8NXx8U2llc3RhJTIwS2V5JTIwQmVhY2glMjBiZWFjaHxlbnwxfDB8fHwxNzg2NTg3NTA3fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_clearwater",category:"beach",title:"Clearwater Beach",      location:"Florida, USA",                  lat:27.9783,lon:-82.8279,ap:"TPA",icon:"🏖️",rating:4.91,reviews:22400,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#22aaff",tags:["Voted #1 USA Beach","Pier 60 Sunsets"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Clearwater_Beach%2C_Florida_%2835188097760%29.jpg/1280px-Clearwater_Beach%2C_Florida_%2835188097760%29.jpg"},
  {id:"beach_keywest",  category:"beach",title:"Key West Beaches",       location:"Florida Keys, USA",             lat:24.5551,lon:-81.7800,ap:"EYW",icon:"🏖️",rating:4.87,reviews:14200,gradient:"linear-gradient(160deg,#001a22,#003344,#005566)",accent:"#22aacc",tags:["Southernmost Point","Duval Street"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Early_morning_Smathers_Beach_Key_West.JPG/1280px-Early_morning_Smathers_Beach_Key_West.JPG"},
  {id:"beach_destin",   category:"beach",title:"Emerald Coast Destin",   location:"Florida, USA",                  lat:30.3935,lon:-86.4958,ap:"VPS",icon:"🏖️",rating:4.92,reviews:19800,gradient:"linear-gradient(160deg,#003344,#005577,#007faa)",accent:"#33bbcc",tags:["Emerald Water","Sugar-White Sand"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Destin_Beach_Florida_100_1103.jpg/1280px-Destin_Beach_Florida_100_1103.jpg"},
  ...
  {id:"beach_lanikai",  category:"beach",title:"Lanikai Beach",          location:"Oahu, Hawaii",                  lat:21.3900,lon:-157.7200,ap:"HNL",icon:"🏖️",rating:4.98,reviews:12400,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#33aaff",tags:["Mokulua Islands View","Powdery White Sand"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Lanikai_beach%2C_Oahu_Hawaii.JPG/1280px-Lanikai_beach%2C_Oahu_Hawaii.JPG"},
  {id:"beach_hapuna",   category:"beach",title:"Hapuna Beach",           location:"Big Island, Hawaii",            lat:20.0040,lon:-155.8270,ap:"KOA",icon:"🏖️",rating:4.96,reviews:8600,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#33bbff",tags:["Hawaii's Best Beach","Snorkeling Coves"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Hapuna_Beach_Hawaii_2021.jpg/1280px-Hapuna_Beach_Hawaii_2021.jpg"},
  {id:"beach_kapalua",  category:"beach",title:"Kapalua Bay",            location:"Maui, Hawaii",                  lat:20.9990,lon:-156.6750,ap:"OGG",icon:"🏖️",rating:4.95,reviews:7800,gradient:"linear-gradient(160deg,#003344,#006688,#0099bb)",accent:"#22bbdd",tags:["Crescent Bay","Spinner Dolphins"], photo:"https://images.unsplash.com/photo-1666427342335-65e2854803f9?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8S2FwYWx1YSUyMEJheSUyMGJlYWNofGVufDF8MHx8fDE3ODY1ODc1MTF8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_positano", category:"beach",title:"Positano Beach",         location:"Amalfi Coast, Italy",           lat:40.6280,lon:14.4850,ap:"NAP",icon:"🏖️",rating:4.92,reviews:22800,gradient:"linear-gradient(160deg,#001a33,#003366,#004d99)",accent:"#3377dd",tags:["Cliffside Pastel Town","Amalfi Drive"], photo:"https://images.unsplash.com/photo-1718800329397-80b8a150b5be?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8NXx8UG9zaXRhbm8lMjBCZWFjaCUyMGJlYWNofGVufDF8MHx8fDE3ODY1ODc1MTJ8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_sardinia", category:"beach",title:"Cala Mariolu",           location:"Sardinia, Italy",               lat:40.0980,lon:9.5600,ap:"CAG",icon:"🏖️",rating:4.98,reviews:8400,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#33aaff",tags:["Caribbean-Clear Water","Boulders + Coves"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Cala_Mariolu_-_Sardinia.jpg/1280px-Cala_Mariolu_-_Sardinia.jpg"},
  {id:"beach_algarve",  category:"beach",title:"Praia da Marinha",       location:"Algarve, Portugal",             lat:37.0870,lon:-8.4110,ap:"FAO",icon:"🏖️",rating:4.96,reviews:14600,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#3399ff",tags:["Rock Arch + Sea Caves","Top10 Europe"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Praia_da_Marinha-Algarve-Portugal.jpg/1280px-Praia_da_Marinha-Algarve-Portugal.jpg"},
  {id:"beach_santorini",category:"beach",title:"Santorini Red Beach",    location:"Santorini, Greece",             lat:36.3470,lon:25.3960,ap:"JTR",icon:"🏖️",rating:4.91,reviews:19400,gradient:"linear-gradient(160deg,#330000,#660000,#990000)",accent:"#dd4444",tags:["Volcanic Red Cliffs","Caldera Views"], photo:"https://images.unsplash.com/photo-1651617733477-6cc82ceb3730?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8U2FudG9yaW5pJTIwUmVkJTIwQmVhY2glMjBiZWFjaHxlbnwxfDB8fHwxNzg0OTQ1OTAwfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_mykonos",  category:"beach",title:"Paradise Beach Mykonos", location:"Mykonos, Greece",               lat:37.4218,lon:25.3472,ap:"JMK",icon:"🏖️",rating:4.89,reviews:21600,gradient:"linear-gradient(160deg,#003355,#0055aa,#0088dd)",accent:"#33bbff",tags:["Non-Stop Party Beach","Crystal Aegean"], photo:"https://images.unsplash.com/photo-1627243014832-c1c8bbbafff5?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8UGFyYWRpc2UlMjBCZWFjaCUyME15a29ub3MlMjBiZWFjaHxlbnwxfDB8fHwxNzg0OTQ1OTAxfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_hvar",     category:"beach",title:"Hvar Hula Hula Beach",   location:"Hvar Island, Croatia",          lat:43.1730,lon:16.4410,ap:"SPU",icon:"🏖️",rating:4.90,reviews:12200,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#3399ff",tags:["Lavender Island","Adriatic Glamour"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Hvar_Croatia_beach_%2827961916426%29.jpg/1280px-Hvar_Croatia_beach_%2827961916426%29.jpg"},
  {id:"beach_dubrovnik",category:"beach",title:"Banje Beach Dubrovnik",  location:"Dubrovnik, Croatia",            lat:42.6340,lon:18.1250,ap:"DBV",icon:"🏖️",rating:4.88,reviews:14600,gradient:"linear-gradient(160deg,#001a33,#003366,#0055aa)",accent:"#3377cc",tags:["Old City Backdrop","Adriatic Clear"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Banje_Beach.jpg/1280px-Banje_Beach.jpg"},
  {id:"beach_milos",    category:"beach",title:"Sarakiniko Moon Beach",  location:"Milos Island, Greece",          lat:36.7570,lon:24.3900,ap:"MLO",icon:"🏖️",rating:4.97,reviews:8900,gradient:"linear-gradient(160deg,#e8e8e8,#cccccc,#aaaaaa)",accent:"#888888",tags:["White Volcanic Pumice","Lunar Landscape"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Sarakiniko_Beach_on_Milos_Island%2C_Greece_with_a_view_of_the_Aegean_Sea.jpg/1280px-Sarakiniko_Beach_on_Milos_Island%2C_Greece_with_a_view_of_the_Aegean_Sea.jpg"},
  {id:"beach_ibiza",    category:"beach",title:"Ses Salines Ibiza",      location:"Ibiza, Spain",                  lat:38.8720,lon:1.3960,ap:"IBZ",icon:"🏖️",rating:4.92,reviews:18400,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#3399ff",tags:["Natural Park Beach","White Island Vibes"], photo:"https://images.unsplash.com/photo-1661887561486-1f771e7b2cab?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8U2VzJTIwU2FsaW5lcyUyMEliaXphJTIwU3BhaW58ZW58MXwwfHx8MTc4NDk0NTkwMnww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_formentera",category:"beach",title:"Formentera Illetes",    location:"Formentera, Spain",             lat:38.7310,lon:1.3820,ap:"IBZ",icon:"🏖️",rating:4.97,reviews:11800,gradient:"linear-gradient(160deg,#003355,#005588,#0088bb)",accent:"#33aadd",tags:["Caribbean of Europe","Car-Free Island"], photo:"https://images.unsplash.com/photo-1663145492026-da93fb19a5f7?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8M3x8Rm9ybWVudGVyYSUyMElsbGV0ZXMlMjBiZWFjaHxlbnwxfDB8fHwxNzg2NTg3NTE0fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_menorca",  category:"beach",title:"Cala Macarella",         location:"Menorca, Spain",                lat:39.9010,lon:3.8080,ap:"MAH",icon:"🏖️",rating:4.96,reviews:9400,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#3399ff",tags:["Emerald Cove","Untouched Pine Forest"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Cala_Macarella.jpg/1280px-Cala_Macarella.jpg"},
  {id:"beach_cotedazur",category:"beach",title:"Côte d'Azur Antibes",   location:"French Riviera, France",        lat:43.5806,lon:7.1287,ap:"NCE",icon:"🏖️",rating:4.88,reviews:22800,gradient:"linear-gradient(160deg,#00133d,#00266e,#0044b3)",accent:"#3366ee",tags:["French Riviera","Billionaire Yachts"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/Antibes_-_beach.jpg/1280px-Antibes_-_beach.jpg"},
  {id:"beach_diani",    category:"beach",title:"Diani Beach",            location:"Mombasa, Kenya",                lat:-4.2720,lon:39.5930,ap:"MBA",icon:"🏖️",rating:4.93,reviews:8800,gradient:"linear-gradient(160deg,#003322,#006644,#009966)",accent:"#22cc88",tags:["White Coral Sand","Colobus Monkeys"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Diani_beach.JPG/1280px-Diani_beach.JPG"},
  {id:"beach_zanzibar", category:"beach",title:"Nungwi Beach",           location:"Zanzibar, Tanzania",            lat:-5.7215,lon:39.2978,ap:"ZNZ",icon:"🏖️",rating:4.95,reviews:12400,gradient:"linear-gradient(160deg,#003344,#006688,#0099bb)",accent:"#22bbdd",tags:["Spice Island","Dhow Sunset Cruises"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/White_sandy_beach_at_Nungwi%2C_Zanzibar.jpg/1280px-White_sandy_beach_at_Nungwi%2C_Zanzibar.jpg"},
  {id:"beach_seychelles",category:"beach",title:"Anse Source d'Argent",  location:"La Digue, Seychelles",          lat:-4.3636,lon:55.8381,ap:"SEZ",icon:"🏖️",rating:4.99,reviews:10200,gradient:"linear-gradient(160deg,#003344,#006688,#0099bb)",accent:"#33ccdd",tags:["Most Photographed Beach","Granite Boulders"], photo:"https://images.unsplash.com/photo-1648647956216-47b74d1f6517?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8Nnx8QW5zZSUyMFNvdXJjZSUyMGQlMjdBcmdlbnQlMjBiZWFjaHxlbnwxfDB8fHwxNzg2NTg3NTE1fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_praslin",  category:"beach",title:"Anse Lazio",             location:"Praslin, Seychelles",           lat:-4.2836,lon:55.7133,ap:"PRI",icon:"🏖️",rating:4.98,reviews:8600,gradient:"linear-gradient(160deg,#003344,#006688,#0099cc)",accent:"#22bbee",tags:["Verdure d'Eau Clear","World Top10"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Anse_Lazio_Praslin_Seychelles_1.jpg/1280px-Anse_Lazio_Praslin_Seychelles_1.jpg"},
  {id:"beach_mauritius",category:"beach",title:"Belle Mare Plage",       location:"Mauritius",                     lat:-20.2700,lon:57.7700,ap:"MRU",icon:"🏖️",rating:4.95,reviews:11200,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#3399ff",tags:["Turquoise Lagoon","Indian Ocean Luxury"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/Mauritius_belle_mare_beach.jpg/1280px-Mauritius_belle_mare_beach.jpg"},
  {id:"beach_railay",   category:"beach",title:"Railay Beach",           location:"Krabi, Thailand",               lat:8.0107,lon:98.8382,ap:"KBV",icon:"🏖️",rating:4.97,reviews:18400,gradient:"linear-gradient(160deg,#002233,#005566,#009999)",accent:"#22ddcc",tags:["Limestone Cliffs","Accessible by Boat Only"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Railay_Beach_5.jpg/1280px-Railay_Beach_5.jpg"},
  {id:"beach_kohsamui", category:"beach",title:"Chaweng Beach",          location:"Koh Samui, Thailand",           lat:9.5317,lon:100.0672,ap:"USM",icon:"🏖️",rating:4.88,reviews:24600,gradient:"linear-gradient(160deg,#002233,#004466,#0077aa)",accent:"#22aacc",tags:["Gulf of Thailand","Full Moon Parties"], photo:"https://images.unsplash.com/photo-1733470252664-ce515758631d?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8M3x8S29oJTIwU2FtdWklMjBUaGFpbGFuZCUyMGJlYWNofGVufDF8MHx8fDE3ODY1ODc1MTl8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_phiphi",   category:"beach",title:"Maya Bay Phi Phi",       location:"Krabi, Thailand",               lat:7.6775,lon:98.7669,ap:"HKT",icon:"🏖️",rating:4.94,reviews:22800,gradient:"linear-gradient(160deg,#002233,#005566,#008888)",accent:"#22cccc",tags:["The Beach Film Location","Emerald Lagoon"], photo:"https://images.unsplash.com/photo-1676648433601-a8f699da0b55?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8TWF5YSUyMEJheSUyMFBoaSUyMFBoaSUyMGJlYWNofGVufDF8MHx8fDE3ODY1ODc1MjB8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_elnido",   category:"beach",title:"El Nido Bacuit Bay",     location:"Palawan, Philippines",          lat:11.1784,lon:119.3944,ap:"ENI",icon:"🏖️",rating:4.98,reviews:16200,gradient:"linear-gradient(160deg,#003344,#006677,#0099aa)",accent:"#22bbcc",tags:["UNESCO Biosphere","Kayak the Lagoons"], photo:"https://images.unsplash.com/photo-1694442948802-00beebcf6448?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8Nnx8UGFsYXdhbiUyMFBoaWxpcHBpbmVzJTIwYmVhY2h8ZW58MXwwfHx8MTc4NjU4NzUyM3ww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_boracay",  category:"beach",title:"White Beach Boracay",    location:"Aklan, Philippines",            lat:11.9674,lon:121.9248,ap:"MPH",icon:"🏖️",rating:4.92,reviews:28800,gradient:"linear-gradient(160deg,#003355,#005588,#0088bb)",accent:"#33aadd",tags:["World Famous White Beach","4km of Sand"], photo:"https://images.unsplash.com/photo-1639526473371-e68e5336df56?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8V2hpdGUlMjBCZWFjaCUyMEJvcmFjYXklMjBiZWFjaHxlbnwxfDB8fHwxNzg0OTQ1OTAyfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_nusapenida",category:"beach",title:"Kelingking Secret Beach",location:"Nusa Penida, Indonesia",        lat:-8.8340,lon:115.4560,ap:"DPS",icon:"🏖️",rating:4.97,reviews:19400,gradient:"linear-gradient(160deg,#002233,#004466,#007799)",accent:"#33aacc",tags:["T-Rex Cliff","Instagram Iconic"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Kelingking_Beach_%28T-Rex_Bay%29_of_Nusa_Penida%2C_Bali_%282025%29_-_img_08.jpg/1280px-Kelingking_Beach_%28T-Rex_Bay%29_of_Nusa_Penida%2C_Bali_%282025%29_-_img_08.jpg"},
  {id:"beach_gilit",    category:"beach",title:"Gili Trawangan",         location:"Lombok, Indonesia",             lat:-8.3520,lon:116.0500,ap:"LOP",icon:"🏖️",rating:4.90,reviews:14600,gradient:"linear-gradient(160deg,#003344,#006688,#0099bb)",accent:"#22ccdd",tags:["No Cars No Motorized Vehicles","Turtle Sanctuary"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Gili-Trawangan-and-Lombok.jpg/1280px-Gili-Trawangan-and-Lombok.jpg"},
  {id:"beach_aitutaki", category:"beach",title:"Aitutaki Lagoon",        location:"Aitutaki, Cook Islands",        lat:-18.8588,lon:-159.7893,ap:"AIT",icon:"🏖️",rating:4.99,reviews:4600,gradient:"linear-gradient(160deg,#002244,#004488,#0077cc)",accent:"#33bbff",tags:["World's Most Beautiful Lagoon","Remote Paradise"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/Maina_Island%2C_Aitutaki_Lagoon%2C_Cook_Islands.jpg/1280px-Maina_Island%2C_Aitutaki_Lagoon%2C_Cook_Islands.jpg"},
  {id:"beach_whitehaven",category:"beach",title:"Whitehaven Beach",      location:"Whitsundays, Queensland",       lat:-20.2788,lon:149.0416,ap:"PPP",icon:"🏖️",rating:4.98,reviews:12800,gradient:"linear-gradient(160deg,#003344,#006688,#0099bb)",accent:"#33ccee",tags:["Hill Inlet Swirl","99% Silica Sand"], photo:"https://images.unsplash.com/photo-1602575146450-90893fbc4c8d?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8Nnx8V2hpdGVoYXZlbiUyMEJlYWNoJTIwYmVhY2h8ZW58MXwwfHx8MTc4NjU4NzUyNHww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"beach_cable",    category:"beach",title:"Cable Beach",            location:"Broome, Western Australia",     lat:-17.9500,lon:122.1800,ap:"BME",icon:"🏖️",rating:4.92,reviews:8600,gradient:"linear-gradient(160deg,#1a0d00,#4d2a00,#8c4a00)",accent:"#dd8833",tags:["Camel Sunset Ride","22km Red Pindan"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Broome_Cable_Beach_and_camels.jpg/1280px-Broome_Cable_Beach_and_camels.jpg"},
  {id:"beach_portdouglas",category:"beach",title:"Four Mile Beach",      location:"Port Douglas, Queensland",      lat:-16.4840,lon:145.4640,ap:"CNS",icon:"🏖️",rating:4.91,reviews:9200,gradient:"linear-gradient(160deg,#003344,#006688,#0099bb)",accent:"#22bbdd",tags:["Great Barrier Reef Gateway","Rainforest Meets Sea"], photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Four_Mile_Beach%2C_Port_Douglas%2C_Queensland_2020.jpg/1280px-Four_Mile_Beach%2C_Port_Douglas%2C_Queensland_2020.jpg"},
  {id:"zakopane",category:"skiing",title:"Zakopane",location:"Tatra Mountains, Poland",lat:49.2992,lon:19.9497,ap:"KRK",icon:"🎿",rating:4.82,reviews:1789,gradient:"linear-gradient(160deg,#0e3660,#1b63a9,#83b7e5)",accent:"#1b63a9",tags:["Tatras","Polish Alps","Cultural Hub","Ski Jumping"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Wyci%C4%85g_na_kozi%C5%84cu_w_zakopanem.jpg/1280px-Wyci%C4%85g_na_kozi%C5%84cu_w_zakopanem.jpg",skiPass:"independent"},
  {id:"schweitzer-mtn",category:"skiing",title:"Schweitzer Mountain",location:"Idaho, USA",lat:48.3583,lon:-116.6272,ap:"GEG",icon:"🎿",rating:4.87,reviews:1567,gradient:"linear-gradient(160deg,#0e3b68,#1b68b5,#87bbea)",accent:"#1b68b5",tags:["Lake Pend Oreille Views","Expert","Uncrowded","Idaho Gem"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/ISS063-E-74709_-_View_of_Earth.jpg/1280px-ISS063-E-74709_-_View_of_Earth.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail",skiPass:"ikon"},
  {id:"beach_spain_mallorca_es",category:"beach",title:"Es Trenc Beach, Mallorca",location:"Mallorca, Spain",lat:39.3426,lon:2.9877,ap:"PMI",icon:"🏖️",rating:4.90,reviews:2987,gradient:"linear-gradient(160deg,#0284c7,#0ea5e9,#e0f2fe)",accent:"#0ea5e9",tags:["UV 9","Naturist Area","White Sand","Crystal Sea","Undeveloped"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/fc/Foto_al_atardecer_en_la_playa_de_Es_Trencs.jpg/1280px-Foto_al_atardecer_en_la_playa_de_Es_Trencs.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail"},
  {id:"zell-am-see-s1",category:"skiing",title:"Zell am See",location:"Salzburg, Austria",lat:47.3333,lon:12.8,ap:"SZG",icon:"🏔️",rating:4.59,reviews:3214,gradient:"linear-gradient(160deg,#0d1b2a,#1565c0,#64b5f6)",accent:"#b3e5fc",tags:["Expert Terrain","Off-Piste","Deep Snow","Backcountry"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/PhylloscopusCollybitaZellerSee_02.jpg/1280px-PhylloscopusCollybitaZellerSee_02.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail", skiPass:"independent"},
  {id:"appi-kogen-s2",category:"skiing",title:"Appi Kogen",location:"Iwate, Japan",lat:39.9711,lon:140.9317,ap:"HNA",icon:"🏔️",rating:4.76,reviews:1985,gradient:"linear-gradient(160deg,#1a0533,#4a0e8f,#7c43bd)",accent:"#ce93d8",tags:["Beginner Slopes","Ski School","Family Friendly","Tohoku Powder"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Appi_Kogen_Ski_Resort_from_Sailer_Gondola_Jan_2005.jpg/1280px-Appi_Kogen_Ski_Resort_from_Sailer_Gondola_Jan_2005.jpg", skiPass:"independent"},
  {id:"hemsedal-s3",category:"skiing",title:"Hemsedal",location:"Viken, Norway",lat:60.8631,lon:8.5647,ap:"OSL",icon:"🏔️",rating:4.75,reviews:3001,gradient:"linear-gradient(160deg,#002233,#004466,#006699)",accent:"#80ccff",tags:["Black Diamonds","Steep Chutes","Variable Terrain","Long Season"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Hemsedal_skisenter_IMG_1341.JPG/1280px-Hemsedal_skisenter_IMG_1341.JPG", skiPass:"independent"},
  {id:"portillo-s4",category:"skiing",title:"Portillo",location:"Valparaiso, Chile",lat:-32.8333,lon:-70.1333,ap:"SCL",icon:"🏔️",rating:4.54,reviews:446,gradient:"linear-gradient(160deg,#001a00,#1b5e20,#4caf50)",accent:"#a5d6a7",tags:["Glacial Skiing","Scenic Views","Village Base","On-Piste"],photo:"https://images.unsplash.com/photo-1724872114702-b9a1ab685f85?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8M3x8UG9ydGlsbG8lMjBDaGlsZXxlbnwxfDB8fHwxNzg2OTI3NDE0fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"independent"},
  {id:"big-white-ski-s5",category:"skiing",title:"Big White Ski",location:"British Columbia, Canada",lat:49.7167,lon:-118.9333,ap:"YLW",icon:"🏔️",rating:4.71,reviews:3866,gradient:"linear-gradient(160deg,#1a3a5c,#2e6bbf,#6db3f2)",accent:"#6db3f2",tags:["Powder Day","All Levels","High Altitude","Groomed Runs"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Big_White_Ski_Resort%2C_Monashee_Mountains.jpg/1280px-Big_White_Ski_Resort%2C_Monashee_Mountains.jpg", skiPass:"ikon"},
  {id:"idre-fjall-s6",category:"skiing",title:"Idre Fjall",location:"Dalarna, Sweden",lat:61.8833,lon:12.6667,ap:"OSL",icon:"🏔️",rating:4.95,reviews:2664,gradient:"linear-gradient(160deg,#0d1b2a,#1565c0,#64b5f6)",accent:"#b3e5fc",tags:["Expert Terrain","Off-Piste","Deep Snow","Backcountry"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Idre_Fj%C3%A4ll_-_panoramio.jpg/1280px-Idre_Fj%C3%A4ll_-_panoramio.jpg", skiPass:"independent"},
  {id:"kicking-horse-s10",category:"skiing",title:"Kicking Horse",location:"British Columbia, Canada",lat:51.2979,lon:-117.0447,ap:"YYC",icon:"🏔️",rating:4.51,reviews:2760,gradient:"linear-gradient(160deg,#1a3a5c,#2e6bbf,#6db3f2)",accent:"#6db3f2",tags:["Powder Day","Expert Terrain","High Altitude","Steep Chutes"],photo:"https://images.unsplash.com/photo-1785970014400-ff8549877a8a?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8Mnx8S2lja2luZyUyMEhvcnNlJTIwQ2FuYWRhfGVufDF8MHx8fDE3ODY5Mjc0Mjd8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"epic"},
  {id:"kiroro-snow-world-s11",category:"skiing",title:"Kiroro Snow World",location:"Hokkaido, Japan",lat:43.0558,lon:140.9656,ap:"CTS",icon:"🏔️",rating:4.58,reviews:3869,gradient:"linear-gradient(160deg,#0d1b2a,#1565c0,#64b5f6)",accent:"#b3e5fc",tags:["Expert Terrain","Off-Piste","Deep Snow","Backcountry"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Kiroro_snow_world_Kiroro_gondola_near_9_of_30.JPG/1280px-Kiroro_snow_world_Kiroro_gondola_near_9_of_30.JPG", skiPass:"independent"},
  {id:"morzine-s12",category:"skiing",title:"Morzine",location:"Haute-Savoie, France",lat:46.1786,lon:6.7069,ap:"GVA",icon:"🏔️",rating:4.91,reviews:3064,gradient:"linear-gradient(160deg,#1a0533,#4a0e8f,#7c43bd)",accent:"#ce93d8",tags:["Beginner Slopes","Ski School","Family Friendly","Night Skiing"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Morzine_-_Avoriaz_-_Panorama_-_2025-10-11_22-49-35_001.jpg/1280px-Morzine_-_Avoriaz_-_Panorama_-_2025-10-11_22-49-35_001.jpg", skiPass:"independent"},
  {id:"sainte-foy-tarentaise-s13",category:"skiing",title:"Sainte-Foy Tarentaise",location:"Savoie, France",lat:45.55,lon:6.8833,ap:"GVA",icon:"🏔️",rating:4.54,reviews:967,gradient:"linear-gradient(160deg,#002233,#004466,#006699)",accent:"#80ccff",tags:["Black Diamonds","Steep Chutes","Variable Terrain","Long Season"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/General_view_of_the_Saint-Foy-Tarentaise_ski_area_from_La_Rosi%C3%A8re%2C_2024.jpg/1280px-General_view_of_the_Saint-Foy-Tarentaise_ski_area_from_La_Rosi%C3%A8re%2C_2024.jpg", skiPass:"independent"},
  {id:"stowe-mountain-s14",category:"skiing",title:"Stowe Mountain",location:"Lamoille County, Vermont",lat:44.5267,lon:-72.7817,ap:"BTV",icon:"🏔️",rating:4.62,reviews:4924,gradient:"linear-gradient(160deg,#001a00,#1b5e20,#4caf50)",accent:"#a5d6a7",tags:["Vermont Classic","Mt Mansfield","Resort Village","New England Icon"],photo:"https://images.unsplash.com/photo-1665890759638-0feb402f77f2?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8Mnx8U3Rvd2UlMjBWZXJtb250fGVufDF8MHx8fDE3ODY5Mjc0MzR8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"epic"},
  {id:"champoluc-monterosa-s15",category:"skiing",title:"Champoluc Monterosa",location:"Aosta Valley, Italy",lat:45.8167,lon:7.7,ap:"TRN",icon:"🏔️",rating:4.7,reviews:744,gradient:"linear-gradient(160deg,#1a3a5c,#2e6bbf,#6db3f2)",accent:"#6db3f2",tags:["Powder Day","All Levels","High Altitude","Groomed Runs"],photo:"https://images.unsplash.com/photo-1706379104889-7dd4ebc9faad?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8Mnx8Q2hhbXBvbHVjJTIwTW9udGVyb3NhJTIwQW9zdGElMjBWYWxsZXl8ZW58MXwwfHx8MTc4NjkyNzQzNnww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"independent"},
  {id:"sun-peaks-resort-s17",category:"skiing",title:"Sun Peaks Resort",location:"British Columbia, Canada",lat:50.8833,lon:-119.8833,ap:"YKA",icon:"🏔️",rating:4.87,reviews:1915,gradient:"linear-gradient(160deg,#1a0533,#4a0e8f,#7c43bd)",accent:"#ce93d8",tags:["Beginner Slopes","Ski School","Family Friendly","Night Skiing"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Sun_Peaks_Resort_%2848167880642%29.jpg/1280px-Sun_Peaks_Resort_%2848167880642%29.jpg", skiPass:"ikon"},
  {id:"pucon-ski-center-s19",category:"skiing",title:"Pucon Ski Center",location:"Araucania, Chile",lat:-39.2667,lon:-71.95,ap:"ZCO",icon:"🏔️",rating:4.54,reviews:1034,gradient:"linear-gradient(160deg,#001a00,#1b5e20,#4caf50)",accent:"#a5d6a7",tags:["Glacial Skiing","Scenic Views","Village Base","On-Piste"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Centro_de_esqu%C3%AD_Puc%C3%B3n_2013-02_1.JPG/1280px-Centro_de_esqu%C3%AD_Puc%C3%B3n_2013-02_1.JPG", skiPass:"independent"},
  {id:"les-arcs-s20",category:"skiing",title:"Les Arcs",location:"Savoie, France",lat:45.5,lon:6.8333,ap:"GVA",icon:"🏔️",rating:4.76,reviews:1688,gradient:"linear-gradient(160deg,#1a3a5c,#2e6bbf,#6db3f2)",accent:"#6db3f2",tags:["Powder Day","All Levels","High Altitude","Groomed Runs"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Roc_du_Grand_Renard_and_Aiguille_Grive%2C_with_TSF_Charmettoger_and_ski_slopes_in_the_foreground%2C_Les_Arcs%2C_2018.jpg/1280px-Roc_du_Grand_Renard_and_Aiguille_Grive%2C_with_TSF_Charmettoger_and_ski_slopes_in_the_foreground%2C_Les_Arcs%2C_2018.jpg", skiPass:"independent"},
  {id:"powder-mountain-s21",category:"skiing",title:"Powder Mountain",location:"Weber County, Utah",lat:41.3833,lon:-111.7833,ap:"SLC",icon:"🏔️",rating:4.94,reviews:2962,gradient:"linear-gradient(160deg,#0d1b2a,#1565c0,#64b5f6)",accent:"#b3e5fc",tags:["Expert Terrain","Off-Piste","Deep Snow","Backcountry"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Powder_Mountain_-_panoramio.jpg/1280px-Powder_Mountain_-_panoramio.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail", skiPass:"independent"},
  {id:"madarao-mountain-s22",category:"skiing",title:"Madarao Mountain",location:"Nagano, Japan",lat:36.9847,lon:138.3381,ap:"NRT",icon:"🏔️",rating:4.67,reviews:1309,gradient:"linear-gradient(160deg,#1a0533,#4a0e8f,#7c43bd)",accent:"#ce93d8",tags:["Deep Powder","Tree Skiing","Uncrowded Runs","Nagano Backcountry"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Madarao_Mountain_Resort_%2851846003746%29.jpg/1280px-Madarao_Mountain_Resort_%2851846003746%29.jpg", skiPass:"independent"},
  {id:"thredbo-village-s23",category:"skiing",title:"Thredbo Village",location:"New South Wales, Australia",lat:-36.5,lon:148.3,ap:"SYD",icon:"🏔️",rating:4.62,reviews:1299,gradient:"linear-gradient(160deg,#002233,#004466,#006699)",accent:"#80ccff",tags:["Black Diamonds","Steep Chutes","Variable Terrain","Long Season"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/STS123-E-7006_-_View_of_Earth.jpg/1280px-STS123-E-7006_-_View_of_Earth.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail", skiPass:"independent"},
  {id:"nevis-range-s24",category:"skiing",title:"Nevis Range",location:"Highlands, Scotland",lat:56.8333,lon:-5.0,ap:"INV",icon:"🏔️",rating:4.63,reviews:1521,gradient:"linear-gradient(160deg,#001a00,#1b5e20,#4caf50)",accent:"#a5d6a7",tags:["Glacial Skiing","Scenic Views","Village Base","On-Piste"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Nevis_Range_Ski_Centre_-_geograph.org.uk_-_5355999.jpg/1280px-Nevis_Range_Ski_Centre_-_geograph.org.uk_-_5355999.jpg", skiPass:"independent"},
  {id:"tsugaike-kogen-s25",category:"skiing",title:"Tsugaike Kogen",location:"Nagano, Japan",lat:36.7697,lon:137.8158,ap:"NRT",icon:"🏔️",rating:4.8,reviews:717,gradient:"linear-gradient(160deg,#1a3a5c,#2e6bbf,#6db3f2)",accent:"#6db3f2",tags:["Powder Day","All Levels","High Altitude","Groomed Runs"],photo:"https://upload.wikimedia.org/wikipedia/commons/9/93/%E6%A0%82%E6%B1%A0%E8%87%AA%E7%84%B6%E5%9C%92%EF%BC%88http-www.tsugaike.gr.jp-%EF%BC%89_-_panoramio.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail_unscaled", skiPass:"independent"},
  {id:"mount-shasta-ski-s26",category:"skiing",title:"Mount Shasta Ski",location:"Siskiyou County, California",lat:41.35,lon:-122.1833,ap:"RDD",icon:"🏔️",rating:4.59,reviews:4147,gradient:"linear-gradient(160deg,#0d1b2a,#1565c0,#64b5f6)",accent:"#b3e5fc",tags:["Expert Terrain","Off-Piste","Deep Snow","Backcountry"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Carex_breweri.jpg/1280px-Carex_breweri.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail", skiPass:"independent"},
  {id:"lech-zurs-s27",category:"skiing",title:"Lech Zürs",location:"Vorarlberg, Austria",lat:47.2083,lon:10.1444,ap:"INN",icon:"🏔️",rating:4.73,reviews:4718,gradient:"linear-gradient(160deg,#1a0533,#4a0e8f,#7c43bd)",accent:"#ce93d8",tags:["Expert Terrain","Off-Piste Powder","Arlberg Region","Luxury"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/Lech-Zuers-Trittkopfbahn-Flexenarena-02ASD.jpg/1280px-Lech-Zuers-Trittkopfbahn-Flexenarena-02ASD.jpg", skiPass:"independent"},
  {id:"cerro-castor-s28",category:"skiing",title:"Cerro Castor",location:"Tierra del Fuego, Argentina",lat:-54.7833,lon:-68.1167,ap:"USH",icon:"🏔️",rating:4.87,reviews:3777,gradient:"linear-gradient(160deg,#002233,#004466,#006699)",accent:"#80ccff",tags:["Black Diamonds","Steep Chutes","Variable Terrain","Long Season"],photo:"https://images.unsplash.com/photo-1768087512577-e83d45f3e98b?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8VGllcnJhJTIwZGVsJTIwRnVlZ28lMjBBcmdlbnRpbmElMjBza2klMjByZXNvcnR8ZW58MXwwfHx8MTc4NjkyNzQ1Nnww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75", skiPass:"independent"},
  {id:"treble-cone-s29",category:"skiing",title:"Treble Cone",location:"Wanaka, New Zealand",lat:-44.6167,lon:168.95,ap:"ZQN",icon:"🏔️",rating:4.83,reviews:4724,gradient:"linear-gradient(160deg,#001a00,#1b5e20,#4caf50)",accent:"#a5d6a7",tags:["Glacial Skiing","Scenic Views","Village Base","On-Piste"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Treble_Cone%2C_Wanaka_NZ_-_Summit_Slopes.jpg/1280px-Treble_Cone%2C_Wanaka_NZ_-_Summit_Slopes.jpg", skiPass:"independent"},
  {id:"agios-prokopios-t2",category:"beach",title:"Agios Prokopios",location:"Naxos, Greece",lat:37.0667,lon:25.4167,ap:"JNX",icon:"🏝️",rating:4.64,reviews:2555,gradient:"linear-gradient(160deg,#003322,#006644,#00a86b)",accent:"#80d4b0",tags:["Quiet & Pristine","Family Friendly","Shallow Clear Water","Naxos Old Town"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Agios_Prokopios_Beach_at_sunset%2C_Naxos%2C_Greece_julesvernex2.jpg/1280px-Agios_Prokopios_Beach_at_sunset%2C_Naxos%2C_Greece_julesvernex2.jpg"},
  {id:"playa-de-la-concha-t3",category:"beach",title:"Playa de la Concha",location:"San Sebastian, Spain",lat:43.3208,lon:-1.9928,ap:"EAS",icon:"🏝️",rating:4.74,reviews:730,gradient:"linear-gradient(160deg,#1a1a3a,#2828a0,#5050e0)",accent:"#a0a0ff",tags:["Curved Urban Bay","Belle Époque Promenade","Basque Pintxos Scene","Safe Swimming"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/San_Sebastian_Playa_de_La_Concha_06_2012_2505.jpg/1280px-San_Sebastian_Playa_de_La_Concha_06_2012_2505.jpg"},
  {id:"huatulco-santa-cruz-t4",category:"beach",title:"Huatulco Santa Cruz",location:"Oaxaca, Mexico",lat:15.7583,lon:-96.1417,ap:"HUX",icon:"🏝️",rating:4.68,reviews:2120,gradient:"linear-gradient(160deg,#3a1a00,#7f3300,#d4600a)",accent:"#ffaa74",tags:["National Park Bay","Snorkeling Reefs","Blue Flag","Calm Pacific"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Bah%C3%ADa_Santa_Cruz_en_Huatulco.jpg/1280px-Bah%C3%ADa_Santa_Cruz_en_Huatulco.jpg"},
  ...
  {id:"matira-beach-t6",category:"beach",title:"Matira Beach",location:"Bora Bora, French Polynesia",lat:-16.5333,lon:-151.7333,ap:"BOB",icon:"🏝️",rating:4.79,reviews:1701,gradient:"linear-gradient(160deg,#3a2800,#8d5700,#d4860a)",accent:"#ffb74d",tags:["Secluded Beach","Snorkeling","Calm Waters","Pristine"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Matira_Beach%2C_Bora_Bora%2C_French_Polynesia.jpg/1280px-Matira_Beach%2C_Bora_Bora%2C_French_Polynesia.jpg"},
  {id:"outer-banks-nags-head-t7",category:"beach",title:"Outer Banks Nags Head",location:"North Carolina, USA",lat:35.9577,lon:-75.6244,ap:"ORF",icon:"🏝️",rating:4.72,reviews:1209,gradient:"linear-gradient(160deg,#003322,#006644,#00a86b)",accent:"#80d4b0",tags:["Jockey's Ridge Dunes","Hang Gliding","Family Friendly","Historic Lighthouse"],photo:"https://images.unsplash.com/photo-1604523350501-4665548f9a3c?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8NHx8T3V0ZXIlMjBCYW5rcyUyME5hZ3MlMjBIZWFkJTIwYmVhY2h8ZW58MXwwfHx8MTc4NjkyNzQ2M3ww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"turquoise-bay-t8",category:"beach",title:"Turquoise Bay",location:"Western Australia, Australia",lat:-22.096,lon:113.8876,ap:"LEA",icon:"🏝️",rating:4.65,reviews:3341,gradient:"linear-gradient(160deg,#1a1a3a,#2828a0,#5050e0)",accent:"#a0a0ff",tags:["Natural Beauty","Protected Bay","Coral Reef","No Crowds"],photo:"https://images.unsplash.com/photo-1506953823976-52e1fdc0149a?w=800&h=600&fit=crop"},
  ...
  {id:"koh-tao-sairee-t25",category:"beach",title:"Koh Tao Sairee",location:"Surat Thani, Thailand",lat:10.0833,lon:99.8333,ap:"USM",icon:"🏝️",rating:4.96,reviews:1817,gradient:"linear-gradient(160deg,#1a3a00,#2e7d32,#66bb6a)",accent:"#a5d6a7",tags:["Scuba Diving Mecca","Crystal Coral","Open Water Certs","Turtle Bay"],photo:"https://images.unsplash.com/photo-1764464456219-22286004cb91?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8S29oJTIwVGFvJTIwU2FpcmVlJTIwYmVhY2h8ZW58MXwwfHx8MTc4NjkyNzQ3OXww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  {id:"muscat-beach-t26",category:"beach",title:"Muscat Beach",location:"Oman",lat:23.588,lon:58.3972,ap:"MCT",icon:"🏝️",rating:4.71,reviews:2486,gradient:"linear-gradient(160deg,#3a2800,#8d5700,#d4860a)",accent:"#ffb74d",tags:["Turquoise Gulf Water","Turtle Nesting","Desert Meets Sea","Quiet Escape"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Muscat_Beach_%28Qurm%29.jpg/1280px-Muscat_Beach_%28Qurm%29.jpg"},

  {id:"rendezvous-bay-t28",category:"beach",title:"Rendezvous Bay",location:"Anguilla",lat:18.2,lon:-63.1167,ap:"AXA",icon:"🏝️",rating:4.9,reviews:3451,gradient:"linear-gradient(160deg,#1a1a3a,#2828a0,#5050e0)",accent:"#a0a0ff",tags:["Natural Beauty","Protected Bay","Coral Reef","No Crowds"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Cuisinart%2C_Rendezvous_Bay%2C_Anguilla_2009.jpg/1280px-Cuisinart%2C_Rendezvous_Bay%2C_Anguilla_2009.jpg"},
  {id:"an-bang-beach-t29",category:"beach",title:"An Bang Beach",location:"Quang Nam, Vietnam",lat:15.9206,lon:108.3369,ap:"DAD",icon:"🏝️",rating:4.83,reviews:1240,gradient:"linear-gradient(160deg,#3a1a00,#7f3300,#d4600a)",accent:"#ffaa74",tags:["Hoi An Doorstep","Fishing Village Vibe","Uncrowded","Beach Bars"],photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/2024-11-23_An_Bang_Beach_in_Hoi_An_in_November.jpg/1280px-2024-11-23_An_Bang_Beach_in_Hoi_An_in_November.jpg"},
  ...
  {id:"beach_maldives",category:"beach",
    ...
    photo:"https://images.unsplash.com/photo-1536851452588-6f2f913bc1f1?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8TWFsZGl2ZXMlMjBOb3J0aCUyME1hbGUlMjBBdG9sbCUyMGJlYWNofGVufDF8MHx8fDE3ODY1ODM5MzN8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  ...
  {id:"beach_mirissa",category:"beach",
    ...
    photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Mirissa_sea_1.jpg/1280px-Mirissa_sea_1.jpg"},
  ...
  {id:"beach_oludeniz",category:"beach",
    ...
    photo:"https://images.unsplash.com/photo-1713888207744-cc23e6028237?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8NHx8T2x1ZGVuaXolMjBCbHVlJTIwTGFnb29uJTIwYmVhY2h8ZW58MXwwfHx8MTc4NjkyNzQ4MXww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  ...
  {id:"ski_mzaar",category:"skiing",
    ...
    photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Montagnes_Faraya.jpg/1280px-Montagnes_Faraya.jpg",
    skiPass:"independent"},
  ...
  {id:"ski_oukaimeden",category:"skiing",
    ...
    photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Oukaimeden_skiing_park%2C_Morocco.jpg/1280px-Oukaimeden_skiing_park%2C_Morocco.jpg",
    skiPass:"independent"},
  ...
  {id:"beach_phuquoc",category:"beach",
    ...
    photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Phu-Quoc-Long-Beach.jpg/1280px-Phu-Quoc-Long-Beach.jpg"},
  ...
  {id:"beach_goa",category:"beach",
    ...
    photo:"https://images.unsplash.com/photo-1614082242765-7c98ca0f3df3?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8UGFsb2xlbSUyMEJlYWNoJTIwYmVhY2h8ZW58MXwwfHx8MTc4NjkyNzQ4NHww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},
  ...
  {id:"ski_gudauri",category:"skiing",
    ...
    photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Gudauri_Ski_Resort%2C_Gudauri%2C_Georgia_%28Unsplash%29.jpg/1280px-Gudauri_Ski_Resort%2C_Gudauri%2C_Georgia_%28Unsplash%29.jpg",
    skiPass:"independent"},
  ...
  {id:"ski_bansko",category:"skiing",
    ...
    photo:"https://images.unsplash.com/photo-1761245466600-81c1dee1218c?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8NHx8QmFuc2tvJTIwU2tpJTIwUmVzb3J0JTIwc2tpJTIwcmVzb3J0fGVufDF8MHx8fDE3ODY5Mjc0OTR8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75",
    skiPass:"independent"},
  // ── Ikon Pass batch (added 2026-06-08) ──
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Winter_Park_Ski_Resort_-_Colorado_%2813843211033%29.jpg/1280px-Winter_Park_Ski_Resort_-_Colorado_%2813843211033%29.jpg",
      "skiPass": "ikon",
    },
    {
      "id": "copper-mountain",
      ...
      "accent": "#7ab87a",
      "tags": [
        "Natural Terrain Separation",
        "Snowboard-Optimized Layout",
        "Front Range Access",
        "Ikon Pass"
      ],
      "photo": "https://images.unsplash.com/photo-1699400873127-ea182f7583fc?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8Q29wcGVyJTIwTW91bnRhaW4lMjBza2klMjByZXNvcnR8ZW58MXwwfHx8MTc4NjkyNzQ5NXww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75",
      "skiPass": "ikon",
    },
    {
      "id": "palisades-tahoe",
      ...
      "photo": "https://images.unsplash.com/flagged/photo-1571060426446-874801b9b026?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8UGFsaXNhZGVzJTIwVGFob2UlMjBVU0F8ZW58MXwwfHx8MTc4NjkyNzQ5N3ww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75",
      "skiPass": "ikon"
    },
    {
      "id": "snowbird",
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Snowbird_Ski_and_Summer_Resort%2C_Sandy%2C_United_States_%28Unsplash%29.jpg/1280px-Snowbird_Ski_and_Summer_Resort%2C_Sandy%2C_United_States_%28Unsplash%29.jpg",
      "skiPass": "ikon",
      "lateSeason": true
    },
    {
      ...
      "accent": "#8898cc",
      "tags": [
        "Cottonwood Canyon Powder",
        "Night Skiing",
        "Family Mountain",
        "Ikon Pass"
      ],
      "photo": "https://images.unsplash.com/photo-1671034765040-9ef42f6b925a?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8Mnx8QnJpZ2h0b24lMjBza2klMjByZXNvcnR8ZW58MXwwfHx8MTc4NjkyNzQ5OHww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75",
      "skiPass": "ikon"
    },
    {
      "id": "solitude",
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Solitude_ski_resort_%28Unsplash%29.jpg/1280px-Solitude_ski_resort_%28Unsplash%29.jpg",
      "skiPass": "ikon"
    },
    {
      "id": "deer-valley",
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/Silver_Lake_Village_and_Goldener_Hirsch_-_Park_City_-_Utah_%2852706903728%29.jpg/1280px-Silver_Lake_Village_and_Goldener_Hirsch_-_Park_City_-_Utah_%2852706903728%29.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail",
      "skiPass": "ikon"
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/View_of_Crystal_Mountain_ski_resort_%28below%29_and_Norse_Peak_massif_%28above%29_from_Silver_Queen_%287_March_2025%29.jpg/1280px-View_of_Crystal_Mountain_ski_resort_%28below%29_and_Norse_Peak_massif_%28above%29_from_Silver_Queen_%287_March_2025%29.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail",
      "skiPass": "ikon"
    },
    {
      "id": "mt-bachelor",
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/Mt._Bachelor_Ski_Resort%2C_Oregon_%282014%29_-_17.JPG/1280px-Mt._Bachelor_Ski_Resort%2C_Oregon_%282014%29_-_17.JPG",
      "skiPass": "ikon",
    },
    {
      "id": "sugar-bowl",
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Donner_Pass_%2812136346995%29.jpg/1280px-Donner_Pass_%2812136346995%29.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail",
      "skiPass": "ikon"
    },
    {
      "id": "killington",
    ...
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Sharp_Blue_Icicle_in_Blue_Field_%2813526416674%29.jpg/1280px-Sharp_Blue_Icicle_in_Blue_Field_%2813526416674%29.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=thumbnail",
      "skiPass": "ikon"
    },
    {
      "id": "sunday-river",
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1573060665892-333a8ba410a2?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8TGFrZSUyMExvdWlzZSUyMHNraSUyMHJlc29ydHxlbnwxfDB8fHwxNzg0OTQ1OTA4fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75",
      "skiPass": "ikon",
    },
    {
      "id": "cypress-mountain",
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1743702263351-40b1b84be3a2?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8WmVybWF0dCUyMHNraSUyMHJlc29ydHxlbnwxfDB8fHwxNzg0OTQ1OTA5fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75",
      "skiPass": "ikon",
      "lateSeason": true
    },
    {
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1495214401470-30a1fbcc783c?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8U3QuJTIwQW50b24lMjBhbSUyMEFybGJlcmclMjBza2klMjByZXNvcnR8ZW58MXwwfHx8MTc4NDk0NTkwOXww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75",
      "skiPass": "ikon"
    },
    {
  ...
  // ── Epic Pass batch (added 2026-06-08) ──
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1592428067555-fbaaa69df4b2?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8UGFyayUyMENpdHklMjBNb3VudGFpbiUyMHNraSUyMHJlc29ydHxlbnwxfDB8fHwxNzg0OTQ1OTEwfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75",
      "skiPass": "epic",
    },
    {
    ...
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/MountSunapeefromLake.jpg/1280px-MountSunapeefromLake.jpg",
      "skiPass": "epic"
    },
    {
      "id": "wilmot-mountain",
    ...
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Liberty_Mountain_Resort_front.JPG/1280px-Liberty_Mountain_Resort_front.JPG",
      "skiPass": "epic"
    },
    {
    ...
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Fernie_alpine_resort_February_2024_White_pass_quad.jpg/1280px-Fernie_alpine_resort_February_2024_White_pass_quad.jpg",
      "skiPass": "epic",
    },
    {
      "id": "kimberley",
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Kimberley_Alpine_Resort_2.JPG/1280px-Kimberley_Alpine_Resort_2.JPG",
      "skiPass": "epic",
    },
    {
      "id": "nakiska",
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1662536209013-844e0a8eced8?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8M3x8VmVyYmllciUyMDQlMjBWYWxsJUMzJUE5ZXMlMjBza2klMjByZXNvcnR8ZW58MXwwfHx8MTc4NDk0NTkxMHww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75",
      "skiPass": "epic",
      "lateSeason": true
    },
    {
  ...
  // ── Global beach batch (added 2026-06-08) ──
    ...
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Dragon_Cay.jpg/1280px-Dragon_Cay.jpg"
    },
    {
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1666051637751-19d52e003355?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8Mnx8UGxheWElMjBQYXJhaXNvJTIwVHVsdW0lMjBiZWFjaHxlbnwxfDB8fHwxNzg0OTQ1OTExfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
      "id": "xpu-ha-beach",
      "category": "beach",
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1665765416733-60b2b1b1f5fd?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8Mnx8V2FpbGVhJTIwQmVhY2glMjBiZWFjaHxlbnwxfDB8fHwxNzg0OTQ1OTExfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1642868972353-b4724b17c519?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8M3x8S2ElMjdhbmFwYWxpJTIwQmVhY2glMjBiZWFjaHxlbnwxfDB8fHwxNzg0OTQ1OTEyfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1614591184338-bd97fac10e22?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8QW1hbGZpJTIwVG93biUyMEJlYWNoJTIwYmVhY2h8ZW58MXwwfHx8MTc4NDk0NTkxMnww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1633268118616-2cf81de89478?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8Mnx8Q2FsYSUyMFNhbGFkYSUyMEliaXphJTIwU3BhaW58ZW58MXwwfHx8MTc4NDk0NTkxM3ww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
      "id": "cala-comte-ibiza",
      "category": "beach",
      ...
      "photo": "https://images.unsplash.com/photo-1672939113907-2549a4c50c64?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8Mnx8Q2FsYSUyMENvbXRlJTIwSWJpemElMjBiZWFjaHxlbnwxfDB8fHwxNzg0OTQ1OTE0fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
      "id": "cala-bassa-ibiza",
      "category": "beach",
      ...
      "photo": "https://images.unsplash.com/photo-1657747296876-320bd655bd23?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8Q2FsYSUyMEJhc3NhJTIwSWJpemElMjBJYml6YXxlbnwxfDB8fHwxNzg0OTQ1OTE1fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1618478669118-1b3eb2b2bb95?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8U2FudG9yaW5pJTIwR3JlZWNlJTIwYmVhY2h8ZW58MXwwfHx8MTc4NjU4MzkzNnww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Beach_-_Perissa_-_Santorini_-_Greece_-_04.jpg/1280px-Beach_-_Perissa_-_Santorini_-_Greece_-_04.jpg"
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Super_Paradise_Beach%2C_Mykonos%2C_Greece.jpg/1280px-Super_Paradise_Beach%2C_Mykonos%2C_Greece.jpg"
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1596234263565-1a24e3d034c7?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8RWxpYSUyMEJlYWNoJTIwTXlrb25vcyUyMGJlYWNofGVufDF8MHx8fDE3ODY1ODM5NDB8MA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1737515908817-2b7668aea1a1?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8UGF0b25nJTIwQmVhY2glMjBiZWFjaHxlbnwxfDB8fHwxNzg2NTgzOTQwfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Sunset_at_Karon_Beach%2C_Phuket%2C_Thailand_2.JPG/1280px-Sunset_at_Karon_Beach%2C_Phuket%2C_Thailand_2.JPG"
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Phuket_-_Kata_Beach_001.jpg/1280px-Phuket_-_Kata_Beach_001.jpg"
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/20221108_Freedom_Beach_auf_Phuket_%284%29.jpg/1280px-20221108_Freedom_Beach_auf_Phuket_%284%29.jpg"
    },
    {
      "id": "nai-harn-phuket",
      "category": "beach",
      ...
      "photo": "https://images.unsplash.com/photo-1687025846473-9bd391575faa?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8TmFpJTIwSGFybiUyMEJlYWNoJTIwYmVhY2h8ZW58MXwwfHx8MTc4NjU4Mzk0Mnww&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1654159148138-bf64a2278cf7?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8UGFkYW5nJTIwUGFkYW5nJTIwQmVhY2glMjBiZWFjaHxlbnwxfDB8fHwxNzg2NTgzOTQzfDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
      "id": "kuta-beach-bali",
      "category": "beach",
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Kuta_Beach%2C_Bali%2C_20220825_1336_0840.jpg/1280px-Kuta_Beach%2C_Bali%2C_20220825_1336_0840.jpg"
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1763872537196-67070a5e16c4?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8QmluZ2luJTIwQmVhY2glMjBiZWFjaHxlbnwxfDB8fHwxNzg2NTgzOTQ0fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1642920039335-65c4c0213961?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8RHJlYW1sYW5kJTIwQmVhY2glMjBiZWFjaHxlbnwxfDB8fHwxNzg2NTgzOTQ0fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1719461208002-32038f552f2b?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8UHVrYSUyMFNoZWxsJTIwQmVhY2glMjBiZWFjaHxlbnwxfDB8fHwxNzg2NTgzOTQ1fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
      "id": "diniwid-boracay",
      "category": "beach",
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/Sunset_at_Diniwid_Beach%2C_Boracay_Island.jpg/1280px-Sunset_at_Diniwid_Beach%2C_Boracay_Island.jpg"
    },
    {
    ...
    },
    {
      ...
      "photo": "https://images.unsplash.com/photo-1609602125933-0b55fd6de9dc?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8VmVsaWdhbmR1JTIwSXNsYW5kJTIwQmVhY2glMjBiZWFjaHxlbnwxfDB8fHwxNzg2NTgzOTQ2fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/2025_Baros_Maldives_25_-_Flickr_-_anoldent.jpg/1280px-2025_Baros_Maldives_25_-_Flickr_-_anoldent.jpg"
    },
    {
    ...
    },
    {
      ...
      "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c0/Barrenjoey_Head_Lighthouse%2C_Palm_Beach%2C_New_South_Wales%2C_AUSTRALIA.jpg/1280px-Barrenjoey_Head_Lighthouse%2C_Palm_Beach%2C_New_South_Wales%2C_AUSTRALIA.jpg"
    },
    {
    ...
    },
  {
    ...
    "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Mount-Cardrona.jpg/1280px-Mount-Cardrona.jpg",
    "skiPass": "independent",
  },
  {
    "id": "mt-hutt-nz",
    ...
    "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Mt_Hutt%2C_NZ1.jpg/1280px-Mt_Hutt%2C_NZ1.jpg",
    "skiPass": "independent",
  },
  {
    "id": "falls-creek-au",
  ...
  },
  {
    ...
    "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Charlotte_Pass_2008.jpg/1280px-Charlotte_Pass_2008.jpg",
    "skiPass": "independent",
  },
  {
    ...
    "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Nevados-de-chillan-from-the-nw-chile-bio-bio-region.jpg/1280px-Nevados-de-chillan-from-the-nw-chile-bio-bio-region.jpg",
    "skiPass": "independent",
  },
  {
    "id": "la-parva-cl",
  ...
  },
  {
    ...
    "photo": "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Caviahue%2C_Neuqu%C3%A9n.jpg/1280px-Caviahue%2C_Neuqu%C3%A9n.jpg",
    "skiPass": "independent",
  },
  ...
  {id:"zuma-beach-malibu", category:"beach",
    ...
    photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Zuma_Beach%2C_Malibu%2C_California_%283125721698%29.jpg/1280px-Zuma_Beach%2C_Malibu%2C_California_%283125721698%29.jpg"},
  ...
  {id:"clifton-fourth-beach-cpt", category:"beach",
    ...
    photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Clifton_4th_Beach%2C_Cape_Town%2C_Western_Cape_Province_%286252674275%29.jpg/1280px-Clifton_4th_Beach%2C_Cape_Town%2C_Western_Cape_Province_%286252674275%29.jpg"},
  ...
  {id:"cancun-beach", category:"beach",
    ...
    photo:"https://images.unsplash.com/photo-1602088113235-229c19758e9f?ixid=M3wxMDA1OTY0fDB8MXxzZWFyY2h8MXx8Q2FuY3VuJTIwQmVhY2glMjBiZWFjaHxlbnwxfDB8fHwxNzg2NTgzOTQ4fDA&ixlib=rb-4.1.0&w=1200&h=900&fit=crop&crop=entropy&auto=format&q=75"},

  // ── July 2026 additions (2026-07-08) ──
  {id:"arugam-bay-sl", category:"beach",
    title:"Arugam Bay", location:"Eastern Province, Sri Lanka",
    lat:6.8400, lon:81.8300, ap:"CMB",
    icon:"🏖️", rating:4.86, reviews:9400,
  ...
  {id:"essaouira-beach", category:"beach",
    ...
    icon:"🏖️", rating:4.79, reviews:7200,
  ...
  {id:"les-deux-alpes-fr", category:"skiing",
    ...
    icon:"🏔️", rating:4.72, reviews:2140,
  ...
  {id:"saas-fee-ch", category:"skiing",
    ...
    icon:"🏔️", rating:4.84, reviews:3120,
  ...
  {id:"st-moritz-ch", category:"skiing",
    ...
    icon:"🏔️", rating:4.91, reviews:3580,
  ...
  {id:"beach_cascais", category:"beach",
    ...
    photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Praia_da_Concei%C3%A7%C3%A3o%2C_Cascais%2C_Portugal.jpg/1280px-Praia_da_Concei%C3%A7%C3%A3o%2C_Cascais%2C_Portugal.jpg"},
  ...
  // ─── New venues Sep 4 batch (AGP/AKL/GRU/SCL gaps) ───
...
async function fetchMarine(lat, lon) {
  ...
  const url =
    ...
    // Marine model horizon is shorter than the weather model's; 14 risks a 400
    // that would silently drop the water-temp gate entirely (see the
    // ocean_temperature_max incident above). scoreVenue already falls back to
    // the most recent reading for days past the end.
...
// calendar dates — it's UTC, so any US-evening browse rolls the date forward a
// day (Friday fares priced as Saturday for everyone west of UTC after ~4pm).
...
function scoreWeekendDeal(venue, wx, marine, today, homeAirport, flight) {
  ...
  // Same mismatch through the other door: on Sat/Sun, upcomingFridayISO skips
  // to NEXT Friday (same-day fares are useless) while the scored window is
  // still the in-progress weekend — so the fare belongs to a different trip
  // than the conditions. No deal claim when the dates don't line up.
  if (conditions.weekendFriISO && flight?.departDate &&
      conditions.weekendFriISO !== flight.departDate) {
    return { score: null, conditions, priceRatio: null, isEstimate: true, label: null };
  }
...
const BASE_PRICES = {
  ...
  // ── Top-7 high-venue-count airports — added 2026-08-08 (PM v112 Decision 1) ──
  ...
  // ── S-hemi ski airports + Caribbean — added 2026-08-09 (PM v113 Decision 1) ──
  ...
  // ── EU/Asia gateway airports — added 2026-08-12 (PM v117 Decision 1, PM-vetted 3× by v116/v117) ──
  ...
  FAO:{ JFK:640, LAX:940, SFO:920, ORD:720, MIA:800, SEA:980, BOS:600, ATL:740, DEN:820, DFW:780, LAS:880, PHX:900, MSP:760, DTW:750 },
  SPU:{ JFK:760, LAX:1040,SFO:1000,ORD:840, MIA:920, SEA:1100,BOS:720, ATL:860, DEN:940, DFW:900, LAS:980, PHX:1000,MSP:880, DTW:870 },
  DLM:{ JFK:780, LAX:1060,SFO:1020,ORD:860, MIA:940, SEA:1120,BOS:740, ATL:880, DEN:960, DFW:920, LAS:1000,PHX:1020,MSP:900, DTW:890 },
  USM:{ JFK:980, LAX:1100,SFO:1060,ORD:960, MIA:1040,SEA:1140,BOS:1000,ATL:1020,DEN:1040,DFW:1000, LAS:1080,PHX:1100,MSP:1000,DTW:990 },
  MPH:{ JFK:1100,LAX:1000,SFO:960, ORD:1080,MIA:1160,SEA:1080,BOS:1140,ATL:1140,DEN:1100,DFW:1080, LAS:1040,PHX:1060,MSP:1120,DTW:1110 },
  // ── Caribbean + US ski/beach batch — added 2026-08-13 (PM v118 Decision 1) ──
  BOB:{ JFK:1700,LAX:1100,SFO:1200,ORD:1600,MIA:1500,SEA:1400,BOS:1800,ATL:1600,DEN:1400,DFW:1500, LAS:1300,PHX:1280,MSP:1640,DTW:1630 },
  GUC:{ JFK:580, LAX:440, SFO:420, ORD:520, MIA:660, SEA:600, BOS:640, ATL:630, DEN:180, DFW:520, LAS:380, PHX:400, MSP:560, DTW:550 },
  AUA:{ JFK:380, LAX:600, SFO:640, ORD:520, MIA:240, SEA:700, BOS:420, ATL:380, DEN:540, DFW:480, LAS:580, PHX:560, MSP:560, DTW:550 },
  STT:{ JFK:320, LAX:540, SFO:580, ORD:440, MIA:220, SEA:640, BOS:360, ATL:320, DEN:480, DFW:420, LAS:500, PHX:480, MSP:480, DTW:470 },
  MBJ:{ JFK:300, LAX:520, SFO:560, ORD:400, MIA:200, SEA:620, BOS:340, ATL:300, DEN:460, DFW:400, LAS:480, PHX:460, MSP:460, DTW:450 },
  CZM:{ JFK:340, LAX:440, SFO:480, ORD:300, MIA:240, SEA:480, BOS:380, ATL:280, DEN:360, DFW:320, LAS:400, PHX:380, MSP:420, DTW:410 },
  SJD:{ JFK:460, LAX:260, SFO:280, ORD:440, MIA:380, SEA:480, BOS:500, ATL:420, DEN:360, DFW:300, LAS:280, PHX:240, MSP:480, DTW:470 },
  ...
  // ── Top missing APs (13) — 2026-08-16 (DevOps agent) — bumps coverage 75%→83% ──
  KBV:{ JFK:820, LAX:780, SFO:760, ORD:840, MIA:860, SEA:720, BOS:840, ATL:860, DEN:820, DFW:820, LAS:780, PHX:800, MSP:860, DTW:860 },
  JNX:{ JFK:740, LAX:1020,SFO:1000,ORD:820, MIA:800, SEA:1080,BOS:700, ATL:840, DEN:920, DFW:880, LAS:960, PHX:980, MSP:860, DTW:850 },
  HUX:{ JFK:380, LAX:280, SFO:300, ORD:320, MIA:360, SEA:340, BOS:400, ATL:340, DEN:280, DFW:280, LAS:280, PHX:260, MSP:320, DTW:340 },
  TPS:{ JFK:680, LAX:980, SFO:960, ORD:760, MIA:780, SEA:1060,BOS:640, ATL:800, DEN:880, DFW:840, LAS:920, PHX:940, MSP:820, DTW:800 },
  MLO:{ JFK:760, LAX:1040,SFO:1020,ORD:840, MIA:820, SEA:1100,BOS:720, ATL:860, DEN:940, DFW:900, LAS:980, PHX:1000,MSP:880, DTW:870 },
  MBA:{ JFK:1100,LAX:1200,SFO:1180,ORD:1100,MIA:1050,SEA:1250,BOS:1120,ATL:1050,DEN:1150,DFW:1100,LAS:1200,PHX:1180,MSP:1120,DTW:1100 },
  AIT:{ JFK:1400,LAX:1080,SFO:1060,ORD:1280,MIA:1450,SEA:980, BOS:1450,ATL:1480,DEN:1100,DFW:1200,LAS:1050,PHX:1020,MSP:1200,DTW:1350 },
  OSL:{ JFK:580, LAX:820, SFO:860, ORD:660, MIA:700, SEA:900, BOS:540, ATL:700, DEN:760, DFW:720, LAS:800, PHX:820, MSP:700, DTW:680 },
  YKA:{ JFK:320, LAX:220, SFO:200, ORD:280, MIA:400, SEA:160, BOS:360, ATL:380, DEN:280, DFW:320, LAS:280, PHX:260, MSP:280, DTW:320 },
  ZCO:{ JFK:820, LAX:720, SFO:740, ORD:860, MIA:680, SEA:780, BOS:860, ATL:740, DEN:780, DFW:720, LAS:760, PHX:780, MSP:880, DTW:860 },
  RHO:{ JFK:740, LAX:1020,SFO:1000,ORD:820, MIA:800, SEA:1080,BOS:700, ATL:840, DEN:920, DFW:880, LAS:960, PHX:980, MSP:860, DTW:850 },
  MCT:{ JFK:860, LAX:980, SFO:1000,ORD:900, MIA:920, SEA:1040,BOS:880, ATL:920, DEN:960, DFW:940, LAS:980, PHX:1000,MSP:920, DTW:920 },
  TGD:{ JFK:720, LAX:1000,SFO:980, ORD:800, MIA:800, SEA:1060,BOS:680, ATL:820, DEN:900, DFW:860, LAS:940, PHX:960, MSP:840, DTW:830 },
  SNA:{ JFK:280, LAX:50,  SFO:100, ORD:200, MIA:280, SEA:180, BOS:300, ATL:260, DEN:180, DFW:180, LAS:120, PHX:120, MSP:220, DTW:240 },
  ...
  // ── BASE_PRICES 100% backfill — 2026-08-24 (PM v129) ──
...
function getFlightDate(whenId = "anytime") {
  ...
  const fmt = d => localISODate(d);   // local, not UTC — see localISODate
  const upcomingFri = () => {
    const ds = now.getDay();
...
function useLocalStorage(key, initial) {
  ...
  // Cloud-sync pull writes straight to localStorage; without this listener the
  // React state here stays stale, and the next local write uploads that stale
  // value over the freshly pulled cloud data (second-device sign-in = data loss).
  useEffect(() => {
    const onPulled = () => {
      try {
    ...
    window.addEventListener("peakly-sync-pulled", onPulled);
    return () => window.removeEventListener("peakly-sync-pulled", onPulled);
  }, [key]);
      ...
      <div style={{
        ...
        <button onClick={() => onGoToProfile && onGoToProfile()} className="pressable" style={{
          ...
          <div>
            ...
            <div style={{ fontSize:11, color:"#717171", marginTop:1 }}>{ALERTS_AVAILABLE ? "Get pushed the moment conditions are firing." : "We’ll email you the moment conditions are firing."}</div>
          </div>
        </button>
...
function ProfileSyncSection({ cloudSync, profile }) {
  // NOTE: the early return lives BELOW the hooks on purpose — bailing before
  // them is a rules-of-hooks violation that would throw the moment `enabled`
  // stops being a compile-time constant.
  const [email, setEmail]       = useState(profile?.email || "");
  const [feedback, setFeedback] = useState("");
  const [busy, setBusy]         = useState(false);
  ...
  const cooldownMs = lastSentAt ? Math.max(0, 30000 - (now - lastSentAt)) : 0;
  if (!cloudSync || !cloudSync.enabled) return null;   // guard AFTER hooks — see note above
    ...
    <div style={{ marginBottom:16, padding:"14px 14px 12px", background:"#fff", border:"1.5px solid #ebebeb", borderRadius:14 }}>
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:8 }}>
        <div style={{ fontSize:12, fontWeight:800, color:"#222", fontFamily:F, letterSpacing:"0.04em", textTransform:"uppercase" }}>
          {ALERTS_AVAILABLE ? "Get notified when conditions are firing" : "Save your spots across devices"}
        </div>
        ...
        <>
          <div style={{ fontSize:12, color:"#555", fontFamily:F, marginBottom:10, lineHeight:1.45 }}>
            {ALERTS_AVAILABLE
              ...
              : "Create an account to save your spots and sync them across every device — no password, just a one-tap email link."}
          </div>
          <div style={{ display:"flex", gap:8 }}>
            <input
          ...
          {isLow ? (
            ...
            <>
              ...
              {isEstimate ? (
                ...
                <ScoreRow label="Price" weight="25 pts" value={priceNorm} explain={priceExplain} />
              )}
...
function App() {
  ...
  }, [userAlerts, setUserAlerts, profile?.homeAirport, cloudSync]);
        ...
        <div key={activeTab} className="tab-fade" style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
          {activeTab === "explore" && (
            <ExploreTab
              ...
              onRefresh={() => fetchInitialWeather(true)}
              cloudSync={cloudSync}
            />
          )}
          {activeTab === "alerts" && (
