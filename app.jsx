...
const VENUES = [
  ...
  {id:"borabora",    category:"beach", title:"Bora Bora Lagoon",       location:"French Polynesia",         lat:-16.5004,lon:-151.7415,ap:"PPT",icon:"🏖️",rating:4.96,reviews:988,gradient:"linear-gradient(160deg,#003344,#006688,#22aabb)",accent:"#66ddee",tags:["UV 11","Overwater Bungalows","Crystal Water"], photo:"https://images.unsplash.com/photo-1508855173839-a6d69c12573a?w=800&h=600&fit=crop&fp-x=0.65&fp-y=0.57"},
  ...
  {id:"big-white-ski-s5",         category:"skiing",title:"Big White",             location:"British Columbia, Canada",  lat:49.7167,lon:-118.9333,ap:"YLW",icon:"⛷️",rating:4.71,reviews:3866,gradient:"linear-gradient(160deg,#0d1c38,#1a3e7c,#3070c0)",accent:"#7aacdc",tags:["BC Powder","Ski-In Village","Family Resort"],photo:"https://images.unsplash.com/photo-1578985545284-db7b72abc2cd?w=800&h=600&fit=crop"},
  ...
  {id:"matira-beach-t6",          category:"beach", title:"Matira Beach",          location:"Bora Bora, French Polynesia",lat:-16.5333,lon:-151.7333,ap:"BOB",icon:"🏖️",rating:4.79,reviews:1701,gradient:"linear-gradient(160deg,#003322,#006644,#22aa77)",accent:"#88dd99",tags:["Powdery White Sand","Sunset Beach","Mt Otemanu View"],photo:"https://images.unsplash.com/photo-1494548162494-384bba4ab999?w=800&h=600&fit=crop"},
  ...
  {id:"hyams-beach-t22",          category:"beach", title:"Hyams Beach",           location:"Jervis Bay, Australia",     lat:-35.1167,lon:150.6833,ap:"CBR",icon:"🏖️",rating:4.60,reviews:4569,gradient:"linear-gradient(160deg,#001a3a,#003688,#0066c8)",accent:"#3399ee",tags:["World's Whitest Sand","Jervis Bay","Quiet Cove"],photo:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop"},
