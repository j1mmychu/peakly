...
const VENUES = [
  ...
  {id:"punta-roca-s12",category:"surfing",title:"Punta Roca",location:"La Libertad, El Salvador",lat:13.5167,lon:-89.3167,ap:"SAL",icon:"🌊",rating:4.71,reviews:4339,gradient:"linear-gradient(160deg,#0d2137,#1565c0,#42a5f5)",accent:"#90caf9",tags:["Point Break","Expert Level","Hollow Left","Central America Classic"],photo:"https://images.unsplash.com/photo-1504681869696-d5e0081c9804?w=800&h=600&fit=crop&fp-x=0.5&fp-y=0.5",facing:215},
  ...
  {id:"catanduanes-s16",category:"surfing",title:"Catanduanes",location:"Bicol, Philippines",lat:13.6997,lon:124.2451,ap:"VRC",icon:"🌊",rating:4.61,reviews:1904,gradient:"linear-gradient(160deg,#001a3a,#004080,#0080c0)",accent:"#40a0ff",tags:["Beach Break","Intermediate","Powerful Surf","Tropical"],photo:"https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=800&h=600&fit=crop&fp-x=0.5&fp-y=0.5",facing:90},
  ...
  {id:"cloudbreak-fiji-s21",category:"surfing",title:"Cloudbreak Fiji",location:"Tavarua, Fiji",lat:-17.85,lon:177.1833,ap:"NAN",icon:"🌊",rating:4.83,reviews:1855,gradient:"linear-gradient(160deg,#001a3a,#004080,#0080c0)",accent:"#40a0ff",tags:["Reef Break","Expert Only","Big Wave","Boat-Access Only"],photo:"https://images.unsplash.com/photo-1586942076095-7fad14e4afdc?w=800&h=600&fit=crop&fp-x=0.5&fp-y=0.5",facing:225},
  ...
  {id:"snappers-gold-coast-s26",category:"surfing",title:"Snappers Gold Coast",location:"Gold Coast, Australia",lat:-28.1667,lon:153.55,ap:"OOL",icon:"🌊",rating:4.82,reviews:3002,gradient:"linear-gradient(160deg,#001a3a,#004080,#0080c0)",accent:"#40a0ff",tags:["Point Break","Intermediate Plus","Superbank","World Class Right"],photo:"https://images.unsplash.com/photo-1520466071398-92af8ecab28c?w=800&h=600&fit=crop&fp-x=0.5&fp-y=0.5",facing:100},
