...
const VENUES = [
  {id:"whistler",    category:"skiing",title:"Whistler Blackcomb",     location:"British Columbia, Canada",lat:50.1163,lon:-122.9574,ap:"YVR",icon:"⛷️",rating:4.97,reviews:2840,gradient:"linear-gradient(160deg,#1a3a5c,#2e6bbf,#6db3f2)",accent:"#6db3f2",tags:["Powder Day","Two Linked Peaks","All Levels"], photo:"https://images.unsplash.com/photo-1526904212716-2d2cb52a7258?w=800&h=600&fit=crop&fp-x=0.33&fp-y=0.65", skiPass:"epic", lateSeason:true},
  {id:"borabora",    category:"beach", title:"Bora Bora",              location:"French Polynesia",         lat:-16.5004,lon:-151.7415,ap:"PPT",icon:"🏖️",rating:4.96,reviews:988,gradient:"linear-gradient(160deg,#003344,#006688,#22aabb)",accent:"#66ddee",tags:["Matira Beach","Overwater Bungalows","Lagoon Snorkel"], photo:"https://images.unsplash.com/photo-1508855173839-a6d69c12573a?w=800&h=600&fit=crop&fp-x=0.65&fp-y=0.57"},
  {id:"chamonix",    category:"skiing",title:"Chamonix-Mont-Blanc",    location:"Haute-Savoie, France",     lat:45.9237,lon:6.8694,ap:"GVA",icon:"⛷️",rating:4.94,reviews:3405,gradient:"linear-gradient(160deg,#0a1a3a,#1a3a6e,#3a6ebf)",accent:"#90caf9",tags:["Off-Piste","Mont Blanc Views","Vallée Blanche"], photo:"https://images.unsplash.com/photo-1552472200-78d2ad19d2ce?w=800&h=600&fit=crop&fp-x=0.50&fp-y=0.47", skiPass:"independent", lateSeason:true},
  ...
  {id:"andermatt",   category:"skiing",title:"Andermatt-Sedrun-Disentis",location:"Uri, Switzerland",       lat:46.6363,lon:8.5942,ap:"ZRH",icon:"⛷️",rating:4.92,reviews:1820,gradient:"linear-gradient(160deg,#0d1832,#1a3a72,#2e62b8)",accent:"#70a8da",tags:["180km of Slopes","Largest in Central Switzerland","Vail-Owned"], photo:"https://images.unsplash.com/photo-1570877316396-0477e81e9d8d?w=800&h=600&fit=crop", skiPass:"epic"},
  ...
  {id:"beach_grace",    category:"beach",title:"Grace Bay",              location:"Providenciales, Turks & Caicos",lat:21.7918,lon:-72.2598,ap:"PLS",icon:"🏖️",rating:4.98,reviews:11900,gradient:"linear-gradient(160deg,#002233,#004466,#0077aa)",accent:"#00bbee",tags:["Caribbean Top-Tier","Swim-Through Reef"], photo:"https://images.unsplash.com/photo-1536276214783-1ae17228588a?w=800&h=600&fit=crop"},
  ...
  {id:"beach_negril",   category:"beach",title:"Seven Mile Beach Negril", location:"Jamaica",                      lat:18.2750,lon:-78.3440,ap:"MBJ",icon:"🏖️",rating:4.92,reviews:16800,gradient:"linear-gradient(160deg,#002200,#004400,#007700)",accent:"#44cc44",tags:["Legendary Sunsets","Cliff Diving"], photo:"https://images.unsplash.com/photo-1584100936595-c0c5b900dc73?w=800&h=600&fit=crop"},
  ...
  {id:"zakopane",                 category:"skiing",title:"Zakopane",              location:"Tatra Mountains, Poland",   lat:49.2992,lon:19.9497, ap:"KRK",icon:"⛷️",rating:4.82,reviews:1789,gradient:"linear-gradient(160deg,#0e3660,#1b63a9,#83b7e5)",accent:"#1b63a9",tags:["Polish Tatras","Ski Jumping Hub","Mountain Town"],photo:"https://images.unsplash.com/photo-1557692493-0a42e50efc26?w=800&h=600&fit=crop&fp-x=0.49&fp-y=0.52",skiPass:"independent"},
  {id:"schweitzer-mtn",           category:"skiing",title:"Schweitzer Mountain",   location:"Idaho, USA",                lat:48.3583,lon:-116.6272,ap:"GEG",icon:"⛷️",rating:4.87,reviews:1567,gradient:"linear-gradient(160deg,#0e3b68,#1b68b5,#87bbea)",accent:"#1b68b5",tags:["Lake Pend Oreille","Uncrowded","Idaho's Largest"],photo:"https://images.unsplash.com/photo-1486582396475-fe5c7f2c1526?w=800&h=600&fit=crop&fp-x=0.56&fp-y=0.62",skiPass:"ikon"},
  {id:"beach_spain_mallorca_es",  category:"beach", title:"Es Trenc",              location:"Mallorca, Spain",           lat:39.3426,lon:2.9877,  ap:"PMI",icon:"🏖️",rating:4.90,reviews:2987,gradient:"linear-gradient(160deg,#0284c7,#0ea5e9,#7dd3fc)",accent:"#0ea5e9",tags:["Undeveloped","White Sand","Mediterranean"],photo:"https://images.unsplash.com/photo-1627990493469-95d51823a423?w=800&h=600&fit=crop&fp-x=0.69&fp-y=0.67"},
  {id:"zell-am-see-s1",           category:"skiing",title:"Zell am See",           location:"Salzburg, Austria",         lat:47.3333,lon:12.8000, ap:"SZG",icon:"⛷️",rating:4.59,reviews:3214,gradient:"linear-gradient(160deg,#0c1832,#1a3670,#3066b8)",accent:"#7ab0e0",tags:["Lake + Glacier","Kitzsteinhorn","All Levels"],photo:"https://images.unsplash.com/photo-1548777113-e0b0d7e72e6c?w=800&h=600&fit=crop"},
  {id:"appi-kogen-s2",            category:"skiing",title:"Appi Kogen",            location:"Iwate, Japan",              lat:39.9711,lon:140.9317,ap:"AXT",icon:"⛷️",rating:4.76,reviews:1985,gradient:"linear-gradient(160deg,#0a1e3a,#1a3e80,#3a78d4)",accent:"#7eb4ec",tags:["Wide Groomers","Family Resort","Night Skiing"],photo:"https://images.unsplash.com/photo-1491555103944-7c647fd857e6?w=800&h=600&fit=crop"},
  {id:"hemsedal-s3",              category:"skiing",title:"Hemsedal",              location:"Viken, Norway",             lat:60.8631,lon:8.5647,  ap:"OSL",icon:"⛷️",rating:4.75,reviews:3001,gradient:"linear-gradient(160deg,#0a1830,#1a386e,#3066b4)",accent:"#80b6dc",tags:["Scandinavian Alps","Steeps + Park","Long Season"],photo:"https://images.unsplash.com/photo-1543896868-2f7d98bd3dd6?w=800&h=600&fit=crop"},
  {id:"portillo-s4",              category:"skiing",title:"Portillo",              location:"Valparaíso, Chile",         lat:-32.8333,lon:-70.1333,ap:"SCL",icon:"⛷️",rating:4.54,reviews:446, gradient:"linear-gradient(160deg,#0a1e3a,#1a4080,#306cc0)",accent:"#76aedc",tags:["Andes High Alpine","Laguna del Inca","Southern Winter"],photo:"https://images.unsplash.com/photo-1520175462-89499834c4c1?w=800&h=600&fit=crop"},
  {id:"big-white-ski-s5",         category:"skiing",title:"Big White Ski Resort", location:"British Columbia, Canada",  lat:49.7167,lon:-118.9333,ap:"YLW",icon:"⛷️",rating:4.71,reviews:3866,gradient:"linear-gradient(160deg,#0d1c38,#1a3e7c,#3070c0)",accent:"#7aacdc",tags:["BC Powder","Ski-In Village","Family Resort"],photo:"https://images.unsplash.com/photo-1578985545284-db7b72abc2cd?w=800&h=600&fit=crop"},
  {id:"idre-fjall-s6",            category:"skiing",title:"Idre Fjäll",            location:"Dalarna, Sweden",           lat:61.8833,lon:12.6667, ap:"MXX",icon:"⛷️",rating:4.95,reviews:2664,gradient:"linear-gradient(160deg,#0a1a30,#1a3672,#2e62b4)",accent:"#82b8de",tags:["Swedish Family Resort","Aurora Skies","Kids Paradise"],photo:"https://images.unsplash.com/photo-1516117172878-026ddba3c36a?w=800&h=600&fit=crop"},
  {id:"kicking-horse-s10",        category:"skiing",title:"Kicking Horse",         location:"British Columbia, Canada",  lat:51.2979,lon:-117.0447,ap:"YYC",icon:"⛷️",rating:4.51,reviews:2760,gradient:"linear-gradient(160deg,#0e1e3a,#1a3e7e,#2e6abe)",accent:"#76aada",tags:["Champagne Powder","Steep Chutes","Rocky Mountains"],photo:"https://images.unsplash.com/photo-1589802822605-b6f1d7fbd41a?w=800&h=600&fit=crop"},
  {id:"kiroro-snow-world-s11",    category:"skiing",title:"Kiroro Snow World",     location:"Hokkaido, Japan",           lat:43.0558,lon:140.9656,ap:"CTS",icon:"⛷️",rating:4.58,reviews:3869,gradient:"linear-gradient(160deg,#0c1c40,#1a3e88,#3876d0)",accent:"#7cb2ec",tags:["Japow","Tree Skiing","Hokkaido"],photo:"https://images.unsplash.com/photo-1484527689-1ac2a30bfbd4?w=800&h=600&fit=crop"},
  {id:"morzine-s12",              category:"skiing",title:"Morzine",               location:"Haute-Savoie, France",      lat:46.1786,lon:6.7069,  ap:"GVA",icon:"⛷️",rating:4.91,reviews:3064,gradient:"linear-gradient(160deg,#0c1430,#1e3070,#3050b8)",accent:"#7090e0",tags:["Portes du Soleil","Charming Village","Linked Domain"],photo:"https://images.unsplash.com/photo-1561843702-1ab41bebe7f9?w=800&h=600&fit=crop"},
  {id:"sainte-foy-tarentaise-s13",category:"skiing",title:"Sainte-Foy Tarentaise", location:"Savoie, France",            lat:45.5500,lon:6.8833,  ap:"GVA",icon:"⛷️",rating:4.54,reviews:967, gradient:"linear-gradient(160deg,#0a1432,#1e2e72,#3046ba)",accent:"#728ee2",tags:["Off-Piste Heaven","Quiet Powder","Tarentaise Valley"],photo:"https://images.unsplash.com/photo-1569038786784-aee5b10e3511?w=800&h=600&fit=crop"},
  {id:"stowe-mountain-s14",       category:"skiing",title:"Stowe Mountain",        location:"Vermont, USA",              lat:44.5267,lon:-72.7817,ap:"BTV",icon:"⛷️",rating:4.62,reviews:4924,gradient:"linear-gradient(160deg,#0c1a36,#1a3a78,#2e66b8)",accent:"#72a6d8",tags:["Mt Mansfield","East Coast Classic","Front Four"],photo:"https://images.unsplash.com/photo-1522163723043-5c42c1de3742?w=800&h=600&fit=crop",skiPass:"epic"},
  {id:"champoluc-monterosa-s15",  category:"skiing",title:"Champoluc",             location:"Aosta Valley, Italy",       lat:45.8167,lon:7.7000,  ap:"TRN",icon:"⛷️",rating:4.70,reviews:744, gradient:"linear-gradient(160deg,#101832,#203872,#3462b2)",accent:"#6ea0d4",tags:["Monterosa Linked","Off-Piste Routes","Italian Alps"],photo:"https://images.unsplash.com/photo-1576012816255-89a5a2d94ac7?w=800&h=600&fit=crop"},
  {id:"val-d-isere-s16",          category:"skiing",title:"Val d'Isère",           location:"Savoie, France",            lat:45.4483,lon:6.9800,  ap:"GVA",icon:"⛷️",rating:4.69,reviews:2641,gradient:"linear-gradient(160deg,#0c1432,#1e2c72,#3046c0)",accent:"#6c88e2",tags:["Espace Killy","Off-Piste Legend","Glacier Skiing"],photo:"https://images.unsplash.com/photo-1567468080289-0f4a3e02dce5?w=800&h=600&fit=crop",lateSeason:true},
  {id:"sun-peaks-resort-s17",     category:"skiing",title:"Sun Peaks Resort",      location:"British Columbia, Canada",  lat:50.8833,lon:-119.8833,ap:"YKA",icon:"⛷️",rating:4.87,reviews:1915,gradient:"linear-gradient(160deg,#0d1e3a,#1a4082,#3070c2)",accent:"#78aedc",tags:["Canada's 2nd Largest","Ski-In Village","Champagne Powder"],photo:"https://images.unsplash.com/photo-1543268524-cda03c9861c3?w=800&h=600&fit=crop"},
  {id:"pucon-ski-center-s19",     category:"skiing",title:"Pucón Ski Center",      location:"Araucanía, Chile",          lat:-39.2667,lon:-71.9500,ap:"ZPC",icon:"⛷️",rating:4.54,reviews:1034,gradient:"linear-gradient(160deg,#0a1a32,#1a3a76,#2e66b8)",accent:"#74a8da",tags:["Villarrica Volcano","Lake Views","Patagonia"],photo:"https://images.unsplash.com/photo-1598586517946-4e3db73cadf3?w=800&h=600&fit=crop"},
  {id:"les-arcs-s20",             category:"skiing",title:"Les Arcs",              location:"Savoie, France",            lat:45.5000,lon:6.8333,  ap:"GVA",icon:"⛷️",rating:4.76,reviews:1688,gradient:"linear-gradient(160deg,#0c1432,#1e3070,#3048bc)",accent:"#708ce2",tags:["Paradiski","Tree-Lined Pistes","High Alpine"],photo:"https://images.unsplash.com/photo-1533234499399-4cc0a54684f9?w=800&h=600&fit=crop",skiPass:"independent"},
  {id:"powder-mountain-s21",      category:"skiing",title:"Powder Mountain",       location:"Utah, USA",                 lat:41.3833,lon:-111.7833,ap:"SLC",icon:"⛷️",rating:4.94,reviews:2962,gradient:"linear-gradient(160deg,#0e1e38,#1a4280,#3272be)",accent:"#74a6d8",tags:["Most Acres in US","Untracked Powder","Members First"],photo:"https://images.unsplash.com/photo-1529408686637-c33ca8e4f9b7?w=800&h=600&fit=crop"},
  {id:"madarao-mountain-s22",     category:"skiing",title:"Madarao Mountain",      location:"Nagano, Japan",             lat:36.9847,lon:138.3381,ap:"NGO",icon:"⛷️",rating:4.67,reviews:1309,gradient:"linear-gradient(160deg,#0c1c40,#1a3e86,#3674ce)",accent:"#7ab0ea",tags:["Tree Skiing Mecca","Quiet Japow","Nagano"],photo:"https://images.unsplash.com/photo-1544982503-9f984c14501a?w=800&h=600&fit=crop"},
  {id:"thredbo-village-s23",      category:"skiing",title:"Thredbo Village",       location:"New South Wales, Australia",lat:-36.5000,lon:148.3000,ap:"SYD",icon:"⛷️",rating:4.62,reviews:1299,gradient:"linear-gradient(160deg,#0a1c2e,#1a4070,#2e74b8)",accent:"#68aadc",tags:["Aussie Alps","Snowy Mountains","Village Base"],photo:"https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=800&h=600&fit=crop"},
  {id:"nevis-range-s24",          category:"skiing",title:"Nevis Range",           location:"Scottish Highlands",        lat:56.8333,lon:-5.0000, ap:"INV",icon:"⛷️",rating:4.63,reviews:1521,gradient:"linear-gradient(160deg,#0e1c34,#1a3a74,#2e64b6)",accent:"#74a6d8",tags:["Scottish Highlands","Ben Nevis","Gondola Access"],photo:"https://images.unsplash.com/photo-1508193638397-1c4234db14d8?w=800&h=600&fit=crop"},
  {id:"tsugaike-kogen-s25",       category:"skiing",title:"Tsugaike Kogen",        location:"Nagano, Japan",             lat:36.7697,lon:137.8158,ap:"NGO",icon:"⛷️",rating:4.80,reviews:717, gradient:"linear-gradient(160deg,#0c1c40,#1a3e86,#3674ce)",accent:"#78b0e8",tags:["Hakuba Valley","Wide Beginner Slopes","Tree Runs"],photo:"https://images.unsplash.com/photo-1580058572462-98e0c62ed3d8?w=800&h=600&fit=crop"},
  {id:"mount-shasta-ski-s26",     category:"skiing",title:"Mt Shasta Ski Park",    location:"California, USA",           lat:41.3500,lon:-122.1833,ap:"RDD",icon:"⛷️",rating:4.59,reviews:4147,gradient:"linear-gradient(160deg,#0c1c38,#1a3a78,#2e68b8)",accent:"#74a8da",tags:["Volcano Skiing","Northern California","Backcountry Routes"],photo:"https://images.unsplash.com/photo-1524673450801-b5aa9b621b76?w=800&h=600&fit=crop"},
  {id:"lech-zurs-s27",            category:"skiing",title:"Lech Zürs",             location:"Arlberg, Austria",          lat:47.2083,lon:10.1444, ap:"INN",icon:"⛷️",rating:4.73,reviews:4718,gradient:"linear-gradient(160deg,#0e1632,#1e3274,#2e5eb6)",accent:"#6ea0d4",tags:["Arlberg Region","Off-Piste Powder","Luxury"],photo:"https://images.unsplash.com/photo-1516259762965-f47aced4a7f7?w=800&h=600&fit=crop"},
  {id:"cerro-castor-s28",         category:"skiing",title:"Cerro Castor",          location:"Tierra del Fuego, Argentina",lat:-54.7833,lon:-68.1167,ap:"USH",icon:"⛷️",rating:4.87,reviews:3777,gradient:"linear-gradient(160deg,#0a1a30,#1a3870,#2e62b4)",accent:"#80b6dc",tags:["Southernmost Resort","Ushuaia Base","End of the World"],photo:"https://images.unsplash.com/photo-1547036967-3f4fc0adbf6a?w=800&h=600&fit=crop"},
  {id:"treble-cone-s29",          category:"skiing",title:"Treble Cone",           location:"Wanaka, New Zealand",       lat:-44.6167,lon:168.9500,ap:"ZQN",icon:"⛷️",rating:4.83,reviews:4724,gradient:"linear-gradient(160deg,#0a1c30,#1a4072,#2e74ba)",accent:"#6aacde",tags:["Steepest in NZ","Saddle Basin","Wanaka Off-Piste"],photo:"https://images.unsplash.com/photo-1514190051997-0f6f39ca5cde?w=800&h=600&fit=crop"},
  {id:"agios-prokopios-t2",       category:"beach", title:"Agios Prokopios",       location:"Naxos, Greece",             lat:37.0667,lon:25.4167, ap:"JNX",icon:"🏖️",rating:4.64,reviews:2555,gradient:"linear-gradient(160deg,#003355,#0066aa,#22aadd)",accent:"#66ccee",tags:["Naxos Coast","Powder Sand","Mild Winds"],photo:"https://images.unsplash.com/photo-1507991237285-6d74e0adc0fa?w=800&h=600&fit=crop"},
  {id:"playa-de-la-concha-t3",    category:"beach", title:"Playa de la Concha",    location:"San Sebastián, Spain",      lat:43.3208,lon:-1.9928, ap:"EAS",icon:"🏖️",rating:4.74,reviews:730, gradient:"linear-gradient(160deg,#001a3a,#003080,#0050c0)",accent:"#5588dd",tags:["Bay of Biscay","Urban Beach","Basque Country"],photo:"https://images.unsplash.com/photo-1519820056430-f656be5a1e7b?w=800&h=600&fit=crop"},
  {id:"huatulco-santa-cruz-t4",   category:"beach", title:"Huatulco Santa Cruz",   location:"Oaxaca, Mexico",            lat:15.7583,lon:-96.1417,ap:"HUX",icon:"🏖️",rating:4.68,reviews:2120,gradient:"linear-gradient(160deg,#1a2a44,#2e5288,#5088c0)",accent:"#88bbe0",tags:["Pacific Mexico","9 Bays","Quiet Cove"],photo:"https://images.unsplash.com/photo-1439405326-9f4ee48e0e73?w=800&h=600&fit=crop"},
  {id:"plage-de-pampelonne-t5",   category:"beach", title:"Plage de Pampelonne",   location:"Saint-Tropez, France",      lat:43.2500,lon:6.6500,  ap:"NCE",icon:"🏖️",rating:4.85,reviews:4161,gradient:"linear-gradient(160deg,#00133d,#00266e,#0044b3)",accent:"#5588dd",tags:["St-Tropez Iconic","Beach Clubs","French Riviera"],photo:"https://images.unsplash.com/photo-1477120128765-a0528148fed2?w=800&h=600&fit=crop"},
  {id:"turquoise-bay-t8",         category:"beach", title:"Turquoise Bay",         location:"Western Australia",         lat:-21.9167,lon:114.1167,ap:"LEA",icon:"🏖️",rating:4.65,reviews:3341,gradient:"linear-gradient(160deg,#002244,#005588,#22aadd)",accent:"#66ccee",tags:["Ningaloo Reef","Drift Snorkeling","Cape Range NP"],photo:"https://images.unsplash.com/photo-1520454379017-1a16d7f1a1d7?w=800&h=600&fit=crop"},
  {id:"natadola-beach-t9",        category:"beach", title:"Natadola Beach",        location:"Coral Coast, Fiji",         lat:-18.1167,lon:177.5167,ap:"NAN",icon:"🏖️",rating:4.66,reviews:3212,gradient:"linear-gradient(160deg,#003344,#006677,#22aabb)",accent:"#88ddee",tags:["Coral Coast","Horseback Riding","Soft White Sand"],photo:"https://images.unsplash.com/photo-1533104190960-c7e28b5f6b52?w=800&h=600&fit=crop"},
  {id:"tofo-beach-t10",           category:"beach", title:"Tofo Beach",            location:"Inhambane, Mozambique",     lat:-23.8667,lon:35.5333, ap:"INH",icon:"🏖️",rating:4.89,reviews:2799,gradient:"linear-gradient(160deg,#003322,#006644,#33aa77)",accent:"#88dd99",tags:["Whale Sharks","Indian Ocean","Diving Mecca"],photo:"https://images.unsplash.com/photo-1519996409144-01b7bb003574?w=800&h=600&fit=crop"},
  {id:"tioman-island-t11",        category:"beach", title:"Tioman Island",         location:"Pahang, Malaysia",          lat:2.8000, lon:104.1667,ap:"KUL",icon:"🏖️",rating:4.72,reviews:3627,gradient:"linear-gradient(160deg,#003344,#006677,#33aabb)",accent:"#88ddee",tags:["Volcanic Island","Marine Park","Jungle Backdrop"],photo:"https://images.unsplash.com/photo-1530053235038-30613cf5eb3b?w=800&h=600&fit=crop"},
  {id:"mana-island-fiji-t12",     category:"beach", title:"Mana Island",           location:"Mamanuca, Fiji",            lat:-17.6667,lon:177.0833,ap:"NAN",icon:"🏖️",rating:4.90,reviews:4969,gradient:"linear-gradient(160deg,#002a40,#005588,#0099bb)",accent:"#44ccdd",tags:["Mamanuca Islands","Castaway Resort","Coral Snorkeling"],photo:"https://images.unsplash.com/photo-1486870591958-9b9d0d1dda99?w=800&h=600&fit=crop"},
  {id:"zlatni-rat-t14",           category:"beach", title:"Zlatni Rat",            location:"Brač, Croatia",             lat:43.3167,lon:16.6333, ap:"SPU",icon:"🏖️",rating:4.80,reviews:1745,gradient:"linear-gradient(160deg,#002244,#0055aa,#0088dd)",accent:"#33aaee",tags:["Shifting Spit","Adriatic Pebble","Windsurfing"],photo:"https://images.unsplash.com/photo-1559825481-12a05cc00344?w=800&h=600&fit=crop"},
  {id:"lovina-beach-t15",         category:"beach", title:"Lovina Beach",          location:"Bali, Indonesia",           lat:-8.1556,lon:115.0244,ap:"DPS",icon:"🏖️",rating:4.73,reviews:1555,gradient:"linear-gradient(160deg,#1a1a1a,#3a3a3a,#666666)",accent:"#aaaaaa",tags:["Black Volcanic Sand","Dolphin Sunrise","North Bali"],photo:"https://images.unsplash.com/photo-1544550581-5f7ceaf7f992?w=800&h=600&fit=crop"},
  {id:"nusa-dua-beach-t17",       category:"beach", title:"Nusa Dua Beach",        location:"Bali, Indonesia",           lat:-8.8059,lon:115.2325,ap:"DPS",icon:"🏖️",rating:4.64,reviews:4122,gradient:"linear-gradient(160deg,#002244,#005599,#0088cc)",accent:"#33aadd",tags:["Upscale Resorts","Calm Lagoon","Geger Beach"],photo:"https://images.unsplash.com/photo-1495908040769-ab5c3b1d4e6e?w=800&h=600&fit=crop"},
  {id:"patara-beach-t18",         category:"beach", title:"Patara Beach",          location:"Antalya, Turkey",           lat:36.2667,lon:29.3167, ap:"DLM",icon:"🏖️",rating:4.97,reviews:2085,gradient:"linear-gradient(160deg,#2a2200,#7f5e00,#cc9020)",accent:"#ffcc77",tags:["18km Pristine Sand","Lycian Ruins","Sea Turtle Nesting"],photo:"https://images.unsplash.com/photo-1528543010-26b51d08a7e2?w=800&h=600&fit=crop"},
  {id:"bulabog-beach-boracay-t19",category:"beach", title:"Bulabog Beach",         location:"Boracay, Philippines",      lat:11.9600,lon:121.9342,ap:"MPH",icon:"🏖️",rating:4.66,reviews:2396,gradient:"linear-gradient(160deg,#003355,#005588,#0088bb)",accent:"#33aadd",tags:["Kitesurfing Capital","East Boracay","Trade Winds"],photo:"https://images.unsplash.com/photo-1436262117760-66d59c6f25cc?w=800&h=600&fit=crop"},
  {id:"san-vito-lo-capo-t21",     category:"beach", title:"San Vito lo Capo",      location:"Sicily, Italy",             lat:38.1750,lon:12.7333, ap:"TPS",icon:"🏖️",rating:4.68,reviews:4719,gradient:"linear-gradient(160deg,#001a3a,#003680,#0066c0)",accent:"#3399ee",tags:["Crescent Bay","Sicilian Gem","Couscous Festival"],photo:"https://images.unsplash.com/photo-1506477331477-33d5d8b3dc85?w=800&h=600&fit=crop"},
  {id:"hyams-beach-t22",          category:"beach", title:"Hyams Beach",           location:"Jervis Bay, Australia",     lat:-35.1167,lon:150.6833,ap:"CBR",icon:"🏖️",rating:4.60,reviews:4569,gradient:"linear-gradient(160deg,#001a3a,#003688,#0066c8)",accent:"#3399ee",tags:["Powdery White Sand","Jervis Bay","Quiet Cove"],photo:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop"},
  {id:"lindos-beach-t23",         category:"beach", title:"Lindos Beach",          location:"Rhodes, Greece",            lat:36.0917,lon:28.0883, ap:"RHO",icon:"🏖️",rating:4.59,reviews:4606,gradient:"linear-gradient(160deg,#002244,#0055aa,#0088dd)",accent:"#3399ee",tags:["Acropolis View","Aegean Cove","Whitewashed Village"],photo:"https://images.unsplash.com/photo-1507041957456-9c397ce39c97?w=800&h=600&fit=crop"},
  {id:"laguna-beach-t24",         category:"beach", title:"Laguna Beach",          location:"California, USA",           lat:33.5427,lon:-117.7854,ap:"SNA",icon:"🏖️",rating:4.51,reviews:3881,gradient:"linear-gradient(160deg,#002a44,#005577,#0088aa)",accent:"#33bbcc",tags:["Cove Coastline","Tide Pools","Orange County"],photo:"https://images.unsplash.com/photo-1467631332947-8506a3b38a56?w=800&h=600&fit=crop"},
  {id:"koh-tao-sairee-t25",       category:"beach", title:"Sairee Beach",          location:"Koh Tao, Thailand",         lat:10.0833,lon:99.8333, ap:"USM",icon:"🏖️",rating:4.96,reviews:1817,gradient:"linear-gradient(160deg,#003344,#006688,#0099bb)",accent:"#33ccdd",tags:["Dive Capital","Coral Bay","Gulf of Thailand"],photo:"https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=800&h=600&fit=crop"},
  {id:"muscat-beach-t26",         category:"beach", title:"Qurum Beach",           location:"Muscat, Oman",              lat:23.5880,lon:58.3972, ap:"MCT",icon:"🏖️",rating:4.71,reviews:2486,gradient:"linear-gradient(160deg,#2a2200,#7f4a00,#cc7720)",accent:"#ffaa66",tags:["Arabian Sea","Quiet Coast","Mountain Backdrop"],photo:"https://images.unsplash.com/photo-1512100011019-1f6c8ecd1b06?w=800&h=600&fit=crop"},
  {id:"rendezvous-bay-t28",       category:"beach", title:"Rendezvous Bay",        location:"Anguilla",                  lat:18.2000,lon:-63.1167,ap:"AXA",icon:"🏖️",rating:4.90,reviews:3451,gradient:"linear-gradient(160deg,#003355,#0066aa,#00aadd)",accent:"#33ccee",tags:["Caribbean Champagne","St. Martin View","Soft Powder Sand"],photo:"https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=800&h=600&fit=crop"},
  {id:"an-bang-beach-t29",        category:"beach", title:"An Bang Beach",         location:"Hội An, Vietnam",           lat:15.9206,lon:108.3369,ap:"DAD",icon:"🏖️",rating:4.83,reviews:1240,gradient:"linear-gradient(160deg,#002233,#005566,#0099aa)",accent:"#33ccdd",tags:["Hội An Coast","Local Seafood","Vietnam Central"],photo:"https://images.unsplash.com/photo-1562619425-01c1b0c33793?w=800&h=600&fit=crop"}
];
