...
const VENUES = [
  ...
  {id:"sarakiniko-beach-t16",category:"tanning",title:"Sarakiniko Beach",location:"Milos, Greece",lat:36.7667,lon:24.4333,ap:"MLO",icon:"🏝️",rating:4.97,reviews:2714,gradient:"linear-gradient(160deg,#3a2800,#8d5700,#d4860a)",accent:"#ffb74d",tags:["Secluded Beach","Snorkeling","Calm Waters","Pristine"],photo:"https://images.unsplash.com/photo-1541480601022-2308c0f02487?w=800&h=600&fit=crop&fp-x=0.5&fp-y=0.5"},
