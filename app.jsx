...
const VENUES = [
  ...
  // ─── Hawaii ───────────────────────────────────────────────────────
  {id:"banzai_pipeline", category:"surfing",title:"Banzai Pipeline",          location:"Oahu, Hawaii",             lat:21.6622,lon:-158.0543,ap:"HNL",icon:"🏄",rating:4.99,reviews:6420,gradient:"linear-gradient(160deg,#003366,#0055a5,#00bcd4)",accent:"#00bcd4",tags:["Most Photographed Wave","Pro Tour Stop"], photo:"https://images.unsplash.com/photo-1509233725247-49e657c25740?w=800&h=600&fit=crop", breakType:"reef"},
  {id:"jaws",        category:"surfing",title:"Pe'ahi (Jaws)",            location:"Maui, Hawaii",             lat:20.9320,lon:-156.2520,ap:"OGG",icon:"🌊",rating:4.97,reviews:3240,gradient:"linear-gradient(160deg,#001a40,#003580,#0055cc)",accent:"#2288ff",tags:["Big Wave Capital","60ft+ Faces"], photo:"https://images.unsplash.com/photo-1526813951498-5498cce49cdf?w=800&h=600&fit=crop", breakType:"reef"},
  {id:"honolua_bay", category:"surfing",title:"Honolua Bay",              location:"Maui, Hawaii",             lat:21.0204,lon:-156.6450,ap:"OGG",icon:"🏄",rating:4.95,reviews:2870,gradient:"linear-gradient(160deg,#003355,#005588,#0077cc)",accent:"#44aaff",tags:["World-Class Right","Pro Tour Finale"], photo:"https://images.unsplash.com/photo-1505459668311-8dfac7952bf0?w=800&h=600&fit=crop", breakType:"reef"},
  {id:"hanalei",     category:"surfing",title:"Hanalei Bay",             location:"Kauai, Hawaii",            lat:22.2152,lon:-159.4986,ap:"LIH",icon:"🏄",rating:4.93,reviews:2140,gradient:"linear-gradient(160deg,#00334d,#005580,#0077b3)",accent:"#33aadd",tags:["Gorgeous Bay","Long Rides"], photo:"https://images.unsplash.com/photo-1542259009477-d625272157b7?w=800&h=600&fit=crop", breakType:"beach"},

  // ─── California ───────────────────────────────────────────────────
  {id:"trestles",    category:"surfing",title:"Trestles",                 location:"San Clemente, California", lat:33.3778,lon:-117.5792,ap:"SAN",icon:"🏄",rating:4.91,reviews:4100,gradient:"linear-gradient(160deg,#003344,#005577,#0077aa)",accent:"#3399cc",tags:["Pro Tour Classic","Performance Waves"], photo:"https://images.unsplash.com/photo-1588976071688-c2520b7b51f9?w=800&h=600&fit=crop", breakType:"beach"},
  {id:"mavericks",   category:"surfing",title:"Mavericks",               location:"Half Moon Bay, California", lat:37.4952,lon:-122.4994,ap:"SFO",icon:"🌊",rating:4.90,reviews:2980,gradient:"linear-gradient(160deg,#001530,#003060,#004590)",accent:"#1166aa",tags:["Big Wave Icon","Invite-Only Contest"], photo:"https://images.unsplash.com/photo-1477204505220-510cd0d57764?w=800&h=600&fit=crop", breakType:"reef"},
  {id:"blacks",      category:"surfing",title:"Black's Beach",           location:"San Diego, California",    lat:32.8828,lon:-117.2524,ap:"SAN",icon:"🏄",rating:4.88,reviews:3220,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2288dd",tags:["Powerful Beach Break","La Jolla Gem"], photo:"https://images.unsplash.com/photo-1502680390548-bdbac40e2a78?w=800&h=600&fit=crop", breakType:"beach"},
  {id:"rincon_ca",   category:"surfing",title:"Rincon Point",            location:"Santa Barbara, California", lat:34.3726,lon:-119.4745,ap:"LAX",icon:"🏄",rating:4.92,reviews:3640,gradient:"linear-gradient(160deg,#003355,#005580,#007ab3)",accent:"#3399cc",tags:["Queen of the Coast","Long Point Break"], photo:"https://images.unsplash.com/photo-1455729552457-5c322d6024db?w=800&h=600&fit=crop", breakType:"point"},

  // ─── East Coast USA ───────────────────────────────────────────────
  {id:"montauk",     category:"surfing",title:"Montauk",                  location:"New York",                 lat:41.0340,lon:-71.9570,ap:"JFK",icon:"🏄",rating:4.75,reviews:1840,gradient:"linear-gradient(160deg,#002244,#004488,#1166bb)",accent:"#3388cc",tags:["East Coast Classic","Hurricane Swells"], photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop", breakType:"beach"},
  {id:"cape_hatteras",category:"surfing",title:"Cape Hatteras",          location:"North Carolina",           lat:35.2332,lon:-75.5280,ap:"ORF",icon:"🏄",rating:4.82,reviews:2100,gradient:"linear-gradient(160deg,#002040,#004080,#1160a0)",accent:"#2288bb",tags:["Graveyard of the Atlantic","Swell Magnet"], photo:"https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&h=600&fit=crop", breakType:"point"},

  // ─── Mexico ───────────────────────────────────────────────────────
  {id:"puerto_escondido",category:"surfing",title:"Puerto Escondido",   location:"Oaxaca, Mexico",           lat:15.8700,lon:-97.0553,ap:"OAX",icon:"🌊",rating:4.96,reviews:4880,gradient:"linear-gradient(160deg,#003355,#005588,#006fcc)",accent:"#1188ee",tags:["Mexican Pipeline","Heaviest Shore Break"], photo:"https://images.unsplash.com/photo-1605009296117-557ee05cb8cc?w=800&h=600&fit=crop", breakType:"beach"},
  {id:"sayulita",    category:"surfing",title:"Sayulita",                location:"Nayarit, Mexico",          lat:20.8700,lon:-105.4400,ap:"PVR",icon:"🏄",rating:4.85,reviews:3280,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#22aacc",tags:["Beginner Friendly","Pueblo Mágico"], photo:"https://images.unsplash.com/photo-1590523741831-ab7e8b8f9c7f?w=800&h=600&fit=crop", breakType:"beach"},

  // ─── Central America ──────────────────────────────────────────────
  {id:"pavones",     category:"surfing",title:"Pavones",                  location:"Costa Rica",               lat:8.3900,lon:-83.1700,ap:"SJO",icon:"🏄",rating:4.88,reviews:1980,gradient:"linear-gradient(160deg,#003344,#005566,#007788)",accent:"#22aacc",tags:["2nd Longest Left","Jungle Setting"], photo:"https://images.unsplash.com/photo-1509914398892-963f53e6e2f1?w=800&h=600&fit=crop", breakType:"rivermouth"},
  {id:"witch_rock",  category:"surfing",title:"Witch's Rock",             location:"Guanacaste, Costa Rica",   lat:10.7800,lon:-85.8700,ap:"LIR",icon:"🏄",rating:4.86,reviews:1740,gradient:"linear-gradient(160deg,#002840,#004870,#0068a0)",accent:"#2288bb",tags:["Boat-Access Only","Volcanic Rock Break"], photo:"https://images.unsplash.com/photo-1530053969600-caed2596d242?w=800&h=600&fit=crop", breakType:"beach"},
  {id:"punta_roca",  category:"surfing",title:"Punta Roca",               location:"El Salvador",              lat:13.4900,lon:-89.2000,ap:"SAL",icon:"🏄",rating:4.89,reviews:2100,gradient:"linear-gradient(160deg,#002244,#004488,#0055aa)",accent:"#1177cc",tags:["Central American Jewel","Long Right Point"], photo:"https://images.unsplash.com/photo-1468413253725-0d5181091126?w=800&h=600&fit=crop", breakType:"point"},

  // ─── Caribbean ────────────────────────────────────────────────────
  {id:"rincon_pr",   category:"surfing",title:"Rincón",                   location:"Puerto Rico",              lat:18.3400,lon:-67.2500,ap:"SJU",icon:"🏄",rating:4.87,reviews:2640,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Caribbean Surf Capital","Sunny Year-Round"], photo:"https://images.unsplash.com/photo-1502933691298-84fc14542831?w=800&h=600&fit=crop", breakType:"reef"},
  ...
  // ─── South America ────────────────────────────────────────────────
  {id:"chicama",     category:"surfing",title:"Chicama",                  location:"La Libertad, Peru",        lat:-7.8400,lon:-79.4500,ap:"LIM",icon:"🏄",rating:4.94,reviews:2960,gradient:"linear-gradient(160deg,#003355,#005588,#0066aa)",accent:"#1188cc",tags:["World's Longest Left","2.4km Ride"], photo:"https://images.unsplash.com/photo-1497890312100-1e4488c9e5e5?w=800&h=600&fit=crop", breakType:"point"},
  {id:"punta_hermosa",category:"surfing",title:"Punta Hermosa",          location:"Lima, Peru",               lat:-12.3300,lon:-76.8200,ap:"LIM",icon:"🏄",rating:4.85,reviews:2440,gradient:"linear-gradient(160deg,#002244,#003f7f,#0060b3)",accent:"#1188cc",tags:["Peru Pro Stop","Consistent Beach Break"], photo:"https://images.unsplash.com/photo-1531722569936-825d3dd91b15?w=800&h=600&fit=crop", breakType:"beach"},
  {id:"punta_lobos", category:"surfing",title:"Punta de Lobos",          location:"Pichilemu, Chile",         lat:-34.4400,lon:-72.0800,ap:"SCL",icon:"🌊",rating:4.91,reviews:2120,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0f7bcc",tags:["South American Big Wave","ISA World Site"], photo:"https://images.unsplash.com/photo-1496737018672-b1a6be2e949c?w=800&h=600&fit=crop", breakType:"point"},
  {id:"florianopolis",category:"surfing",title:"Florianópolis",          location:"Santa Catarina, Brazil",   lat:-27.5954,lon:-48.5480,ap:"FLN",icon:"🏄",rating:4.84,reviews:3120,gradient:"linear-gradient(160deg,#003355,#00507f,#0070b3)",accent:"#1199dd",tags:["Magic Island","Brazil's Surf City"], photo:"https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=800&h=600&fit=crop", breakType:"beach"},
  {id:"noronha_surf",category:"surfing",title:"Fernando de Noronha",     location:"Pernambuco, Brazil",       lat:-3.8542,lon:-32.4250,ap:"REC",icon:"🏄",rating:4.96,reviews:1980,gradient:"linear-gradient(160deg,#003344,#005577,#00789f)",accent:"#0099cc",tags:["UNESCO World Heritage","Crystal Waters"], photo:"https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=800&h=600&fit=crop", breakType:"reef"},

  // ─── Europe — France ──────────────────────────────────────────────
  {id:"hossegor",    category:"surfing",title:"Hossegor",                 location:"Landes, France",           lat:43.6700,lon:-1.4300,ap:"BIQ",icon:"🏄",rating:4.93,reviews:5200,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#0099bb",tags:["Quiksilver Pro","Hollow Sand Barrels"], photo:"https://images.unsplash.com/photo-1699883815067-e48996c32217?w=800&h=600&fit=crop", breakType:"beach"},

  // ─── Europe — Spain ───────────────────────────────────────────────
  {id:"mundaka",     category:"surfing",title:"Mundaka",                  location:"Basque Country, Spain",   lat:43.4100,lon:-2.7000,ap:"BIO",icon:"🌊",rating:4.95,reviews:3840,gradient:"linear-gradient(160deg,#002244,#003f7f,#0055b3)",accent:"#0077cc",tags:["Best Left in Europe","River Mouth Barrel"], photo:"https://images.unsplash.com/photo-1654311670729-9426fc4a2a2f?w=800&h=600&fit=crop", breakType:"rivermouth"},

  // ─── Europe — Portugal ────────────────────────────────────────────
  {id:"supertubos",  category:"surfing",title:"Supertubos",               location:"Peniche, Portugal",        lat:39.3600,lon:-9.3700,ap:"LIS",icon:"🌊",rating:4.94,reviews:4100,gradient:"linear-gradient(160deg,#002244,#004480,#0066bb)",accent:"#1188ee",tags:["Portuguese Pipeline","WSL Stop"], photo:"https://images.unsplash.com/photo-1525266558638-6da3a79fbfc3?w=800&h=600&fit=crop", breakType:"beach"},
  {id:"ericeira",    category:"surfing",title:"Ericeira",                 location:"Lisbon Coast, Portugal",   lat:38.9600,lon:-9.4200,ap:"LIS",icon:"🏄",rating:4.91,reviews:3600,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["World Surf Reserve","Village Vibes"], photo:"https://images.unsplash.com/photo-1528644355366-0c6a7b2bdf5d?w=800&h=600&fit=crop", breakType:"reef"},
  {id:"nazare",      category:"surfing",title:"Nazaré",                   location:"Silver Coast, Portugal",   lat:39.6000,lon:-9.0700,ap:"LIS",icon:"🌊",rating:4.98,reviews:4800,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2277ff",tags:["World Record Waves","100ft Monsters"], photo:"https://images.unsplash.com/photo-1708356943415-6296d6c25d28?w=800&h=600&fit=crop", breakType:"beach"},

  // ─── Europe — UK / Ireland ────────────────────────────────────────
  {id:"newquay",     category:"surfing",title:"Newquay",                  location:"Cornwall, England",        lat:50.3700,lon:-5.1000,ap:"NQY",icon:"🏄",rating:4.78,reviews:3200,gradient:"linear-gradient(160deg,#003344,#005566,#007788)",accent:"#0099bb",tags:["UK Surf Capital","Fistral Beach"], photo:"https://images.unsplash.com/photo-1507680225127-6450260913c0?w=800&h=600&fit=crop", breakType:"beach"},
  {id:"thurso_east", category:"surfing",title:"Thurso East",              location:"Caithness, Scotland",      lat:58.5900,lon:-3.5200,ap:"INV",icon:"🌊",rating:4.89,reviews:1640,gradient:"linear-gradient(160deg,#002040,#003878,#0050a0)",accent:"#0f7bcc",tags:["Scotland's Best Right","Arctic Swells"], photo:"https://images.unsplash.com/photo-1527769929977-c341ee9f2e66?w=800&h=600&fit=crop", breakType:"reef"},
  {id:"lahinch",     category:"surfing",title:"Lahinch",                  location:"County Clare, Ireland",    lat:52.9300,lon:-9.3400,ap:"SNN",icon:"🏄",rating:4.82,reviews:1820,gradient:"linear-gradient(160deg,#003344,#005566,#007788)",accent:"#0099bb",tags:["Irish Surf Town","Cliffs of Moher Backdrop"], photo:"https://images.unsplash.com/photo-1508437981923-e88ea3be23de?w=800&h=600&fit=crop", breakType:"beach"},

  // ─── Europe — Canary Islands ──────────────────────────────────────
  {id:"la_santa",    category:"surfing",title:"La Santa",                 location:"Lanzarote, Canary Islands",lat:29.0600,lon:-13.6600,ap:"ACE",icon:"🌊",rating:4.90,reviews:2760,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2288dd",tags:["Year-Round Swell","Lava Rock Reef"], photo:"https://images.unsplash.com/photo-1486890598084-3673ba1a7fc4?w=800&h=600&fit=crop", breakType:"reef"},
  {id:"fuerteventura_surf",category:"surfing",title:"Fuerteventura",     location:"Canary Islands, Spain",    lat:28.3587,lon:-14.0537,ap:"FUE",icon:"🏄",rating:4.88,reviews:3100,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Windsurf & Surf Mecca","Consistent Atlantic"], photo:"https://images.unsplash.com/photo-1461696114087-397271a7aedc?w=800&h=600&fit=crop", breakType:"reef"},
  ...
  {id:"taghazout",   category:"surfing",title:"Taghazout",               location:"Agadir, Morocco",          lat:30.5600,lon:-9.7100,ap:"AGA",icon:"🏄",rating:4.88,reviews:4200,gradient:"linear-gradient(160deg,#003344,#005577,#0077aa)",accent:"#2299cc",tags:["Surf Village","Hash Point & Killers"], photo:"https://images.unsplash.com/photo-1504194921103-f8b80cadd5e4?w=800&h=600&fit=crop", breakType:"point"},

  // ─── Africa — South Africa ────────────────────────────────────────
  {id:"jeffreys_bay",category:"surfing",title:"Jeffreys Bay",            location:"Eastern Cape, South Africa",lat:-34.0500,lon:24.9200,ap:"PLZ",icon:"🌊",rating:4.97,reviews:4640,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2277ff",tags:["J-Bay","WSL Championship Stop"], photo:"https://images.unsplash.com/photo-1530870110042-98b2cb110834?w=800&h=600&fit=crop", breakType:"point"},
  {id:"cape_town_surf",category:"surfing",title:"Cape Town",             location:"Western Cape, South Africa",lat:-33.8900,lon:18.4200,ap:"CPT",icon:"🏄",rating:4.86,reviews:2880,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2288dd",tags:["Table Mountain Backdrop","Cold Water Barrels"], photo:"https://images.unsplash.com/photo-1516815231560-8f41ec531527?w=800&h=600&fit=crop", breakType:"reef"},

  // ─── Bali / Indonesia ─────────────────────────────────────────────
  {id:"uluwatu",     category:"surfing",title:"Uluwatu",                  location:"Bali, Indonesia",          lat:-8.8291,lon:115.0850,ap:"DPS",icon:"🌊",rating:4.96,reviews:6800,gradient:"linear-gradient(160deg,#002244,#003f7f,#0055b3)",accent:"#1188ee",tags:["Cliff Temple","WSL Events"], photo:"https://images.unsplash.com/photo-1585823096440-9fdb837d48ba?w=800&h=600&fit=crop", breakType:"reef"},
  {id:"padang_padang",category:"surfing",title:"Padang Padang",          location:"Bali, Indonesia",          lat:-8.8105,lon:115.0938,ap:"DPS",icon:"🌊",rating:4.93,reviews:4320,gradient:"linear-gradient(160deg,#001f40,#003880,#0055bb)",accent:"#2288ff",tags:["Eat Pray Love Beach","Barreling Left"], photo:"https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?w=800&h=600&fit=crop", breakType:"reef"},
  {id:"keramas",     category:"surfing",title:"Keramas",                  location:"Bali, Indonesia",          lat:-8.5764,lon:115.3190,ap:"DPS",icon:"🏄",rating:4.85,reviews:2640,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Night Surfing","OC Pro Contest"], photo:"https://images.unsplash.com/photo-1537519646099-5e064512a1fd?w=800&h=600&fit=crop", breakType:"beach"},
  {id:"mentawais",   category:"surfing",title:"Mentawai Islands",        location:"West Sumatra, Indonesia",  lat:-2.3500,lon:99.8500,ap:"PDG",icon:"🌊",rating:4.98,reviews:3200,gradient:"linear-gradient(160deg,#001a40,#003080,#0050cc)",accent:"#2277ff",tags:["Perfect Waves","HT's & Lance's Right"], photo:"https://images.unsplash.com/photo-1654137065487-cce388f2c58f?w=800&h=600&fit=crop", breakType:"reef"},

  // ─── Philippines ──────────────────────────────────────────────────
  {id:"cloud9",      category:"surfing",title:"Cloud 9",                  location:"Siargao, Philippines",     lat:9.8600,lon:126.0600,ap:"CEB",icon:"🌊",rating:4.95,reviews:3640,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2288dd",tags:["Asia's Best Wave","Hollow Reef Right"], photo:"https://images.unsplash.com/photo-1520443240718-fce5930fbb38?w=800&h=600&fit=crop", breakType:"reef"},

  // ─── Fiji ─────────────────────────────────────────────────────────
  {id:"cloudbreak",  category:"surfing",title:"Cloudbreak",              location:"Tavarua, Fiji",            lat:-17.7748,lon:177.2362,ap:"NAN",icon:"🌊",rating:4.97,reviews:2980,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2277ff",tags:["South Pacific Power","Boat-Access Only"], photo:"https://images.unsplash.com/photo-1580402403932-f828854cb123?w=800&h=600&fit=crop", breakType:"reef"},
  {id:"restaurants_fiji",category:"surfing",title:"Restaurants",        location:"Tavarua, Fiji",            lat:-17.7800,lon:177.2400,ap:"NAN",icon:"🏄",rating:4.89,reviews:1840,gradient:"linear-gradient(160deg,#003355,#005588,#007fbb)",accent:"#33aadd",tags:["Tavarua Left","Super Consistent"], photo:"https://images.unsplash.com/photo-1501949997128-2fdb1f5fbc85?w=800&h=600&fit=crop", breakType:"reef"},

  // ─── Tahiti ───────────────────────────────────────────────────────
  {id:"teahupoo",    category:"surfing",title:"Teahupo'o",               location:"Tahiti, French Polynesia", lat:-17.8672,lon:-149.2594,ap:"PPT",icon:"🌊",rating:4.99,reviews:3840,gradient:"linear-gradient(160deg,#001530,#003070,#0050bb)",accent:"#1166ee",tags:["Scariest Wave on Earth","2024 Olympics"], photo:"https://images.unsplash.com/photo-1416339306562-f3d12fefd36f?w=800&h=600&fit=crop", breakType:"reef"},

  // ─── Maldives ─────────────────────────────────────────────────────
  {id:"pasta_point", category:"surfing",title:"Pasta Point",             location:"Maldives",                 lat:4.7500,lon:72.9700,ap:"MLE",icon:"🏄",rating:4.94,reviews:2120,gradient:"linear-gradient(160deg,#003344,#005577,#007fa0)",accent:"#00bbdd",tags:["Indian Ocean Luxury","Resort Access"], photo:"https://images.unsplash.com/photo-1543039625-14cbd3802e7d?w=800&h=600&fit=crop", breakType:"point"},
  {id:"jailbreaks",  category:"surfing",title:"Jailbreaks",              location:"South Malé Atoll, Maldives",lat:3.5000,lon:73.0000,ap:"MLE",icon:"🌊",rating:4.88,reviews:1640,gradient:"linear-gradient(160deg,#002244,#004488,#006faa)",accent:"#1199cc",tags:["Dhow Boat Sessions","Crystal Water"], photo:"https://images.unsplash.com/photo-1545251142-f32339076e6d?w=800&h=600&fit=crop", breakType:"reef"},

  // ─── Australia ────────────────────────────────────────────────────
  {id:"snapper_rocks",category:"surfing",title:"Snapper Rocks",         location:"Gold Coast, Queensland",   lat:-28.1640,lon:153.5546,ap:"OOL",icon:"🌊",rating:4.94,reviews:5400,gradient:"linear-gradient(160deg,#002244,#003f7f,#0055b3)",accent:"#1177cc",tags:["Superbank","WSL Opener"], photo:"https://images.unsplash.com/photo-1583105103934-32c7a64ba012?w=800&h=600&fit=crop", breakType:"point"},
  {id:"bells_beach",  category:"surfing",title:"Bells Beach",           location:"Torquay, Victoria",        lat:-38.3700,lon:144.2800,ap:"MEL",icon:"🌊",rating:4.91,reviews:3680,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Rip Curl Pro","Australia's Most Famous"], photo:"https://images.unsplash.com/photo-1564429238961-2dbc6e71ea68?w=800&h=600&fit=crop", breakType:"reef"},
  {id:"margaret_river_surf",category:"surfing",title:"Margaret River",  location:"Western Australia",        lat:-34.0500,lon:115.0900,ap:"PER",icon:"🌊",rating:4.89,reviews:2840,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2288dd",tags:["Wine & Waves","Championship Reef"], photo:"https://images.unsplash.com/photo-1581059089599-0b7e13b9d952?w=800&h=600&fit=crop", breakType:"reef"},
  {id:"the_pass",    category:"surfing",title:"The Pass",               location:"Byron Bay, NSW",           lat:-28.6500,lon:153.5800,ap:"OOL",icon:"🏄",rating:4.87,reviews:4100,gradient:"linear-gradient(160deg,#003355,#005580,#007faa)",accent:"#2299cc",tags:["Byron Bay Icon","Long Mellow Rights"], photo:"https://images.unsplash.com/photo-1484804959655-1074f38e5394?w=800&h=600&fit=crop", breakType:"point"},

  // ─── New Zealand ──────────────────────────────────────────────────
  {id:"raglan",      category:"surfing",title:"Raglan",                  location:"Waikato, New Zealand",     lat:-37.8000,lon:174.8700,ap:"AKL",icon:"🌊",rating:4.88,reviews:2420,gradient:"linear-gradient(160deg,#002244,#004488,#0066bb)",accent:"#1188dd",tags:["Southern Hemisphere Left","Endless Rides"], photo:"https://images.unsplash.com/photo-1461730278450-19cc1863601c?w=800&h=600&fit=crop", breakType:"point"},
  ...
  // ─── 280 Additional Surf Spots ─────────────────────────────────────────────
  {id:"padang_bai", category:"surfing",title:"Padang Bai", location:"Bali, Indonesia", lat:-8.5533,lon:115.3717,ap:"DPS",icon:"🏄",rating:4.72,reviews:892,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2288dd",tags:["Beginner Friendly","Blue Barrel"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"ceningan_island", category:"surfing",title:"Ceningan Island", location:"Nusa Penida, Indonesia", lat:-8.6733,lon:115.6375,ap:"DPS",icon:"🏄",rating:4.68,reviews:1245,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Crystal Clear","Secret Spot"],photo:"https://images.unsplash.com/photo-1502680390548-bdbac40e2a78?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"sungailaut", category:"surfing",title:"Sungailaut", location:"Simeulue, Indonesia", lat:2.6238,lon:96.2394,ap:"MDN",icon:"🏄",rating:4.81,reviews:634,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#2299ee",tags:["Hollow Barrels","Consistent Swell"],photo:"https://images.unsplash.com/photo-1544255089-256abef2d44a?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"sorake_beach", category:"surfing",title:"Sorake Beach", location:"Nias, Indonesia", lat:0.9475,lon:97.6342,ap:"BTJ",icon:"🏄",rating:4.76,reviews:2156,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0099bb",tags:["Perfect Right Hander","Warm Water"],photo:"https://images.unsplash.com/photo-1509233725247-49e657c25740?w=800&h=600&fit=crop",breakType:"point"},
  {id:"krui_left", category:"surfing",title:"Krui Left", location:"Lampung, Indonesia", lat:-5.1156,lon:103.6244,ap:"TKG",icon:"🏄",rating:4.79,reviews:1087,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1177cc",tags:["Long Barrels","Down The Line"],photo:"https://images.unsplash.com/photo-1526813951498-5498cce49cdf?w=800&h=600&fit=crop",breakType:"point"},
  {id:"siargao_island", category:"surfing",title:"Siargao Island", location:"Siargao, Philippines", lat:9.1184,lon:126.2081,ap:"CRK",icon:"🏄",rating:4.74,reviews:3421,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2277ff",tags:["Surfer's Paradise","Year Round"],photo:"https://images.unsplash.com/photo-1505459668311-8dfac7952bf0?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cloud9_siargao", category:"surfing",title:"Cloud 9 Reef", location:"Siargao, Philippines", lat:9.1267,lon:126.2134,ap:"CRK",icon:"🌊",rating:4.88,reviews:2834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Hollow Reef","Hardcore Spot"],photo:"https://images.unsplash.com/photo-1542259009477-d625272157b7?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"ditumabo", category:"surfing",title:"Ditumabo", location:"Catanduanes, Philippines", lat:13.8944,lon:124.3394,ap:"VCT",icon:"🏄",rating:4.65,reviews:743,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#0f7bcc",tags:["Sandy Beach","Scenic"],photo:"https://images.unsplash.com/photo-1477204505220-510cd0d57764?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"pacifico_mexico", category:"surfing",title:"Pacifico", location:"Nayarit, Mexico", lat:21.4917,lon:-105.2906,ap:"PVR",icon:"🏄",rating:4.71,reviews:1456,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2288dd",tags:["Warm Waves","Cheap Eats"],photo:"https://images.unsplash.com/photo-1455729552457-5c322d6024db?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"bucerias", category:"surfing",title:"Bucerias", location:"Nayarit, Mexico", lat:21.7575,lon:-105.2894,ap:"PVR",icon:"🏄",rating:4.67,reviews:892,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1188ee",tags:["Funky Rights","Artsy Town"],photo:"https://images.unsplash.com/photo-1531722569936-825d3dd91b15?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"guanacaste_costa_rica", category:"surfing",title:"Tamarindo", location:"Guanacaste, Costa Rica", lat:10.3009,lon:-85.8375,ap:"SJO",icon:"🏄",rating:4.73,reviews:4231,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Party Vibe","Easy Waves"],photo:"https://images.unsplash.com/photo-1468413253725-0d5181091126?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"avellanas", category:"surfing",title:"Playa Avellanas", location:"Guanacaste, Costa Rica", lat:10.0667,lon:-85.6,ap:"SJO",icon:"🏄",rating:4.78,reviews:1823,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#0099bb",tags:["Hollow Peak","Low Key"],photo:"https://images.unsplash.com/photo-1502933691298-84fc14542831?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"salsa_brava", category:"surfing",title:"Salsa Brava", location:"Limon, Costa Rica", lat:9.7543,lon:-82.6431,ap:"SJO",icon:"🌊",rating:4.86,reviews:756,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#1177cc",tags:["Dangerous Reef","Expert Only"],photo:"https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"leon_nicaragua", category:"surfing",title:"Leon Beachbreak", location:"Leon, Nicaragua", lat:12.4375,lon:-86.8931,ap:"MGA",icon:"🏄",rating:4.64,reviews:987,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#33aadd",tags:["Perfect Left","Backpacker Hub"],photo:"https://images.unsplash.com/photo-1544551763-77932c184deb?w=800&h=600&fit=crop",breakType:"point"},
  {id:"popoyo", category:"surfing",title:"Popoyo", location:"Rivas, Nicaragua", lat:11.3522,lon:-85.9517,ap:"MGA",icon:"🏄",rating:4.69,reviews:1201,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2288dd",tags:["Right Point","Consistent"],photo:"https://images.unsplash.com/photo-1497890312100-1e4488c9e5e5?w=800&h=600&fit=crop",breakType:"point"},
  {id:"panama_bocas", category:"surfing",title:"Bocas del Toro", location:"Bocas del Toro, Panama", lat:9.3520,lon:-82.2394,ap:"BOC",icon:"🏄",rating:4.62,reviews:1543,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Caribbean Vibes","Reef Breaks"],photo:"https://images.unsplash.com/photo-1496737018672-b1a6be2e949c?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"manzanillo_costa_rica", category:"surfing",title:"Manzanillo", location:"Limon, Costa Rica", lat:9.6347,lon:-82.6389,ap:"SJO",icon:"🏄",rating:4.68,reviews:834,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#2299ee",tags:["Empty Waves","Jungle Backdrop"],photo:"https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"jaco_costa_rica", category:"surfing",title:"Jaco Beach", location:"Puntarenas, Costa Rica", lat:9.7727,lon:-84.6344,ap:"SJO",icon:"🏄",rating:4.65,reviews:2156,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#0099bb",tags:["Nightlife","Black Sand"],photo:"https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"uvita_costa_rica", category:"surfing",title:"Uvita", location:"Puntarenas, Costa Rica", lat:9.1667,lon:-83.7333,ap:"SJO",icon:"🏄",rating:4.71,reviews:1678,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1177cc",tags:["Whale Tail View","Lazy Vibe"],photo:"https://images.unsplash.com/photo-1517699418036-fb2fcd498b89?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"witch_rock_baja", category:"surfing",title:"Witch's Rock", location:"Guanacaste, Costa Rica", lat:10.5011,lon:-85.7522,ap:"SJO",icon:"🏄",rating:4.74,reviews:943,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2277ff",tags:["Rocky Peak","Scenic Drop"],photo:"https://images.unsplash.com/photo-1504194921103-f8b80cadd5e4?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"malpais_costa_rica", category:"surfing",title:"Malpais", location:"Puntarenas, Costa Rica", lat:9.6161,lon:-85.1364,ap:"SJO",icon:"🏄",rating:4.73,reviews:1234,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#33aadd",tags:["Rugged Coast","Wild Waves"],photo:"https://images.unsplash.com/photo-1530870110042-98b2cb110834?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"dominical_costa_rica", category:"surfing",title:"Dominical", location:"Puntarenas, Costa Rica", lat:9.2506,lon:-83.6417,ap:"SJO",icon:"🏄",rating:4.70,reviews:1456,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0f7bcc",tags:["Laid Back","River Mouth"],photo:"https://images.unsplash.com/photo-1585823096440-9fdb837d48ba?w=800&h=600&fit=crop",breakType:"rivermouth"},
  {id:"santa_teresa_costa_rica", category:"surfing",title:"Santa Teresa", location:"Puntarenas, Costa Rica", lat:9.6233,lon:-85.2181,ap:"SJO",icon:"🏄",rating:4.76,reviews:2234,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2288dd",tags:["Yoga Mecca","Beach Town"],photo:"https://images.unsplash.com/photo-1518548419970-58e3b4079ab2?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"ecuaflat_ecuador", category:"surfing",title:"Ecuaflat", location:"Santa Elena, Ecuador", lat:-2.2255,lon:-80.4378,ap:"UIO",icon:"🏄",rating:4.68,reviews:567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Flat Face","Perfect Tube"],photo:"https://images.unsplash.com/photo-1537519646099-5e064512a1fd?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"salinas_ecuador", category:"surfing",title:"Salinas", location:"Santa Elena, Ecuador", lat:-2.2061,lon:-80.9667,ap:"UIO",icon:"🏄",rating:4.62,reviews:834,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#2299ee",tags:["Party Beach","Good Eats"],photo:"https://images.unsplash.com/photo-1654137065487-cce388f2c58f?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"montanita_ecuador", category:"surfing",title:"Montanita", location:"Santa Elena, Ecuador", lat:-1.8558,lon:-80.7617,ap:"UIO",icon:"🏄",rating:4.65,reviews:1876,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0099bb",tags:["Backpacker Town","Sandy Breaks"],photo:"https://images.unsplash.com/photo-1520443240718-fce5930fbb38?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"manta_ecuador", category:"surfing",title:"Manta", location:"Manabi, Ecuador", lat:-0.9734,lon:-80.7378,ap:"MEC",icon:"🏄",rating:4.61,reviews:743,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#1177cc",tags:["Consistent Swell","Working Town"],photo:"https://images.unsplash.com/photo-1580402403932-f828854cb123?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"atacama_peru", category:"surfing",title:"Atacama", location:"Ica, Peru", lat:-13.0167,lon:-75.5333,ap:"AQT",icon:"🏄",rating:4.58,reviews:456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Desert Waves","Remote"],photo:"https://images.unsplash.com/photo-1501949997128-2fdb1f5fbc85?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"tumbes_peru", category:"surfing",title:"Tumbes", location:"Tumbes, Peru", lat:-3.5667,lon:-80.4,ap:"TPP",icon:"🏄",rating:4.64,reviews:589,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#2288dd",tags:["Tropical Peru","Warm Water"],photo:"https://images.unsplash.com/photo-1416339306562-f3d12fefd36f?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"chicama_peru_left", category:"surfing",title:"Chicama Left Point", location:"La Libertad, Peru", lat:-8.3814,lon:-79.0142,ap:"TRU",icon:"🌊",rating:4.89,reviews:1234,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1188ee",tags:["Longest Left","World Record"],photo:"https://images.unsplash.com/photo-1543039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"puertoChicama", category:"surfing",title:"Puerto Chicama Village", location:"La Libertad, Peru", lat:-8.3833,lon:-79.0167,ap:"TRU",icon:"🏄",rating:4.73,reviews:923,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2299ee",tags:["River Mouth","Easy Access"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"rivermouth"},
  {id:"cerraze_peru", category:"surfing",title:"Cerro Azul", location:"Canete, Peru", lat:-13.3,lon:-76.3667,ap:"LIM",icon:"🏄",rating:4.69,reviews:678,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Long Right","Consistent"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"zarumilla_peru", category:"surfing",title:"Zarumilla", location:"Tumbes, Peru", lat:-3.4167,lon:-80.1667,ap:"TPP",icon:"🏄",rating:4.62,reviews:534,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#1177cc",tags:["Border Break","Empty"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"playa_grande_brazil", category:"surfing",title:"Playa Grande", location:"Santa Catarina, Brazil", lat:-26.8667,lon:-48.75,ap:"SSC",icon:"🏄",rating:4.71,reviews:1567,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2277ff",tags:["Town Beach","Busy Lineup"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"guarda_do_embaú", category:"surfing",title:"Guarda do Embaú", location:"Santa Catarina, Brazil", lat:-27.8333,lon:-48.6667,ap:"SSC",icon:"🏄",rating:4.74,reviews:892,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Forested Beach","Hollow Peaks"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"mariscal_brasil", category:"surfing",title:"Mariscal", location:"Santa Catarina, Brazil", lat:-26.95,lon:-48.6833,ap:"SSC",icon:"🏄",rating:4.68,reviews:745,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0099bb",tags:["Punchy Peaks","Empty Waves"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"garopaba_brasil", category:"surfing",title:"Garopaba", location:"Santa Catarina, Brazil", lat:-27.8333,lon:-48.7333,ap:"SSC",icon:"🏄",rating:4.70,reviews:1234,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1188ee",tags:["Multi Peak","Scenic"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"itamambuca_brasil", category:"surfing",title:"Itamambuca", location:"Sao Paulo, Brazil", lat:-23.7667,lon:-45.1,ap:"GIG",icon:"🏄",rating:4.65,reviews:876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Point Break","Fast Wave"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"ubatuba_brasil", category:"surfing",title:"Ubatuba", location:"Sao Paulo, Brazil", lat:-23.4667,lon:-45.0667,ap:"GIG",icon:"🏄",rating:4.72,reviews:1456,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#2299ee",tags:["Multi Peaks","Party Town"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"icarai_brasil", category:"surfing",title:"Icarai", location:"Rio de Janeiro, Brazil", lat:-23.0,lon:-43.1667,ap:"GIG",icon:"🏄",rating:4.61,reviews:2345,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#0f7bcc",tags:["Urban Beach","Busy Lineup"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"arpoador_brasil", category:"surfing",title:"Arpoador", location:"Rio de Janeiro, Brazil", lat:-23.0117,lon:-43.1906,ap:"GIG",icon:"🏄",rating:4.63,reviews:1876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Rocky Reef","Vibrant City"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"praia_brava_brasil", category:"surfing",title:"Praia Brava", location:"Rio de Janeiro, Brazil", lat:-22.9706,lon:-43.2272,ap:"GIG",icon:"🏄",rating:4.69,reviews:1123,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#33aadd",tags:["Secret Cove","Scenic"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"fernando_noronha_novo", category:"surfing",title:"Noronha Novo", location:"Pernambuco, Brazil", lat:-3.8558,lon:-32.4275,ap:"NAT",icon:"🏄",rating:4.85,reviews:634,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2277ff",tags:["Pristine Reefs","Island Paradise"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"atins_brasil", category:"surfing",title:"Atins", location:"Maranhao, Brazil", lat:-2.6167,lon:-42.8167,ap:"MAO",icon:"🏄",rating:4.58,reviews:456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Desert Dunes","Sand River"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"jericoacoara_brasil", category:"surfing",title:"Jericoacoara", location:"Ceara, Brazil", lat:-2.7667,lon:-40.5,ap:"FOR",icon:"🏄",rating:4.70,reviews:1789,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#1188ee",tags:["Dune Beach","Lagoon Access"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cumbuco_brasil", category:"surfing",title:"Cumbuco", location:"Ceara, Brazil", lat:-3.0333,lon:-38.9,ap:"FOR",icon:"🏄",rating:4.64,reviews:1234,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2299ee",tags:["Windy Waves","Kite Hub"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"maceio_brasil", category:"surfing",title:"Maceio", location:"Alagoas, Brazil", lat:-9.6658,lon:-35.7353,ap:"MAO",icon:"🏄",rating:4.59,reviews:876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Tropical Setting","Urban Beach"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"trancoso_brasil", category:"surfing",title:"Trancoso", location:"Bahia, Brazil", lat:-16.8333,lon:-39.1,ap:"ILH",icon:"🏄",rating:4.67,reviews:945,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#33aadd",tags:["Bahian Vibes","Colonial Town"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"santa_cruz_cabralia", category:"surfing",title:"Santa Cruz Cabralia", location:"Bahia, Brazil", lat:-16.3333,lon:-39.05,ap:"ILH",icon:"🏄",rating:4.61,reviews:678,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0f7bcc",tags:["Discovery Coast","Empty Waves"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"ilheus_brasil", category:"surfing",title:"Ilheus", location:"Bahia, Brazil", lat:-14.7867,lon:-39.0383,ap:"ILH",icon:"🏄",rating:4.65,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Chocolate Coast","Historic Town"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"tamarindo_baja", category:"surfing",title:"Tamarindo Baja Sur", location:"Baja California Sur, Mexico", lat:24.6333,lon:-111.3,ap:"LAS",icon:"🏄",rating:4.68,reviews:1123,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#2299ee",tags:["Hot Desert","Crystal Waters"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cerritos_baja", category:"surfing",title:"Cerritos", location:"Baja California Sur, Mexico", lat:23.7583,lon:-111.2833,ap:"LAS",icon:"🏄",rating:4.70,reviews:1567,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#0099bb",tags:["Funky Beach Break","Good Tacos"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"pulmo_baja", category:"surfing",title:"Cabo Pulmo", location:"Baja California Sur, Mexico", lat:23.4167,lon:-109.4,ap:"LAS",icon:"🏄",rating:4.75,reviews:856,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Pristine Reef","Marine Park"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"los_barriles", category:"surfing",title:"Los Barriles", location:"Baja California Sur, Mexico", lat:23.6333,lon:-109.6667,ap:"LAS",icon:"🏄",rating:4.64,reviews:743,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1177cc",tags:["Windy Point","Expat Town"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"todos_santos", category:"surfing",title:"Todos Santos", location:"Baja California Sur, Mexico", lat:23.7333,lon:-110.2333,ap:"LAS",icon:"🏄",rating:4.72,reviews:2145,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Magical Artsy Town","Epic Waves"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cerritos_todos", category:"surfing",title:"Cerritos Todos Santos", location:"Baja California Sur, Mexico", lat:23.7667,lon:-110.2667,ap:"LAS",icon:"🏄",rating:4.68,reviews:1098,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2277ff",tags:["Sandy Beach","Laid Back"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cerritos_ventura", category:"surfing",title:"Ventura County Spots", location:"California, USA", lat:34.2805,lon:-119.2945,ap:"BUR",icon:"🏄",rating:4.71,reviews:3456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Freeway Access","Consistent"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"malibu_secondary", category:"surfing",title:"Secondary Malibu Break", location:"California, USA", lat:34.0308,lon:-118.6816,ap:"BUR",icon:"🏄",rating:4.76,reviews:2234,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2288dd",tags:["Mellow Point","Crowded Lineup"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"san_clemente_pier", category:"surfing",title:"San Clemente Pier", location:"California, USA", lat:33.4272,lon:-117.6211,ap:"SNA",icon:"🏄",rating:4.65,reviews:1876,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#1188ee",tags:["Punchy Waves","Pier Break"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"doheny_beach", category:"surfing",title:"Doheny Beach", location:"California, USA", lat:33.6447,lon:-117.7583,ap:"SNA",icon:"🏄",rating:4.62,reviews:2567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["State Park","Perfect Beginner"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"lowers_trestles", category:"surfing",title:"Lower Trestles", location:"California, USA", lat:33.4106,lon:-117.5972,ap:"SNA",icon:"🏄",rating:4.79,reviews:1234,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0099bb",tags:["Hollow Peak","Long Ride"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"salt_creek", category:"surfing",title:"Salt Creek", location:"California, USA", lat:33.6001,lon:-117.7372,ap:"SNA",icon:"🏄",rating:4.68,reviews:1456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Reef Break","Busy Lineup"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"cottons_california", category:"surfing",title:"Cottons", location:"California, USA", lat:33.5667,lon:-117.6667,ap:"SNA",icon:"🏄",rating:4.61,reviews:987,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#33aadd",tags:["Powerful Reef","Expert Wave"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"leo_carrillo", category:"surfing",title:"Leo Carrillo State Beach", location:"California, USA", lat:34.0267,lon:-118.9408,ap:"BUR",icon:"🏄",rating:4.64,reviews:1123,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Mellow Lefts","Scenic Canyon"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"topanga_california", category:"surfing",title:"Topanga State Beach", location:"California, USA", lat:34.0103,lon:-118.8036,ap:"BUR",icon:"🏄",rating:4.66,reviews:1345,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2299ee",tags:["Right Point","Mountain View"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"county_line", category:"surfing",title:"County Line", location:"California, USA", lat:34.0308,lon:-118.9297,ap:"BUR",icon:"🏄",rating:4.71,reviews:876,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#0f7bcc",tags:["Mellow Lefts","Sandy Point"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"zuma_beach", category:"surfing",title:"Zuma Beach", location:"California, USA", lat:34.0022,lon:-118.8361,ap:"BUR",icon:"🏄",rating:4.65,reviews:2134,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Cruisy Waves","Family Beach"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"point_dume", category:"surfing",title:"Point Dume", location:"California, USA", lat:34.0019,lon:-118.8042,ap:"BUR",icon:"🏄",rating:4.73,reviews:945,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1177cc",tags:["Scenic Point","Right Hander"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"westward_beach", category:"surfing",title:"Westward Beach", location:"California, USA", lat:34.0108,lon:-118.8028,ap:"BUR",icon:"🏄",rating:4.62,reviews:1567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Punchy Peak","Cove Located"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"surfrider_beach", category:"surfing",title:"Surfrider Beach", location:"California, USA", lat:34.0236,lon:-118.7789,ap:"BUR",icon:"🏄",rating:4.77,reviews:3215,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#0099bb",tags:["Iconic Spot","Pier Break"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"big_dume_cove", category:"surfing",title:"Big Dume Cove", location:"California, USA", lat:34.0019,lon:-118.8031,ap:"BUR",icon:"🏄",rating:4.68,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Secret Cove","Morning Glass"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"carbon_beach", category:"surfing",title:"Carbon Beach", location:"California, USA", lat:-2.0219,lon:-118.7219,ap:"BUR",icon:"🏄",rating:4.64,reviews:1098,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2299ee",tags:["Private Beach","Sandy Peaks"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"trancas_beach", category:"surfing",title:"Trancas Beach", location:"California, USA", lat:34.0397,lon:-118.6897,ap:"BUR",icon:"🏄",rating:4.70,reviews:743,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Long Right Hander","Morning Duty"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"neptune_nets", category:"surfing",title:"Neptune's Net", location:"California, USA", lat:34.0514,lon:-118.7136,ap:"BUR",icon:"🏄",rating:4.59,reviews:567,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1188ee",tags:["Seafood Shack","Reef Waves"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"ventura_pier", category:"surfing",title:"Ventura Pier", location:"California, USA", lat:34.2759,lon:-119.2942,ap:"BUR",icon:"🏄",rating:4.66,reviews:2456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Pier Break","Urban Access"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"oxnard_shores", category:"surfing",title:"Oxnard Shores", location:"California, USA", lat:34.1803,lon:-119.1833,ap:"BUR",icon:"🏄",rating:4.61,reviews:1234,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#33aadd",tags:["Sandy Beach","Mellow"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"rincon_island", category:"surfing",title:"Rincon Island Breaks", location:"California, USA", lat:34.3283,lon:-119.4094,ap:"BUR",icon:"🏄",rating:4.74,reviews:856,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#0099bb",tags:["Protected Reef","Oil Island"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"carpinteria_state", category:"surfing",title:"Carpinteria State Beach", location:"California, USA", lat:34.3966,lon:-119.5261,ap:"SBA",icon:"🏄",rating:4.68,reviews:1876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Mellow Point","Family Friendly"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"santa_barbara_beach", category:"surfing",title:"Santa Barbara Main Beach", location:"California, USA", lat:34.4084,lon:-119.6901,ap:"SBA",icon:"🏄",rating:4.65,reviews:2345,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2299ee",tags:["Urban Waves","Beginner","Crowded"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"goleta_point", category:"surfing",title:"Goleta Point", location:"California, USA", lat:34.4247,lon:-119.7961,ap:"SBA",icon:"🏄",rating:4.72,reviews:945,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Protected Left","Consistent"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"cowell_beach", category:"surfing",title:"Cowell Beach", location:"California, USA", lat:36.9574,lon:-122.0275,ap:"SJC",icon:"🏄",rating:4.63,reviews:3421,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#1188ee",tags:["Urban Break","Beginner Waves"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"steamer_lane", category:"surfing",title:"Steamer Lane", location:"California, USA", lat:36.9539,lon:-122.0257,ap:"SJC",icon:"🌊",rating:4.82,reviews:1567,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#1177cc",tags:["Powerful Reef","Expert Only"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"pleasure_point", category:"surfing",title:"Pleasure Point", location:"California, USA", lat:36.9319,lon:-122.0189,ap:"SJC",icon:"🏄",rating:4.71,reviews:2134,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Crowded Lineup","Reef Break"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"natural_bridges", category:"surfing",title:"Natural Bridges", location:"California, USA", lat:36.9548,lon:-122.0406,ap:"SJC",icon:"🏄",rating:4.64,reviews:876,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0099bb",tags:["Arch Formation","Sandy Beach"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"capitola_wharf", category:"surfing",title:"Capitola Wharf", location:"California, USA", lat:36.9731,lon:-121.9631,ap:"SJC",icon:"🏄",rating:4.59,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Colorful Village","Pier Break"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"aptos_seacliff", category:"surfing",title:"Aptos Seacliff", location:"California, USA", lat:36.9786,lon:-121.8889,ap:"SJC",icon:"🏄",rating:4.67,reviews:1456,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2299ee",tags:["State Beach","Pier Access"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"watsonville_area", category:"surfing",title:"Pajaro Dunes", location:"California, USA", lat:36.8017,lon:-121.7892,ap:"SJC",icon:"🏄",rating:4.62,reviews:743,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Empty Waves","Sandy Point"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"big_sur_pfeiffer", category:"surfing",title:"Pfeiffer Beach", location:"California, USA", lat:36.2393,lon:-121.8138,ap:"SJC",icon:"🏄",rating:4.76,reviews:2345,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1188ee",tags:["Purple Sand","Scenic Break"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"andrewmolera", category:"surfing",title:"Andrew Molera State Park", location:"California, USA", lat:36.2947,lon:-121.8064,ap:"SJC",icon:"🏄",rating:4.69,reviews:1098,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Scenic Park","Beach Break"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"moonstone_beach", category:"surfing",title:"Moonstone Beach", location:"California, USA", lat:36.0844,lon:-121.2656,ap:"SBY",icon:"🏄",rating:4.65,reviews:834,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#33aadd",tags:["Stone Beach","Right Break"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"piedrasblancas", category:"surfing",title:"Piedras Blancas", location:"California, USA", lat:35.7614,lon:-121.2806,ap:"SBY",icon:"🏄",rating:4.72,reviews:567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["White Rocks","Empty Break"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"cambria_pinedeo", category:"surfing",title:"Cambria Beaches", location:"California, USA", lat:35.5603,lon:-121.0886,ap:"SBY",icon:"🏄",rating:4.60,reviews:1256,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#2288dd",tags:["Town Beach","Scenic"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cayucos_pier", category:"surfing",title:"Cayucos Pier", location:"California, USA", lat:35.4455,lon:-120.8889,ap:"SBY",icon:"🏄",rating:4.66,reviews:2134,gradient:"linear-gradient(160deg,#003344,#005577,#007799)",accent:"#2299ee",tags:["Pier Break","Mellow Waves"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"morro_rock", category:"surfing",title:"Morro Rock", location:"California, USA", lat:35.3617,lon:-120.8628,ap:"SBY",icon:"🏄",rating:4.71,reviews:1876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Iconic Rock","Mellow Break"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"estero_point", category:"surfing",title:"Estero Point", location:"California, USA", lat:35.2989,lon:-120.7883,ap:"SBY",icon:"🏄",rating:4.68,reviews:943,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1188ee",tags:["Sandy Point","Consistent"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"pismo_pier", category:"surfing",title:"Pismo Pier", location:"California, USA", lat:35.1411,lon:-120.6406,ap:"SBY",icon:"🏄",rating:4.64,reviews:2345,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Pier Break","Beach Town"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"santa_maria_breaks", category:"surfing",title:"Santa Maria Valley Breaks", location:"California, USA", lat:34.9406,lon:-120.4358,ap:"SBY",icon:"🏄",rating:4.59,reviews:656,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#33aadd",tags:["Windy Breaks","Consistent"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"santa_barbara_anchorpoint", category:"surfing",title:"Anchor Point Santa Barbara", location:"California, USA", lat:34.3756,lon:-119.6983,ap:"SBA",icon:"🏄",rating:4.73,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Perfect Left","Rare Days"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"prison_point", category:"surfing",title:"Prison Point", location:"California, USA", lat:34.3972,lon:-119.6856,ap:"SBA",icon:"🏄",rating:4.67,reviews:1098,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2288dd",tags:["Left Hander","Cold Water"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"isle_vista_breaks", location:"California, USA", lat:34.4108,lon:-119.8536,ap:"SBA",icon:"🏄",rating:4.58,reviews:2456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["College Town","Sandy Waves"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach",category:"surfing",title:"Isla Vista Breaks"},
  {id:"gaviota_pass", category:"surfing",title:"Gaviota Pass", location:"California, USA", lat:34.4681,lon:-120.2328,ap:"SBA",icon:"🏄",rating:4.70,reviews:745,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0f7bcc",tags:["Windy Point Break","Exposed"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"jalama_beach", category:"surfing",title:"Jalama Beach", location:"California, USA", lat:34.5034,lon:-120.5414,ap:"SBA",icon:"🏄",rating:4.72,reviews:923,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Remote Beach","Magical Mornings"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"santa_ynez_area", category:"surfing",title:"Santa Ynez Valley", location:"California, USA", lat:34.6167,lon:-120.1,ap:"SBA",icon:"🏄",rating:4.61,reviews:567,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1177cc",tags:["Wine Country","Inland Breaks"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"point_conception", category:"surfing",title:"Point Conception", location:"California, USA", lat:34.4478,lon:-120.4736,ap:"SBA",icon:"🌊",rating:4.84,reviews:456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Big Wave Spot","Dangerous Current"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"pacific_beach_sandiego", category:"surfing",title:"Pacific Beach Pier", location:"California, USA", lat:32.7928,lon:-117.2495,ap:"SAN",icon:"🏄",rating:4.68,reviews:3456,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#0099bb",tags:["Pier Break","Busy Beach"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"mission_beach_san", category:"surfing",title:"Mission Beach", location:"California, USA", lat:32.7722,lon:-117.2414,ap:"SAN",icon:"🏄",rating:4.64,reviews:2876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Crowded Beach","Fast Food"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"ocean_beach_san", category:"surfing",title:"Ocean Beach San Diego", location:"California, USA", lat:32.7540,lon:-117.2509,ap:"SAN",icon:"🏄",rating:4.71,reviews:2345,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2299ee",tags:["Pier Break","Party Vibe"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"cardiff_reef", category:"surfing",title:"Cardiff Reef", location:"California, USA", lat:32.8899,lon:-117.2447,ap:"SAN",icon:"🏄",rating:4.77,reviews:1678,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Consistent Reef","Mellow Vibe"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"swamis_encinitas", category:"surfing",title:"Swamis", location:"California, USA", lat:32.9601,lon:-117.2895,ap:"SAN",icon:"🏄",rating:4.75,reviews:1456,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1188ee",tags:["Scenic Cliffs","Consistent Barrels"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3802e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"d_street_encinitas", category:"surfing",title:"D Street", location:"California, USA", lat:32.9755,lon:-117.2833,ap:"SAN",icon:"🏄",rating:4.72,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Mellow Point","Beginner Wave"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"tamarack_avenue", category:"surfing",title:"Tamarack Avenue", location:"California, USA", lat:32.9662,lon:-117.2861,ap:"SAN",icon:"🏄",rating:4.68,reviews:987,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#33aadd",tags:["Funky Peak","Local Spot"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"stone_steps", category:"surfing",title:"Stone Steps", location:"California, USA", lat:32.9549,lon:-117.2984,ap:"SAN",icon:"🏄",rating:4.65,reviews:1345,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Steep Stairs","Consistent Waves"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"beacon_point", category:"surfing",title:"Beacon Point", location:"California, USA", lat:32.9422,lon:-117.3106,ap:"SAN",icon:"🏄",rating:4.70,reviews:876,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2288dd",tags:["Point Break","Rocky Cove"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"campground_breaks", category:"surfing",title:"Campground Breaks", location:"California, USA", lat:33.1431,lon:-117.3239,ap:"SAN",icon:"🏄",rating:4.63,reviews:1198,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Sandy Beach","Good Barbecue"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"torrey_pines_breaks", category:"surfing",title:"Torrey Pines Breaks", location:"California, USA", lat:32.9234,lon:-117.2559,ap:"SAN",icon:"🏄",rating:4.67,reviews:1567,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0f7bcc",tags:["Scenic Cliffs","Sandy Peak"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"bird_rock_san", category:"surfing",title:"Bird Rock", location:"California, USA", lat:32.8681,lon:-117.2717,ap:"SAN",icon:"🏄",rating:4.69,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Kelp Forest","Sea Lion Seals"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"sunset_cliffs", category:"surfing",title:"Sunset Cliffs", location:"California, USA", lat:32.7573,lon:-117.2461,ap:"SAN",icon:"🏄",rating:4.64,reviews:2345,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1177cc",tags:["Spectator Spot","Golden Hour"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"imperial_beach_pier", category:"surfing",title:"Imperial Beach Pier", location:"California, USA", lat:32.5748,lon:-117.1292,ap:"SAN",icon:"🏄",rating:4.58,reviews:1876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Border Town","Pier Break"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"tijuana_sloughs", category:"surfing",title:"Tijuana Sloughs", location:"California, USA", lat:32.5466,lon:-117.1239,ap:"SAN",icon:"🏄",rating:4.62,reviews:743,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#0099bb",tags:["Salt Marsh","Mellow Waves"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"barc_breaks", category:"surfing",title:"BARC Breaks", location:"California, USA", lat:32.5613,lon:-117.1353,ap:"SAN",icon:"🏄",rating:4.59,reviews:567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["South Bay Ripples","Dune Access"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"humboldt_county", category:"surfing",title:"Humboldt County Breaks", location:"California, USA", lat:40.7661,lon:-124.1977,ap:"ACV",icon:"🏄",rating:4.71,reviews:1234,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2299ee",tags:["Cold Water","Secluded Beaches"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"salt_point_california", category:"surfing",title:"Salt Point", location:"California, USA", lat:38.5119,lon:-123.3403,ap:"SFO",icon:"🏄",rating:4.73,reviews:876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["State Reserve","Rocky Cove"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"bodega_head", category:"surfing",title:"Bodega Head", location:"California, USA", lat:38.3167,lon:-123.0667,ap:"SFO",icon:"🏄",rating:4.68,reviews:1345,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1188ee",tags:["Exposed Point","Fun Beach"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"point"},
  {id:"fort_ross", category:"surfing",title:"Fort Ross", location:"California, USA", lat:38.5078,lon:-123.2397,ap:"SFO",icon:"🏄",rating:4.65,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Historic Site","Sandy Beach"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"point_arena", category:"surfing",title:"Point Arena", location:"California, USA", lat:38.9062,lon:-123.7224,ap:"SFO",icon:"🏄",rating:4.70,reviews:1098,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#33aadd",tags:["Exposed Reef","Powerful Waves"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"mendocino_county", category:"surfing",title:"Mendocino County Breaks", location:"California, USA", lat:39.2833,lon:-123.8,ap:"OAK",icon:"🏄",rating:4.64,reviews:743,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Coastal Cliffs","Remote Access"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cork_screw_beach", category:"surfing",title:"Cork Screw Beach", location:"California, USA", lat:39.4617,lon:-123.8103,ap:"OAK",icon:"🏄",rating:4.67,reviews:567,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2288dd",tags:["Sandy Beach","Local Wave"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"eureka_breaks", category:"surfing",title:"Eureka Breaks", location:"California, USA", lat:40.8021,lon:-124.1637,ap:"ACV",icon:"🏄",rating:4.62,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Redwood Country","Muddy Banks"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"trinidad_california", category:"surfing",title:"Trinidad", location:"California, USA", lat:41.0567,lon:-124.0903,ap:"ACV",icon:"🏄",rating:4.71,reviews:876,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0f7bcc",tags:["Scenic Cove","Peaceful Waves"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"crescent_city_breaks", category:"surfing",title:"Crescent City", location:"California, USA", lat:41.7439,lon:-124.2041,ap:"ACV",icon:"🏄",rating:4.63,reviews:745,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Tsunami Harbor","Quirky Town"],photo:"https://images.unsplash.com/photo-1345039625-14cbd3602e7d?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"brookings_oregon", category:"surfing",title:"Brookings", location:"Oregon, USA", lat:42.0575,lon:-124.2858,ap:"MFR",icon:"🏄",rating:4.68,reviews:1456,gradient:"linear-gradient(160deg,#002244,#004488,#0066cc)",accent:"#1177cc",tags:["Warm Water","Hidden Gem"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"gold_beach_oregon", category:"surfing",title:"Gold Beach", location:"Oregon, USA", lat:42.4092,lon:-124.4278,ap:"MFR",icon:"🏄",rating:4.64,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Scenic Bay","Quiet Town"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"bandon_beach", category:"surfing",title:"Bandon Beach", location:"Oregon, USA", lat:43.1186,lon:-124.4047,ap:"MFR",icon:"🏄",rating:4.72,reviews:1234,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0f7bcc",tags:["Sea Stacks","Dramatic Cliffs"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cape_sebastian", category:"surfing",title:"Cape Sebastian", location:"Oregon, USA", lat:42.3553,lon:-124.3508,ap:"MFR",icon:"🏄",rating:4.70,reviews:876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Headland Views","Consistent"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"point"},
  {id:"coquille_point", category:"surfing",title:"Coquille Point", location:"Oregon, USA", lat:43.1547,lon:-124.4061,ap:"MFR",icon:"🏄",rating:4.66,reviews:745,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2299ee",tags:["Rocky Point","Seal Colony"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"sunset_bay", category:"surfing",title:"Sunset Bay", location:"Oregon, USA", lat:43.3361,lon:-124.3503,ap:"EUG",icon:"🏄",rating:4.71,reviews:1098,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Sandy Cove","Protected Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"shore_acres", category:"surfing",title:"Shore Acres", location:"Oregon, USA", lat:43.3378,lon:-124.3356,ap:"EUG",icon:"🏄",rating:4.69,reviews:834,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1188ee",tags:["Botanical Gardens","Scenic Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"heceta_head", category:"surfing",title:"Heceta Head", location:"Oregon, USA", lat:43.4897,lon:-124.1175,ap:"EUG",icon:"🏄",rating:4.65,reviews:567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Sea Lion Caves","Reef Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"mapleton_oregon", category:"surfing",title:"Mapleton", location:"Oregon, USA", lat:44.1542,lon:-124.0861,ap:"EUG",icon:"🏄",rating:4.62,reviews:743,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#33aadd",tags:["River Mouth","Consistent Swell"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"rivermouth"},
  {id:"yaquina_head", category:"surfing",title:"Yaquina Head", location:"Oregon, USA", lat:44.6786,lon:-124.0833,ap:"EUG",icon:"🏄",rating:4.70,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Lighthouse Point","Seabird Refuge"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"beverly_beach", category:"surfing",title:"Beverly Beach", location:"Oregon, USA", lat:44.6728,lon:-124.0639,ap:"EUG",icon:"🏄",rating:4.67,reviews:876,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2288dd",tags:["State Park","Fun Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"otter_crest", category:"surfing",title:"Otter Crest", location:"Oregon, USA", lat:44.8089,lon:-124.0603,ap:"EUG",icon:"🏄",rating:4.73,reviews:1098,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Scenic Drive","Rocky Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"cape_perpetua", category:"surfing",title:"Cape Perpetua", location:"Oregon, USA", lat:44.2839,lon:-124.0481,ap:"EUG",icon:"🏄",rating:4.71,reviews:945,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0f7bcc",tags:["Scenic Area","Powerful Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"yachats_oregon", category:"surfing",title:"Yachats", location:"Oregon, USA", lat:44.3042,lon:-124.1069,ap:"EUG",icon:"🏄",rating:4.64,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Rock Gardens","Tide Pools"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"alsea_bay", category:"surfing",title:"Alsea Bay", location:"Oregon, USA", lat:44.6256,lon:-124.0681,ap:"EUG",icon:"🏄",rating:4.68,reviews:743,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1177cc",tags:["Bay Break","Local Wave"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"lincoln_city_oregon", category:"surfing",title:"Lincoln City", location:"Oregon, USA", lat:44.9642,lon:-123.9758,ap:"EUG",icon:"🏄",rating:4.66,reviews:2345,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Beach Town","Multi Peak"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"siletz_bay", category:"surfing",title:"Siletz Bay", location:"Oregon, USA", lat:44.9553,lon:-123.9733,ap:"EUG",icon:"🏄",rating:4.63,reviews:567,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0099bb",tags:["Bay Break","Quiet"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"rivermouth"},
  {id:"neskowin_oregon", category:"surfing",title:"Neskowin", location:"Oregon, USA", lat:45.1139,lon:-123.8694,ap:"PDX",icon:"🏄",rating:4.70,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Haystack Rock","Beach Town"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"pacific_city_oregon", category:"surfing",title:"Pacific City", location:"Oregon, USA", lat:45.1131,lon:-123.9578,ap:"PDX",icon:"🏄",rating:4.72,reviews:1456,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2299ee",tags:["Dory Fleet","Fun Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cape_lookout", category:"surfing",title:"Cape Lookout", location:"Oregon, USA", lat:45.3447,lon:-123.9711,ap:"PDX",icon:"🏄",rating:4.75,reviews:876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Headland Trail","Powerful Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"netarts_bay", category:"surfing",title:"Netarts Bay", location:"Oregon, USA", lat:45.3617,lon:-123.9819,ap:"PDX",icon:"🏄",rating:4.68,reviews:743,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1188ee",tags:["Bay Break","Sandy Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"oceanside_oregon", category:"surfing",title:"Oceanside", location:"Oregon, USA", lat:45.5622,lon:-123.9544,ap:"PDX",icon:"🏄",rating:4.71,reviews:1098,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Scenic Cove","Mellow Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cape_kiwanda", category:"surfing",title:"Cape Kiwanda", location:"Oregon, USA", lat:45.5525,lon:-123.9636,ap:"PDX",icon:"🏄",rating:4.77,reviews:1567,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#33aadd",tags:["Sandstone Cliffs","Powerful Reef"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"manzanita_oregon", category:"surfing",title:"Manzanita", location:"Oregon, USA", lat:45.7317,lon:-123.9347,ap:"PDX",icon:"🏄",rating:4.69,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Sandy Beach","Laid Back"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cannon_beach_oregon", category:"surfing",title:"Cannon Beach", location:"Oregon, USA", lat:45.8894,lon:-123.9603,ap:"PDX",icon:"🏄",rating:4.70,reviews:3456,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2288dd",tags:["Iconic Beach","Haystack Rock"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"arcadia_beach", category:"surfing",title:"Arcadia Beach", location:"Oregon, USA", lat:45.9044,lon:-123.9656,ap:"PDX",icon:"🏄",rating:4.65,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Tunnels Trail","Sandy Cove"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"short_sands", category:"surfing",title:"Short Sands", location:"Oregon, USA", lat:45.8906,lon:-123.9769,ap:"PDX",icon:"🏄",rating:4.72,reviews:945,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0f7bcc",tags:["Beginner Wave","Cliffs"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"humbug_creek", category:"surfing",title:"Humbug Creek", location:"Oregon, USA", lat:46.0086,lon:-123.9581,ap:"PDX",icon:"🏄",rating:4.62,reviews:567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["River Mouth","Quiet Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"rivermouth"},
  {id:"cape_meares", category:"surfing",title:"Cape Meares", location:"Oregon, USA", lat:45.4881,lon:-123.9797,ap:"PDX",icon:"🏄",rating:4.68,reviews:743,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1177cc",tags:["Lighthouse","Protected Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"tillamook_county", category:"surfing",title:"Tillamook County Breaks", location:"Oregon, USA", lat:45.4167,lon:-123.8667,ap:"PDX",icon:"🏄",rating:4.64,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Dairy Country","Sandy Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"ecola_state_park", category:"surfing",title:"Ecola State Park", location:"Oregon, USA", lat:45.8744,lon:-123.9792,ap:"PDX",icon:"🏄",rating:4.71,reviews:1098,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0099bb",tags:["Hiking Trails","Coastal Views"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"oysterville_washington", category:"surfing",title:"Oysterville", location:"Washington, USA", lat:46.5089,lon:-124.0297,ap:"SEA",icon:"🏄",rating:4.66,reviews:645,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Quiet Town","Sandy Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"holyrood_washington", category:"surfing",title:"Holyrood", location:"Washington, USA", lat:46.5186,lon:-124.0436,ap:"SEA",icon:"🏄",rating:4.63,reviews:523,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2299ee",tags:["Coastal Access","Long Left"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"point"},
  {id:"long_beach_washington", category:"surfing",title:"Long Beach Peninsula", location:"Washington, USA", lat:46.3303,lon:-124.0717,ap:"SEA",icon:"🏄",rating:4.70,reviews:1567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Sandy Beach","Quiet Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"ilwaco_washington", category:"surfing",title:"Ilwaco", location:"Washington, USA", lat:46.3167,lon:-124.0667,ap:"SEA",icon:"🏄",rating:4.64,reviews:856,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1188ee",tags:["Fishing Town","Protected Breaks"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"north_beach_washington", category:"surfing",title:"North Beach", location:"Washington, USA", lat:46.3564,lon:-124.0381,ap:"SEA",icon:"🏄",rating:4.68,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Sandy Beach","Beginner Wave"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cape_disappointment", category:"surfing",title:"Cape Disappointment", location:"Washington, USA", lat:46.2867,lon:-124.0519,ap:"SEA",icon:"🌊",rating:4.81,reviews:745,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#33aadd",tags:["Big Wave","Dangerous Current"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"westport_washington", category:"surfing",title:"Westport", location:"Washington, USA", lat:46.9028,lon:-124.6039,ap:"SEA",icon:"🏄",rating:4.72,reviews:1456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Fishing Fleet","Reef Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"ocean_city_washington", category:"surfing",title:"Ocean City", location:"Washington, USA", lat:47.0078,lon:-124.5367,ap:"SEA",icon:"🏄",rating:4.67,reviews:945,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2288dd",tags:["Sandy Town","Beginner Friendly"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"copalis_beach", category:"surfing",title:"Copalis Beach", location:"Washington, USA", lat:47.1361,lon:-124.3039,ap:"SEA",icon:"🏄",rating:4.63,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Beach Rocks","Mellow"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"morecambe_bay", category:"surfing",title:"Morecambe Bay", location:"UK", lat:54.0667,lon:-2.9,ap:"MAN",icon:"🏄",rating:4.71,reviews:1234,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0f7bcc",tags:["Tidal Bore","Funky Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"rivermouth"},
  {id:"spot_in_pembrokeshire", category:"surfing",title:"Pembrokeshire Breaks", location:"Wales, UK", lat:51.6833,lon:-5.3,ap:"CWL",icon:"🏄",rating:4.68,reviews:876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Welsh Coast","Rocky Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"gwithian", category:"surfing",title:"Gwithian", location:"Cornwall, UK", lat:50.3267,lon:-5.2306,ap:"LPA",icon:"🏄",rating:4.72,reviews:1567,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1177cc",tags:["Long Beach","Beginner Wave"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"watergate_bay", category:"surfing",title:"Watergate Bay", location:"Cornwall, UK", lat:50.4428,lon:-5.0669,ap:"LPA",icon:"🏄",rating:4.70,reviews:2145,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Resort Beach","Multi Peak"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"constantine_bay", category:"surfing",title:"Constantine Bay", location:"Cornwall, UK", lat:50.5522,lon:-4.9519,ap:"LPA",icon:"🏄",rating:4.75,reviews:1098,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0099bb",tags:["Sheltered Cove","Fun Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"trevose_head", category:"surfing",title:"Trevose Head", location:"Cornwall, UK", lat:50.5525,lon:-4.9794,ap:"LPA",icon:"🏄",rating:4.73,reviews:856,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Headland Point","Powerful Wave"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"perranporth_beach", category:"surfing",title:"Perranporth", location:"Cornwall, UK", lat:50.3467,lon:-4.9181,ap:"LPA",icon:"🏄",rating:4.68,reviews:1345,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2299ee",tags:["Long Beach","Fun Peak"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"porthtowan_beach", category:"surfing",title:"Porthtowan", location:"Cornwall, UK", lat:50.2842,lon:-4.9306,ap:"LPA",icon:"🏄",rating:4.71,reviews:1876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Sandy Bay","Beginner"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"porthleven", category:"surfing",title:"Porthleven", location:"Cornwall, UK", lat:50.0894,lon:-5.3256,ap:"LPA",icon:"�🌊",rating:4.82,reviews:745,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1188ee",tags:["Granite Blocks","Hollow Barrel"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"mousehole_beach", category:"surfing",title:"Mousehole", location:"Cornwall, UK", lat:50.0753,lon:-5.4742,ap:"LPA",icon:"🏄",rating:4.65,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Picturesque Village","Protected"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"penzance_breaks", category:"surfing",title:"Penzance", location:"Cornwall, UK", lat:50.1190,lon:-5.5361,ap:"LPA",icon:"🏄",rating:4.62,reviews:1234,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#33aadd",tags:["Coastal Town","Historic"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"sennen_cove", category:"surfing",title:"Sennen Cove", location:"Cornwall, UK", lat:50.0483,lon:-5.6858,ap:"LPA",icon:"🏄",rating:4.77,reviews:1567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Westernmost Beach","Powerful Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"lelant_beach", category:"surfing",title:"Lelant Beach", location:"Cornwall, UK", lat:50.2103,lon:-5.4806,ap:"LPA",icon:"🏄",rating:4.67,reviews:943,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2288dd",tags:["Sandy Bay","St Ives Access"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"carbis_bay", category:"surfing",title:"Carbis Bay", location:"Cornwall, UK", lat:50.2006,lon:-5.5019,ap:"LPA",icon:"🏄",rating:4.70,reviews:1123,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Luxury Resort","Sandy Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"porthmeor_beach", category:"surfing",title:"Porthmeor Beach", location:"Cornwall, UK", lat:50.2136,lon:-5.4800,ap:"LPA",icon:"🏄",rating:4.74,reviews:2345,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0f7bcc",tags:["Gallery Beach","Artsy Town"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"godrevy_beach", category:"surfing",title:"Godrevy Beach", location:"Cornwall, UK", lat:50.2383,lon:-5.3667,ap:"LPA",icon:"🏄",rating:4.72,reviews:1789,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Lighthouse","Sandy Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"fistral_beach", category:"surfing",title:"Fistral Beach", location:"Cornwall, UK", lat:50.4139,lon:-5.0897,ap:"LPA",icon:"🏄",rating:4.78,reviews:2567,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1177cc",tags:["Championship Beach","Surf Town"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"crooklets_beach", category:"surfing",title:"Crooklets Beach", location:"Cornwall, UK", lat:50.4464,lon:-4.8856,ap:"LPA",icon:"🏄",rating:4.69,reviews:1456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Double Beach","Funky Peaks"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"crumbly_island", category:"surfing",title:"Crumbly Island", location:"Cornwall, UK", lat:50.4494,lon:-4.8769,ap:"LPA",icon:"🏄",rating:4.71,reviews:834,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0099bb",tags:["Reef Break","Expert Wave"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"bude_breaks", category:"surfing",title:"Bude Beaches", location:"Cornwall, UK", lat:50.8328,lon:-4.5236,ap:"LPA",icon:"🏄",rating:4.73,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Coastal Town","Multi Peaks"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"welcombe_mouth", category:"surfing",title:"Welcombe Mouth", location:"Devon, UK", lat:50.9953,lon:-4.3544,ap:"EXT",icon:"🏄",rating:4.67,reviews:745,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2299ee",tags:["Remote Beach","Quiet Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"devon_coast_breaks", category:"surfing",title:"Devon Coast Spots", location:"Devon, UK", lat:50.6167,lon:-3.8,ap:"EXT",icon:"🏄",rating:4.65,reviews:1098,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Coastal Path","Diverse Breaks"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"lulworth_cove", category:"surfing",title:"Lulworth Cove", location:"Dorset, UK", lat:50.6167,lon:-2.2528,ap:"BHD",icon:"🏄",rating:4.72,reviews:1567,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1188ee",tags:["Iconic Cove","Sheltered Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"weymouth_beach", category:"surfing",title:"Weymouth Beach", location:"Dorset, UK", lat:50.6083,lon:-2.4575,ap:"BHD",icon:"🏄",rating:4.64,reviews:2234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Sandy Town","Beginner Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"bournemouth_beach", category:"surfing",title:"Bournemouth Beach", location:"Dorset, UK", lat:50.7355,lon:-1.8767,ap:"BHD",icon:"🏄",rating:4.68,reviews:3456,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#33aadd",tags:["Pier Break","Urban Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"point"},
  {id:"isle_of_wight_breaks", category:"surfing",title:"Isle of Wight Breaks", location:"Isle of Wight, UK", lat:50.6,lon:-1.3,ap:"LGW",icon:"🏄",rating:4.70,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Island Reef","Consistent"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"hampshire_coast", category:"surfing",title:"Hampshire Coast Spots", location:"Hampshire, UK", lat:50.8667,lon:-1.5667,ap:"LGW",icon:"🏄",rating:4.62,reviews:876,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2288dd",tags:["Eastern England","Sandy Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"sussex_coast", category:"surfing",title:"Sussex Coast Breaks", location:"East Sussex, UK", lat:50.8667,lon:-0.0,ap:"GTW",icon:"🏄",rating:4.65,reviews:1123,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["South Coast","Pier Breaks"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"point"},
  {id:"dungeness_point", category:"surfing",title:"Dungeness Point", location:"Kent, UK", lat:50.9119,lon:0.9544,ap:"GTW",icon:"🏄",rating:4.68,reviews:745,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0f7bcc",tags:["Nuclear Station","Pebble Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"reykjanes_iceland", category:"surfing",title:"Reykjanes Peninsula", location:"Reykjanes, Iceland", lat:63.8808,lon:-22.4513,ap:"KEF",icon:"🏄",rating:4.76,reviews:1456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Geothermal Area","Cold Water"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"snaefellsnes_iceland", category:"surfing",title:"Snaefellsnes", location:"Snaefellsnes, Iceland", lat:64.8808,lon:-23.8125,ap:"KEF",icon:"🏄",rating:4.71,reviews:1098,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1177cc",tags:["Mountain Backdrop","Powerful Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"westfjords_iceland", category:"surfing",title:"Westfjords Iceland", location:"Westfjords, Iceland", lat:66.0208,lon:-23.1425,ap:"KEF",icon:"🌊",rating:4.84,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Remote Fjord","Epic Wave"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"achill_island", category:"surfing",title:"Achill Island", location:"County Mayo, Ireland", lat:53.9667,lon:-9.9333,ap:"DUB",icon:"🏄",rating:4.72,reviews:1234,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0099bb",tags:["Dramatic Cliffs","Fun Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"sligo_breaks", category:"surfing",title:"Sligo Beaches", location:"County Sligo, Ireland", lat:54.2667,lon:-8.5667,ap:"DUB",icon:"🏄",rating:4.68,reviews:876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Ben Bulben","Multi Peaks"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"donegal_coast", category:"surfing",title:"Donegal Coast", location:"County Donegal, Ireland", lat:55.0,lon:-8.3667,ap:"DUB",icon:"🏄",rating:4.74,reviews:1567,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2299ee",tags:["Atlantic Swells","Rugged Coast"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"dingle_ireland", category:"surfing",title:"Dingle Peninsula", location:"County Kerry, Ireland", lat:52.1333,lon:-10.3,ap:"DUB",icon:"🏄",rating:4.71,reviews:2145,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Scenic Peninsula","Fun Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"mouth_of_the_shannon", category:"surfing",title:"Mouth of Shannon", location:"County Clare, Ireland", lat:52.5333,lon:-9.6667,ap:"SNN",icon:"🏄",rating:4.65,reviews:834,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1188ee",tags:["River Mouth","Funky Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"rivermouth"},
  {id:"lahinch_main", category:"surfing",title:"Lahinch Main Beach", location:"County Clare, Ireland", lat:52.9442,lon:-9.3389,ap:"SNN",icon:"🏄",rating:4.73,reviews:3456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Irish Classic","Sandy Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"castlerock_ireland", category:"surfing",title:"Castlerock", location:"County Derry, Ireland", lat:55.1333,lon:-7.0833,ap:"DUB",icon:"🏄",rating:4.68,reviews:1456,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#33aadd",tags:["Epic Right","Consistent"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"point"},
  {id:"bangor_beach_ireland", category:"surfing",title:"Bangor Beach", location:"County Down, Ireland", lat:54.6533,lon:-5.6717,ap:"BFS",icon:"🏄",rating:4.64,reviews:943,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Irish Sea","Sandy Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"sarclet_scotland", category:"surfing",title:"Sarclet", location:"Highland, Scotland", lat:58.5044,lon:-3.4681,ap:"INV",icon:"🏄",rating:4.71,reviews:834,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2288dd",tags:["Secret Cove","Fun Wave"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"dunnet_beach", category:"surfing",title:"Dunnet Beach", location:"Highland, Scotland", lat:58.5606,lon:-3.6661,ap:"INV",icon:"🏄",rating:4.68,reviews:1123,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Far North","Consistent"},photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"shetland_islands", category:"surfing",title:"Shetland Islands", location:"Shetland, Scotland", lat:60.5,lon:-1.25,ap:"SUM",icon:"🏄",rating:4.75,reviews:745,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0f7bcc",tags:["Northern Isles","Powerful Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"outer_hebrides", category:"surfing",title:"Outer Hebrides", location:"Scotland", lat:57.5,lon:-7.25,ap:"INV",icon:"🏄",rating:4.79,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Island Paradise","Atlantic Swells"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"sri_lanka_mirissa", category:"surfing",title:"Mirissa", location:"Southern, Sri Lanka", lat:5.9469,lon:80.7731,ap:"CMB",icon:"🏄",rating:4.73,reviews:2456,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1177cc",tags:["Whale Watching","Party Town"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"sri_lanka_arugam", category:"surfing",title:"Arugam Bay", location:"Eastern, Sri Lanka", lat:7.1517,lon:81.8458,ap:"BRI",icon:"🏄",rating:4.76,reviews:1678,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Long Right","Laid Back"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"point"},
  {id:"sri_lanka_hikkaduwa", category:"surfing",title:"Hikkaduwa", location:"Southern, Sri Lanka", lat:6.9428,lon:80.1482,ap:"CMB",icon:"🏄",rating:4.68,reviews:1456,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0099bb",tags:["Reef Break","Beach Town"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"maldives_spot", category:"surfing",title:"Maldives Atolls", location:"Male, Maldives", lat:4.1755,lon:73.5093,ap:"MLE",icon:"🏄",rating:4.85,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Luxury Resorts","Consistent Reef"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"lombok_senggigi", category:"surfing",title:"Senggigi", location:"Lombok, Indonesia", lat:-8.6964,lon:116.1333,ap:"LOP",icon:"🏄",rating:4.67,reviews:1876,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2299ee",tags:["Beach Town","Multi Peaks"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"lombok_gili", category:"surfing",title:"Gili Islands", location:"Lombok, Indonesia", lat:-8.3667,lon:116.0,ap:"LOP",icon:"🏄",rating:4.72,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Island Paradise","Boat Access"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"sumatra_spot", category:"surfing",title:"Sumatra Interior", location:"Sumatra, Indonesia", lat:2.0469,lon:99.8201,ap:"PEK",icon:"🏄",rating:4.88,reviews:2345,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1188ee",tags:["Jungle Waves","Hardcore"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"java_grajagan", category:"surfing",title:"Grajagan", location:"Java, Indonesia", lat:-8.0167,lon:114.3667,ap:"SUB",icon:"🌊",rating:4.89,reviews:1567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Perfection Left","Expert Wave"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"point"},
  {id:"java_spot2", category:"surfing",title:"Java Inland Breaks", location:"Java, Indonesia", lat:-7.5,lon:112.75,ap:"SUB",icon:"🏄",rating:4.65,reviews:856,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#33aadd",tags:["Remote Access","Sandy Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"flores_island", category:"surfing",title:"Flores Island", location:"Nusa Tenggara, Indonesia", lat:-8.5333,lon:121.8667,ap:"LBJ",icon:"🏄",rating:4.70,reviews:1045,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Volcanic Island","Fun Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"timor_spot", category:"surfing",title:"Timor Breaks", location:"East Timor", lat:-9.5167,lon:124.5,ap:"DIL",icon:"🏄",rating:4.68,reviews:745,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2288dd",tags:["Untouched Reefs","Adventure"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"taiwan_jiaoxi", category:"surfing",title:"Jiaoxi", location:"Taiwan", lat:24.8144,lon:121.5531,ap:"TPE",icon:"🏄",rating:4.71,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["East Coast","Warm Water"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"taiwan_jialeshui", category:"surfing",title:"Jialeshui", location:"Taiwan", lat:22.7847,lon:121.0217,ap:"KHH",icon:"🏄",rating:4.75,reviews:1567,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0f7bcc",tags:["Reef Break","Consistent Swell"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"vietnam_spot", category:"surfing",title:"Vietnam Coast", location:"Vietnam", lat:11.8667,lon:109.2167,ap:"NHA",icon:"🏄",rating:4.62,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Tropical Setting","Beginner"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"thailand_spot", category:"surfing",title:"Thailand Breaks", location:"Thailand", lat:12.9031,lon:100.9972,ap:"BKK",icon:"🏄",rating:4.64,reviews:1456,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1177cc",tags:["Monsoon Swell","Tropical Vibe"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"australia_sunset", category:"surfing",title:"Sunset Beach", location:"Western Australia, Australia", lat:-32.3833,lon:115.4167,ap:"PER",icon:"🏄",rating:4.73,reviews:2345,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Western Paradise","Warm Water"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"australia_break", category:"surfing",title:"Rottnest Island", location:"Western Australia, Australia", lat:-32.0,lon:115.5,ap:"PER",icon:"🏄",rating:4.70,reviews:1678,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0099bb",tags:["Island Reef","Quokkas"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"shark_bay", category:"surfing",title:"Shark Bay", location:"Western Australia, Australia", lat:-25.3,lon:113.7,ap:"PER",icon:"🏄",rating:4.68,reviews:945,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Remote Breaks","Shark Sightings"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"esperance_au", category:"surfing",title:"Esperance", location:"Western Australia, Australia", lat:-33.8667,lon:121.8833,ap:"PER",icon:"🏄",rating:4.72,reviews:1234,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2299ee",tags:["Great Southern","Fun Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"tasmania_break", category:"surfing",title:"Tasmania Breaks", location:"Tasmania, Australia", lat:-42.8333,lon:147.3333,ap:"HBA",icon:"🏄",rating:4.75,reviews:1567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Southern Ocean","Cold Water"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"new_zealand_piha", category:"surfing",title:"Piha", location:"Auckland, New Zealand", lat:-37.3667,lon:174.4667,ap:"AKL",icon:"🏄",rating:4.74,reviews:2345,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1188ee",tags:["Black Sand","Powerful Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"new_zealand_karekare", category:"surfing",title:"Karekare", location:"Auckland, New Zealand", lat:-37.4333,lon:174.5,ap:"AKL",icon:"🏄",rating:4.71,reviews:1456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Waterfall Beach","Scenic Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"new_zealand_gisborne", category:"surfing",title:"Gisborne", location:"Gisborne, New Zealand", lat:-38.6667,lon:178.5,ap:"GIS",icon:"🏄",rating:4.69,reviews:1234,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#33aadd",tags:["East Cape","Consistent Swell"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"new_zealand_coromandel", category:"surfing",title:"Coromandel Peninsula", location:"Coromandel, New Zealand", lat:-36.75,lon:175.5,ap:"AKL",icon:"🏄",rating:4.68,reviews:1876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Thermal Beaches","Hot Water"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"fiji_cloudbreak", category:"surfing",title:"Cloudbreak Extended", location:"Fiji", lat:-17.6,lon:177.2,ap:"NAN",icon:"🌊",rating:4.90,reviews:2567,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2288dd",tags:["Perfect Barrel","Resort Access"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"samoa_spot", category:"surfing",title:"Samoa Breaks", location:"Samoa", lat:-13.8314,lon:-171.7449,ap:"APW",icon:"🏄",rating:4.71,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Island Reef","Tropical Paradise"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"tonga_spot", category:"surfing",title:"Tonga", location:"Tonga", lat:-21.1357,lon:-175.1992,ap:"NAN",icon:"🏄",rating:4.73,reviews:1045,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0f7bcc",tags:["Whale Season","Clean Water"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"vanuatu_spot", category:"surfing",title:"Vanuatu", location:"Vanuatu", lat:-17.7404,lon:168.3045,ap:"VLI",icon:"🏄",rating:4.66,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Volcanic Islands","Adventure"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"japan_shonan", category:"surfing",title:"Shonan", location:"Kanagawa, Japan", lat:35.3167,lon:139.5,ap:"NRT",icon:"🏄",rating:4.70,reviews:2345,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1177cc",tags:["Tokyo Access","Fun Beach"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"japan_shizuoka", category:"surfing",title:"Shizuoka Breaks", location:"Shizuoka, Japan", lat:34.7,lon:138.4,ap:"FSZ",icon:"🏄",rating:4.68,reviews:1456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Mt Fuji Views","Consistent"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"japan_kyushu", category:"surfing",title:"Kyushu Breaks", location:"Kyushu, Japan", lat:31.5,lon:130.5,ap:"KMI",icon:"🏄",rating:4.71,reviews:1234,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0099bb",tags:["Southern Island","Typhoon Swell"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"maldives_detailed", category:"surfing",title:"Male City Breaks", location:"Male, Maldives", lat:4.1755,lon:73.5095,ap:"MLE",icon:"🏄",rating:4.67,reviews:1098,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Urban Reef","Day Trip"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"mauritius_island", category:"surfing",title:"Mauritius", location:"Mauritius", lat:-20.3484,lon:57.5522,ap:"MRU",icon:"🏄",rating:4.69,reviews:1567,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2299ee",tags:["Turquoise Lagoon","Reef Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"reunion_spot", category:"surfing",title:"Reunion Island", location:"Reunion", lat:-20.8781,lon:55.4922,ap:"RUN",icon:"🏄",rating:4.72,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Volcanic Island","Shark Risk"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"madagascar_spot", category:"surfing",title:"Madagascar", location:"Madagascar", lat:-18.8667,lon:47.5333,ap:"TNR",icon:"🏄",rating:4.65,reviews:945,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1188ee",tags:["Island Nation","Adventure"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"senegal_spot", category:"surfing",title:"Senegal", location:"Senegal", lat:14.7167,lon:-17.4667,ap:"DSS",icon:"🏄",rating:4.68,reviews:834,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["West Africa","Consistent Swell"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"ghana_spot", category:"surfing",title:"Ghana Coast", location:"Ghana", lat:5.5,lon:-0.2,ap:"ACC",icon:"🏄",rating:4.62,reviews:743,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#33aadd",tags:["West Africa","Beach Break"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"cote_divoire_spot", category:"surfing",title:"Cote d'Ivoire", location:"Ivory Coast", lat:5.3333,lon:-4.0167,ap:"ABJ",icon:"🏄",rating:4.64,reviews:567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Tropical Break","Less Crowded"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"morocco_taghazout_ext", category:"surfing",title:"Taghazout Extended", location:"Morocco", lat:31.3937,lon:-8.7295,ap:"AGD",icon:"🏄",rating:4.74,reviews:2234,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2288dd",tags:["Digital Nomad Hub","Consistent"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"morocco_imsouane", category:"surfing",title:"Imsouane", location:"Morocco", lat:31.2167,lon:-8.8,ap:"AGD",icon:"🏄",rating:4.71,reviews:1567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Beach Bay","Perfect Left"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"point"},
  {id:"morocco_anchor", category:"surfing",title:"Anchor Point Morocco", location:"Morocco", lat:30.9622,lon:-8.9703,ap:"AGD",icon:"🏄",rating:4.77,reviews:1234,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0f7bcc",tags:["Righthand Point","Reliable"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"point"},
  {id:"canaries_fuerteventura_ext", category:"surfing",title:"Fuerteventura Extended", location:"Canary Islands, Spain", lat:28.3,lon:-14.1667,ap:"FUE",icon:"🏄",rating:4.73,reviews:2345,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Windy Island","Kite Hub"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"canaries_gran_canaria", category:"surfing",title:"Gran Canaria", location:"Canary Islands, Spain", lat:27.9333,lon:-15.5833,ap:"LPA",icon:"🏄",rating:4.70,reviews:1876,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#1177cc",tags:["Island Reefs","Consistent"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"canaries_tenerife", category:"surfing",title:"Tenerife", location:"Canary Islands, Spain", lat:28.4667,lon:-16.3167,ap:"TFS",icon:"🏄",rating:4.69,reviews:1567,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Largest Island","Mt Teide View"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"canaries_la_palma", category:"surfing",title:"La Palma", location:"Canary Islands, Spain", lat:28.6833,lon:-17.8667,ap:"SPC",icon:"🏄",rating:4.67,reviews:1234,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#0099bb",tags:["Quietest Island","Lava Rocks"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"canaries_el_hierro", category:"surfing",title:"El Hierro", location:"Canary Islands, Spain", lat:27.75,lon:-18.0,ap:"VDE",icon:"🏄",rating:4.72,reviews:945,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Smallest Island","Secret Breaks"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"france_hossegor_alt", category:"surfing",title:"Hossegor Alternative", location:"Aquitaine, France", lat:43.6333,lon:-1.4333,ap:"BOD",icon:"🏄",rating:4.72,reviews:2234,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#2299ee",tags:["Pro Spot","Beach Town"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"france_capbreton", category:"surfing",title:"Capbreton", location:"Aquitaine, France", lat:43.6464,lon:-1.4306,ap:"BOD",icon:"🏄",rating:4.70,reviews:1456,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0f7bcc",tags:["Canyon Point","Powerful Wave"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"point"},
  {id:"france_mimizan", category:"surfing",title:"Mimizan", location:"Aquitaine, France", lat:43.8667,lon:-1.3,ap:"BOD",icon:"🏄",rating:4.66,reviews:1234,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1188ee",tags:["Beach Breaks","Sandy Peaks"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"france_arcachon", category:"surfing",title:"Arcachon Bay", location:"Aquitaine, France", lat:44.6667,lon:-1.1667,ap:"BOD",icon:"🏄",rating:4.62,reviews:876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Bay Break","Lagoon"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"rivermouth"},
  {id:"spain_mundaka_alt", category:"surfing",title:"Mundaka Extended", location:"Basque Country, Spain", lat:43.4167,lon:-2.6667,ap:"BIO",icon:"🏄",rating:4.75,reviews:1567,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#33aadd",tags:["Left Point","River Mouth"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"rivermouth"},
  {id:"spain_zarautz", category:"surfing",title:"Zarautz", location:"Basque Country, Spain", lat:43.2958,lon:-2.1697,ap:"BIO",icon:"🏄",rating:4.70,reviews:2145,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Long Beach","Basque Charm"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"spain_doniostia", category:"surfing",title:"Doniostia", location:"Basque Country, Spain", lat:43.3183,lon:-1.9833,ap:"BIO",icon:"🏄",rating:4.68,reviews:1876,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2288dd",tags:["Beautiful Bay","Gourmet City"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"spain_oleron", category:"surfing",title:"Oleron Island", location:"Aquitaine, France", lat:45.3667,lon:-1.1667,ap:"RCN",icon:"🏄",rating:4.65,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2299ee",tags:["Island Breaks","Scenic"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"portugal_peniche_ext", category:"surfing",title:"Peniche Extended", location:"Estremadura, Portugal", lat:39.3667,lon:-9.4,ap:"LIS",icon:"🏄",rating:4.76,reviews:2345,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0f7bcc",tags:["Pro Spot","Consistent Reef"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"reef"},
  {id:"portugal_obidos", category:"surfing",title:"Obidos Lagoon", location:"Estremadura, Portugal", lat:39.3667,lon:-9.1667,ap:"LIS",icon:"🏄",rating:4.63,reviews:1098,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Lagoon Break","Unique"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"rivermouth"},
  {id:"portugal_nazare_access", category:"surfing",title:"Nazare Access Town", location:"Estremadura, Portugal", lat:39.5667,lon:-9.2,ap:"LIS",icon:"🌊",rating:4.86,reviews:1567,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#1177cc",tags:["Biggest Wave","Tow-in Only"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"canyon"},
  {id:"portugal_supertubos", category:"surfing",title:"Supertubos Section", location:"Estremadura, Portugal", lat:39.3558,lon:-9.3522,ap:"LIS",icon:"🏄",rating:4.80,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#33aadd",tags:["Perfect Barrel","Hollow Wave"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"portugal_ericeira_alt", category:"surfing",title:"Ericeira Expansion", location:"Estremadura, Portugal", lat:38.9667,lon:-9.4333,ap:"LIS",icon:"🏄",rating:4.74,reviews:2456,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#0099bb",tags:["Seaside Town","Multi Breaks"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"portugal_guincho", category:"surfing",title:"Guincho", location:"Estremadura, Portugal", lat:38.7167,lon:-9.5,ap:"LIS",icon:"🏄",rating:4.71,reviews:1345,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#2288dd",tags:["Windy Beach","Powerful Waves"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"portugal_algarve", category:"surfing",title:"Algarve", location:"Algarve, Portugal", lat:37.1,lon:-8.0,ap:"FAO",icon:"🏄",rating:4.68,reviews:1567,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2299ee",tags:["Southern Coast","Golden Cliffs"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"israel_spot", category:"surfing",title:"Israel Coast", location:"Israel", lat:31.0461,lon:34.4672,ap:"TLV",icon:"🏄",rating:4.64,reviews:876,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1188ee",tags:["Middle East","Mediterranean Swell"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"oman_spot", category:"surfing",title:"Oman Breaks", location:"Oman", lat:22.5,lon:59.5,ap:"MCT",icon:"🏄",rating:4.70,reviews:1234,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#1177cc",tags:["Arabian Sea","Consistent"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"india_varkalamh", category:"surfing",title:"Varkala", location:"Kerala, India", lat:8.7408,lon:76.7276,ap:"COK",icon:"🏄",rating:4.65,reviews:1456,gradient:"linear-gradient(160deg,#002040,#003878,#0050a8)",accent:"#33aadd",tags:["Beach Cliffs","Spiritual Town"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"south_africa_durban", category:"surfing",title:"Durban", location:"KwaZulu-Natal, South Africa", lat:-29.8833,lon:31.0333,ap:"DUR",icon:"🏄",rating:4.73,reviews:2345,gradient:"linear-gradient(160deg,#003355,#005588,#0077bb)",accent:"#0099bb",tags:["Warm Water","Shark Spotters"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
  {id:"south_africa_mossel_bay", category:"surfing",title:"Mossel Bay", location:"Western Cape, South Africa", lat:-34.3627,lon:22.1394,ap:"MQT",icon:"🏄",rating:4.70,reviews:1567,gradient:"linear-gradient(160deg,#001a40,#003380,#0055cc)",accent:"#2288dd",tags:["Great White Area","Powerful"],photo:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=600&fit=crop",breakType:"beach"},
