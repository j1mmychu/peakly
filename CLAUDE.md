...
- ✅ **Auto-push guard residual closed** (Open #14) — venue-count check swapped grep→eval counter; `.venue-baseline` 156→353. Working tree confirmed clean (book_click + ToS/Privacy links were already committed; the stale "uncommitted" flag is cleared).
